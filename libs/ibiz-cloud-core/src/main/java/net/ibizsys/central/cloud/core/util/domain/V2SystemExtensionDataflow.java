...
public class V2SystemExtensionDataflow extends EntityBase{
     ...
     * 属性: 数据流标记
     */
    public final static String FIELD_DATAFLOW_TAG="dataflow_tag";
    ...
    public V2SystemExtensionDataflow setVersion(Integer val) {
    ...
    public V2SystemExtensionDataflow setState(Integer val) {
    ...
    public V2SystemExtensionDataflow setCreateMan(String val) {
    ...
    public V2SystemExtensionDataflow setCreateTime(Timestamp val) {
    ...
    public V2SystemExtensionDataflow setId(String val) {
    ...
    public V2SystemExtensionDataflow setName(String val) {
    ...
    public V2SystemExtensionDataflow setSystemExtensionId(String val) {
    ...
    public V2SystemExtensionDataflow setUpdateMan(String val) {
    ...
    public V2SystemExtensionDataflow setUpdateTime(Timestamp val) {
    ...
    public V2SystemExtensionDataflow setSystemTag(String val) {
    ...
    public V2SystemExtensionDataflow setDataEntityTag(String val) {
    ...
    public V2SystemExtensionDataflow setDataflowTag(String val) {
        this.set(FIELD_DATAFLOW_TAG, val);
        return this;
    }
    ...
    public String getDataflowTag() {
        return DataTypeUtils.asString(this.get(FIELD_DATAFLOW_TAG), null);
    }
    ...
    public boolean containsDataflowTag() {
        return this.contains(FIELD_DATAFLOW_TAG);
    }
    ...
    public V2SystemExtensionDataflow setOrderValue(Integer val) {
    ...
    public V2SystemExtensionDataflow setExtensionTag(String val) {
    ...
    public V2SystemExtensionDataflow setExtensionTag2(String val) {
    ...
    public V2SystemExtensionDataflow setExtensionTag3(String val) {
    ...
    public V2SystemExtensionDataflow setExtensionTag4(String val) {
    ...
    public V2SystemExtensionDataflow setExtensionModel(String val) {
    ...
    public V2SystemExtensionDataflow setPendingExtensionModel(String val) {
    ...
    public V2SystemExtensionDataflow setRuntimeModel(String val) {
    ...
    public V2SystemExtensionDataflow setScopeType(String val) {
    ...
    public V2SystemExtensionDataflow setScopeTag(String val) {
    ...
    public V2SystemExtensionDataflow setScopeTag2(String val) {
    ...
    public V2SystemExtensionDataflow setScopeTag3(String val) {
    ...
    public V2SystemExtensionDataflow setScopeTag4(String val) {
    ...
    public V2SystemExtensionDataflow setApplyFlag(Integer val) {
    ...
    public V2SystemExtensionDataflow setApplyInfo(String val) {
    ...
    public V2SystemExtensionDataflow setValidFlag(Integer val) {
     ...
     */
    @JsonIgnore
    public V2SystemExtensionDataflow resetValidFlag() {
