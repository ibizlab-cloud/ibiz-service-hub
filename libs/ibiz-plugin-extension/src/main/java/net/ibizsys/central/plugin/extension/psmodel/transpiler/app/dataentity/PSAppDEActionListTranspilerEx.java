...
public class PSAppDEActionListTranspilerEx extends net.ibizsys.model.util.transpiler.extend.app.dataentity.PSAppDEActionListTranspilerEx {
				...
				if(!ObjectUtils.isEmpty(psAppDataEntities)) {
					for(IPSAppDataEntity iPSAppDataEntity : psAppDataEntities) {
						...
						if(strDETag.equalsIgnoreCase(strParentId)) {
							...
							IPSAppDEMethod iPSAppDEMethod = iPSAppDataEntity.getPSAppDEMethod(strSimpleId, false);
