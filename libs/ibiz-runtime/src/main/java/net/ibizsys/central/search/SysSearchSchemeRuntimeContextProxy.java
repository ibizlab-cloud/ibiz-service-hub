...
public class SysSearchSchemeRuntimeContextProxy<M extends ISysSearchSchemeRuntime, C extends ISysSearchSchemeRuntimeContext> extends SysSearchSchemeRuntimeContextBase<M>{

	final C proxyContext;
	public SysSearchSchemeRuntimeContextProxy(C proxyContext) {
...
//	
	...
	public M getModelRuntime() {
		return (M)getProxyContext().getSysSearchSchemeRuntime();
	}
	...
	public ISysSearchSchemeRuntime getSysSearchSchemeRuntime() {
		return getProxyContext().getSysSearchSchemeRuntime();
	}
