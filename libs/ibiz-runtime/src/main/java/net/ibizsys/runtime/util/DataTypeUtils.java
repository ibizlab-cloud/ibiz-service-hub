...
//	}
//
	final static public Integer asInteger(Object objValue){
		return asInteger(objValue, null);
	}
	...
	final static public BigDecimal asBigDecimal(Object objValue) {
		return asBigDecimal(objValue, null);
	}
	...
	final static public BigInteger asBigInteger(Object objValue)  {
		return asBigInteger(objValue, null);
	}
...
//	}
//
	final static public Double asDouble(Object objValue) {
		return asDouble(objValue, null);
	}
	...
	final static public Float asFloat(Object objValue) {
		return asFloat(objValue, null);
	}
	...
	final static public Long asLong(Object objValue){
		return asLong(objValue, null);
	}
	...
	public static java.sql.Timestamp asDateTime(Object objValue){
		return asDateTime(objValue, null);
	}
	
	
	public static java.sql.Timestamp asDateTime(Object objValue, java.sql.Timestamp def){
		try {
	...
	final static public Boolean asBoolean(Object objValue) {
		return asBoolean(objValue, null);
	}
	...
	final static public String asString(Object objValue) {
		return asString(objValue, null);
	}
