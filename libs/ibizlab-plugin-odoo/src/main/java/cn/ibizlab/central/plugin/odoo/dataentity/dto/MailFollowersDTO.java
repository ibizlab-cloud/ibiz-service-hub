...
public class MailFollowersDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
    ...
    public MailFollowersDTO setName(String val) {
     ...
     * 设置「关注类型」
     * 代码表[关注类型]
     * //@see cn.ibizlab.ibizodoo.core.runtime.dict.StaticDict.attention_type
     * @param val
     */
    @JsonProperty(FIELD_TYPE)
    public MailFollowersDTO setType(String val) {
     ...
     */
    @JsonIgnore
    public MailFollowersDTO resetType() {
    ...
    public MailFollowersDTO setResId(String val) {
     ...
     */
    @JsonIgnore
    public MailFollowersDTO resetResId() {
    ...
    public MailFollowersDTO setDisplayName(String val) {
     ...
     */
    @JsonIgnore
    public MailFollowersDTO resetDisplayName() {
    ...
    public MailFollowersDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public MailFollowersDTO resetId() {
    ...
    public MailFollowersDTO setPartnerId(String val) {
     ...
     */
    @JsonIgnore
    public MailFollowersDTO resetPartnerId() {
    ...
    public MailFollowersDTO setResModel(String val) {
     ...
     */
    @JsonIgnore
    public MailFollowersDTO resetResModel() {
