...
public class AiKnowledgeBaseDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
    ...
    public AiKnowledgeBaseDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public AiKnowledgeBaseDTO resetId() {
    ...
    public AiKnowledgeBaseDTO setName(String val) {
     ...
     */
    @JsonIgnore
    public AiKnowledgeBaseDTO resetName() {
    ...
    public AiKnowledgeBaseDTO setCreateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiKnowledgeBaseDTO resetCreateMan() {
    ...
    public AiKnowledgeBaseDTO setCreateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiKnowledgeBaseDTO resetCreateTime() {
    ...
    public AiKnowledgeBaseDTO setUpdateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiKnowledgeBaseDTO resetUpdateMan() {
    ...
    public AiKnowledgeBaseDTO setUpdateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiKnowledgeBaseDTO resetUpdateTime() {
