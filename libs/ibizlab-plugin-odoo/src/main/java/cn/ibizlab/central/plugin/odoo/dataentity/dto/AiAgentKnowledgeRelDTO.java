...
public class AiAgentKnowledgeRelDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
     ...
     * 属性: 知识库标识
     */
    public final static String FIELD_AI_KNOWLEDGE_BASE_ID = "ai_knowledge_base_id";
    ...
    public AiAgentKnowledgeRelDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetId() {
    ...
    public AiAgentKnowledgeRelDTO setName(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetName() {
    ...
    public AiAgentKnowledgeRelDTO setCreateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetCreateMan() {
    ...
    public AiAgentKnowledgeRelDTO setCreateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetCreateTime() {
    ...
    public AiAgentKnowledgeRelDTO setUpdateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetUpdateMan() {
    ...
    public AiAgentKnowledgeRelDTO setUpdateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetUpdateTime() {
    ...
    public AiAgentKnowledgeRelDTO setAiAgentId(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetAiAgentId() {
     ...
     * @param val
     */
    @JsonProperty(FIELD_AI_KNOWLEDGE_BASE_ID)
    public AiAgentKnowledgeRelDTO setAiKnowledgeBaseId(String val) {
        this._set(FIELD_AI_KNOWLEDGE_BASE_ID, val);
        return this;
    }
    ...
    public String getAiKnowledgeBaseId() {
        return DataTypeUtils.asString(this._get(FIELD_AI_KNOWLEDGE_BASE_ID), null);
    }
     ...
     */
    @JsonIgnore
    public boolean containsAiKnowledgeBaseId() {
        return this._contains(FIELD_AI_KNOWLEDGE_BASE_ID);
    }
     ...
     */
    @JsonIgnore
    public AiAgentKnowledgeRelDTO resetAiKnowledgeBaseId() {
        this._reset(FIELD_AI_KNOWLEDGE_BASE_ID);
        return this;
    }
