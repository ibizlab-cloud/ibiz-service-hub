...
public class AiAgentConversationDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
    ...
    public AiAgentConversationDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetId() {
    ...
    public AiAgentConversationDTO setName(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetName() {
    ...
    public AiAgentConversationDTO setCreateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetCreateMan() {
    ...
    public AiAgentConversationDTO setCreateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetCreateTime() {
    ...
    public AiAgentConversationDTO setUpdateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetUpdateMan() {
    ...
    public AiAgentConversationDTO setUpdateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetUpdateTime() {
    ...
    public AiAgentConversationDTO setAiAgentId(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentConversationDTO resetAiAgentId() {
