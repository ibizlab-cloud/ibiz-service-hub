...
public class AiAgentContextDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
    ...
    public AiAgentContextDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentContextDTO resetId() {
    ...
    public AiAgentContextDTO setName(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentContextDTO resetName() {
    ...
    public AiAgentContextDTO setCreateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentContextDTO resetCreateMan() {
    ...
    public AiAgentContextDTO setCreateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiAgentContextDTO resetCreateTime() {
    ...
    public AiAgentContextDTO setUpdateMan(String val) {
     ...
     */
    @JsonIgnore
    public AiAgentContextDTO resetUpdateMan() {
    ...
    public AiAgentContextDTO setUpdateTime(Timestamp val) {
     ...
     */
    @JsonIgnore
    public AiAgentContextDTO resetUpdateTime() {
