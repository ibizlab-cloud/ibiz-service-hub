...
public class MailAliasMixinDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
    ...
    public MailAliasMixinDTO setAliasEmail(String val) {
     ...
     */
    @JsonIgnore
    public MailAliasMixinDTO resetAliasEmail() {
    ...
    public MailAliasMixinDTO setAliasId(String val) {
     ...
     */
    @JsonIgnore
    public MailAliasMixinDTO resetAliasId() {
    ...
    public MailAliasMixinDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public MailAliasMixinDTO resetId() {
    ...
    public MailAliasMixinDTO setName(String val) {
     ...
     */
    @JsonIgnore
    public MailAliasMixinDTO resetName() {
