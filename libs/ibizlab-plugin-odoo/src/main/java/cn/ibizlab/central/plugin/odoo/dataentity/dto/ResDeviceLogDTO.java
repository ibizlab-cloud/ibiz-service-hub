...
public class ResDeviceLogDTO extends cn.ibizlab.central.plugin.odoo.util.OdooEntityDTOBase {
    ...
    public ResDeviceLogDTO setBrowser(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetBrowser() {
    ...
    public ResDeviceLogDTO setCity(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetCity() {
    ...
    public ResDeviceLogDTO setCountry(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetCountry() {
    ...
    public ResDeviceLogDTO setCreateDate(Timestamp val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetCreateDate() {
    ...
    public ResDeviceLogDTO setCreateUid(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetCreateUid() {
     ...
     * 设置「设备类型」
     * 代码表[设备类型]
     * //@see cn.ibizlab.ibizodoo.core.runtime.dict.StaticDict.res_device_log_device_type
     * @param val
     */
    @JsonProperty(FIELD_DEVICE_TYPE)
    public ResDeviceLogDTO setDeviceType(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetDeviceType() {
    ...
    public ResDeviceLogDTO setDisplayName(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetDisplayName() {
    ...
    public ResDeviceLogDTO setFirstActivity(Timestamp val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetFirstActivity() {
    ...
    public ResDeviceLogDTO setId(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetId() {
    ...
    public ResDeviceLogDTO setIpAddress(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetIpAddress() {
    ...
    public ResDeviceLogDTO setIsCurrent(Integer val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetIsCurrent() {
    ...
    public ResDeviceLogDTO setLastActivity(Timestamp val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetLastActivity() {
    ...
    public ResDeviceLogDTO setLinkedIpAddresses(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetLinkedIpAddresses() {
    ...
    public ResDeviceLogDTO setPlatform(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetPlatform() {
    ...
    public ResDeviceLogDTO setRevoked(Integer val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetRevoked() {
    ...
    public ResDeviceLogDTO setSessionIdentifier(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetSessionIdentifier() {
    ...
    public ResDeviceLogDTO setUserId(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetUserId() {
    ...
    public ResDeviceLogDTO setWriteDate(Timestamp val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetWriteDate() {
    ...
    public ResDeviceLogDTO setWriteUid(String val) {
     ...
     */
    @JsonIgnore
    public ResDeviceLogDTO resetWriteUid() {
