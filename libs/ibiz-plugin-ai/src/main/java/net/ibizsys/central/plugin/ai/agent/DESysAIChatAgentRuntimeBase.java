...
public abstract class DESysAIChatAgentRuntimeBase extends net.ibizsys.central.cloud.core.ai.DESysAIChatAgentRuntimeBase {
	...
	protected void onInit() throws Exception {
		if (!MsgTemplEngine.FREEMARKER.value.equals(this.getPSModelObject().getTemplEngine())) {
			throw new Exception("仅支持FreeMarker模板");
		}
		this.aiFactoryRTFreeMarkerObject = new AIFactoryRTFreeMarkerObject(this.getAIFactoryRuntime());
		this.aiAgentRTFreeMarkerContext = new AIAgentRTFreeMarkerContext(this.getModelRuntimeContext());
