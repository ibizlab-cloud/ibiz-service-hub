...
import net.ibizsys.central.plugin.ai.mcp.spec.DefaultJsonSchemaValidator;
...
public interface McpServer {
	...
	class StatelessSyncSpecification {
		...
		public McpStatelessSyncServer build() {
			 ...
			 * ObjectMapper(); JsonSchemaValidator jsonSchemaValidator = this.jsonSchemaValidator != null
			...
			JsonSchemaValidator jsonSchemaValidator = this.jsonSchemaValidator != null ? this.jsonSchemaValidator
					: new DefaultJsonSchemaValidator(mapper);
			McpStatelessAsyncServer asyncServer = new McpStatelessAsyncServer(this.transport, mapper, asyncFeatures, this.requestTimeout,
					this.uriTemplateManagerFactory, jsonSchemaValidator);
