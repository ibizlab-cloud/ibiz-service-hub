 ...
 * {@link net.ibizsys.central.plugin.ai.mcp.server.McpServer#sync(McpStreamableServerTransportProvider)}
 * or
 * {@link net.ibizsys.central.plugin.ai.mcp.server.McpServer#async(McpStreamableServerTransportProvider)}.
