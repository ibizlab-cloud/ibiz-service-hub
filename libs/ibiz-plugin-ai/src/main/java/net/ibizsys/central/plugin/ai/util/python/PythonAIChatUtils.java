...
//		String code = net.ibizsys.runtime.util.ResourcesUtils.getInstance().getResourceContent(PythonAIChatUtils.class, "Module.py", false);
...
//	public static void exec(String code, Map<String, Object> inputs, Map<String, Object> outputs) {
...
//	}
//
//	public static void exec(String code, Map<String, Object> inputs, Map<String, Object> outputs, OutputStream outputStream) {
//
...
//		scriptFile = "Q:\\pyworkspace\\test\\test10.py";
		...
		try {
			...
			String[] commandArray = {
					...
					sessionId,
					"--base-url",
					String.format("http://127.0.0.1:%1$s/local/ai/sessions", ServiceHub.getInstance().getPort())
			};
	...
	public static ExecuteResult executeCommand(String command, File workingDirectory) throws ExecuteException, IOException {
		return executeCommand(command, workingDirectory, COMMAND_TIMEOUT);
	}
	public static ExecuteResult executeCommand(String command, File workingDirectory, long timeoutMs) throws ExecuteException, IOException {
