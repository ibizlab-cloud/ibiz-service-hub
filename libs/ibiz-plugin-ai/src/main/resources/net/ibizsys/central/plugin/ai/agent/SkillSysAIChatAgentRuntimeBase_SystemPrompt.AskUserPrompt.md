...
11.  **`ask_user_question(question, choices?)`**: Asks the user a question and returns their response; optionally provide a list of predefined choices for the user to select from.
