...
/**
 * <B>PSDEDATAVIEWLOGIC</B>卡片视图部件逻辑 模型传输对象
 * <P>
 * 
 */
public class PSDEDataViewLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEDataViewLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO ordervalue(Integer orderValue){
        this.setOrderValue(orderValue);
        return this;
    }

    /**
     * <B>PSDEDATAVIEWID</B>&nbsp;卡片视图部件
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdedataviewid(String pSDEDataViewId){
        this.setPSDEDataViewId(pSDEDataViewId);
        return this;
    }

    /**
     * 设置 卡片视图部件，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSDEDataViewId}
     * @param pSDEDataView 引用对象
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdedataviewid(PSDEDataViewDTO pSDEDataView){
    ...
    /**
     * <B>PSDEDATAVIEWLOGICID</B>&nbsp;卡片视图部件逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSDEDATAVIEWLOGICID = "psdedataviewlogicid";

    /**
     * 设置 卡片视图部件逻辑标识
     * 
     * @param pSDEDataViewLogicId
     * 
     */
    @JsonProperty(FIELD_PSDEDATAVIEWLOGICID)
    public void setPSDEDataViewLogicId(String pSDEDataViewLogicId){
        this.set(FIELD_PSDEDATAVIEWLOGICID, pSDEDataViewLogicId);
    }
    ...
    public String getPSDEDataViewLogicId(){
        Object objValue = this.get(FIELD_PSDEDATAVIEWLOGICID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 卡片视图部件逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSDEDataViewLogicIdDirty(){
        if(this.contains(FIELD_PSDEDATAVIEWLOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEDataViewLogicId(){
        this.reset(FIELD_PSDEDATAVIEWLOGICID);
    }

    /**
     * 设置 卡片视图部件逻辑标识
     * <P>
     * 等同 {@link #setPSDEDataViewLogicId}
     * @param pSDEDataViewLogicId
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdedataviewlogicid(String pSDEDataViewLogicId){
        this.setPSDEDataViewLogicId(pSDEDataViewLogicId);
        return this;
    }

    /**
     * <B>PSDEDATAVIEWLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSDEDATAVIEWLOGICNAME = "psdedataviewlogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSDEDataViewLogicName
     * 
     */
    @JsonProperty(FIELD_PSDEDATAVIEWLOGICNAME)
    public void setPSDEDataViewLogicName(String pSDEDataViewLogicName){
        this.set(FIELD_PSDEDATAVIEWLOGICNAME, pSDEDataViewLogicName);
    }
    ...
    public String getPSDEDataViewLogicName(){
        Object objValue = this.get(FIELD_PSDEDATAVIEWLOGICNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEDataViewLogicNameDirty(){
        if(this.contains(FIELD_PSDEDATAVIEWLOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEDataViewLogicName(){
        this.reset(FIELD_PSDEDATAVIEWLOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSDEDataViewLogicName}
     * @param pSDEDataViewLogicName
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdedataviewlogicname(String pSDEDataViewLogicName){
        this.setPSDEDataViewLogicName(pSDEDataViewLogicName);
        return this;
    }

    @JsonIgnore
    public String getName(){
        return this.getPSDEDataViewLogicName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSDEDataViewLogicName(strName);
    }

    @JsonIgnore
    public PSDEDataViewLogicDTO name(String strName){
        this.setPSDEDataViewLogicName(strName);
        return this;
    }

    /**
     * <B>PSDEDATAVIEWNAME</B>&nbsp;卡片视图部件
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdedataviewname(String pSDEDataViewName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdeid(PSDataEntityDTO pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdelogicid(PSDELogicDTO pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdeuiactionid(PSDEUIActionDTO pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssyspfpluginid(PSSysPFPluginDTO pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssysviewlogicid(PSSysViewLogicDTO pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssysviewpanelid(PSSysViewPanelDTO pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO triggertype(net.ibizsys.model.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEDataViewLogicDTO validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    public String getSrfkey(){
        return this.getPSDEDataViewLogicId();
    }

    @JsonIgnore
    public void setSrfkey(String strValue){
        this.setPSDEDataViewLogicId(strValue);
    }
    ...
    @JsonIgnore
    public PSDEDataViewLogicDTO id(String strValue){
        this.setPSDEDataViewLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEDataViewLogicDTO){
            PSDEDataViewLogicDTO dto = (PSDEDataViewLogicDTO)iEntity;
        }
