 ...
 * 
 */
public class PSDESADetailParamDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDESADetailParamDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDESADetailParamDTO stddatatype(net.ibizsys.model.PSModelEnums.StdDataType stdDataType){
        if(stdDataType == null){
     ...
     */
    @JsonIgnore
    public PSDESADetailParamDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDESADetailParamDTO){
            PSDESADetailParamDTO dto = (PSDESADetailParamDTO)iEntity;
        }
