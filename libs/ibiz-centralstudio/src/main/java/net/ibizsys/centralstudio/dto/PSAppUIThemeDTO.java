 ...
 */
public class PSAppUIThemeDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSAppUIThemeDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSAppUIThemeDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSAppUIThemeDTO){
            PSAppUIThemeDTO dto = (PSAppUIThemeDTO)iEntity;
        }
