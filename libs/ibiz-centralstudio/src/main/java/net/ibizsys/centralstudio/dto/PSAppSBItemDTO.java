 ...
 */
public class PSAppSBItemDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSAppSBItemDTO(){
    }      
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.AppStoryBoardItemType} 
     */
     ...
     */
    @JsonIgnore
    public PSAppSBItemDTO itemtype(net.ibizsys.model.PSModelEnums.AppStoryBoardItemType itemType){
        if(itemType == null){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.centralstudio.dto.PSAppStoryBoardDTO} 
     */
     ...
     */
    @JsonIgnore
    public PSAppSBItemDTO pssysusecaseid(PSSysUseCaseDTO pSSysUseCase){
     ...
     */
    @JsonIgnore
    public PSAppSBItemDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSAppSBItemDTO){
            PSAppSBItemDTO dto = (PSAppSBItemDTO)iEntity;
        }
