 ...
 * 
 */
public class PSDETreeLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDETreeLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDETreeLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDETreeLogicDTO triggertype(net.ibizsys.model.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDETreeLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDETreeLogicDTO){
            PSDETreeLogicDTO dto = (PSDETreeLogicDTO)iEntity;
        }
