 ...
 * 
 */
public class PSSysReqItemHisDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSSysReqItemHisDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysReqItemHisDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysReqItemHisDTO){
            PSSysReqItemHisDTO dto = (PSSysReqItemHisDTO)iEntity;
        }
