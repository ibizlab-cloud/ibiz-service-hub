 ...
 */
public class PSDEUtilDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {
     ...
     */
    @JsonIgnore
    public PSDEUtilDTO extendmode(net.ibizsys.model.PSModelEnums.DEExtendMode extendMode){
        if(extendMode == null){
     ...
     */
    @JsonIgnore
    public PSDEUtilDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.DEUtilType} 
     */
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEUtilDTO){
            PSDEUtilDTO dto = (PSDEUtilDTO)iEntity;
        }
