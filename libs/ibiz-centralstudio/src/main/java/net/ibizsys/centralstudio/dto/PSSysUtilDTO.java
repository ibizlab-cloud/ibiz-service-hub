 ...
 */
public class PSSysUtilDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {
     ...
     */
    @JsonIgnore
    public PSSysUtilDTO authmode(net.ibizsys.model.PSModelEnums.APIAuthMode authMode){
        if(authMode == null){
     ...
     */
    @JsonIgnore
    public PSSysUtilDTO custommode(Boolean customMode){
        if(customMode == null){
     ...
     */
    @JsonIgnore
    public PSSysUtilDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.SysUtilType} 
     */
     ...
     */
    @JsonIgnore
    public PSSysUtilDTO utiltype(net.ibizsys.model.PSModelEnums.SysUtilType utilType){
        if(utilType == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysUtilDTO){
            PSSysUtilDTO dto = (PSSysUtilDTO)iEntity;
        }
