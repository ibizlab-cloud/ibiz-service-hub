 ...
 */
public class PSSysDBPartDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSSysDBPartDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO bl_pos(net.ibizsys.model.PSModelEnums.BorderLayoutPos bL_Pos){
        if(bL_Pos == null){
            this.setBL_Pos(null);
        }
        else{
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO contenttype(net.ibizsys.model.PSModelEnums.RawItemContentType contentType){
        if(contentType == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.DashboardPartType} 
     */
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO dbparttype(net.ibizsys.model.PSModelEnums.DashboardPartType dBPartType){
        if(dBPartType == null){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO flexalign(net.ibizsys.model.PSModelEnums.FlexAlign flexAlign){
        if(flexAlign == null){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO flexdir(net.ibizsys.model.PSModelEnums.FlexLayoutDir flexDir){
        if(flexDir == null){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO flexvalign(net.ibizsys.model.PSModelEnums.FlexVAlign flexVAlign){
        if(flexVAlign == null){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO halignself(net.ibizsys.model.PSModelEnums.TextAlign hAlignSelf){
        if(hAlignSelf == null){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO layoutmode(net.ibizsys.model.PSModelEnums.LayoutMode layoutMode){
        if(layoutMode == null){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO partstyle(net.ibizsys.model.PSModelEnums.CtrlDetailStyle partStyle){
        if(partStyle == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.PortletType} 
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO titlebarclosemode(net.ibizsys.model.PSModelEnums.GroupTitleBarCloseMode titleBarCloseMode){
     ...
     */
    @JsonIgnore
    public PSSysDBPartDTO valignself(net.ibizsys.model.PSModelEnums.TextVAlign vAlignSelf){
        if(vAlignSelf == null){
    ...
    private java.util.List<net.ibizsys.centralstudio.dto.PSSysDBPartDTO> pssysdbparts;
    ...
    public java.util.List<net.ibizsys.centralstudio.dto.PSSysDBPartDTO> getPSSysDBParts(){
     ...
     */
    @JsonProperty(FIELD_PSSYSDBPARTS)
    public void setPSSysDBParts(java.util.List<net.ibizsys.centralstudio.dto.PSSysDBPartDTO> pssysdbparts){
     ...
     */
    @JsonIgnore
    public java.util.List<net.ibizsys.centralstudio.dto.PSSysDBPartDTO> getPSSysDBPartsIf(){
        if(this.pssysdbparts == null){
            this.pssysdbparts = new java.util.ArrayList<net.ibizsys.centralstudio.dto.PSSysDBPartDTO>();          
        }
        return this.pssysdbparts;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysDBPartDTO){
            PSSysDBPartDTO dto = (PSSysDBPartDTO)iEntity;
            dto.setPSSysDBParts(this.getPSSysDBParts());
        }
