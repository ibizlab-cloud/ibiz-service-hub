...
/**
 * <B>PSAPPWF</B>应用工作流 模型传输对象
 * <P>
 * 应用工作流模型，定义前端应用加载的工作流
 */
public class PSAppWFDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {
     ...
     */
    @JsonIgnore
    public PSAppWFDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }

    /**
     * <B>PSAPPMODULEID</B>&nbsp;应用模块，指定应用工作流所属应用模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psappmoduleid(String pSAppModuleId){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psappmoduleid(PSAppModuleDTO pSAppModule){
        if(pSAppModule == null){
    ...
    /**
     * <B>PSAPPMODULENAME</B>&nbsp;应用模块，指定应用工作流所属应用模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psappmodulename(String pSAppModuleName){
        this.setPSAppModuleName(pSAppModuleName);
        return this;
    }

    /**
     * <B>PSAPPWFID</B>&nbsp;应用工作流标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psappwfid(String pSAppWFId){
        this.setPSAppWFId(pSAppWFId);
        return this;
    }

    /**
     * <B>PSAPPWFNAME</B>&nbsp;应用工作流名称，指定应用工作流的名称，需在所属前端应用中具备唯一性
     * <P>
     * 字符串：最大长度 200
     */
    ...
    /**
     * 设置 应用工作流名称，详细说明：{@link #FIELD_PSAPPWFNAME}
     * 
     * @param pSAppWFName
     * 
     */
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psappwfname(String pSAppWFName){
    ...
    public String getName(){
        return this.getPSAppWFName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSAppWFName(strName);
    }

    @JsonIgnore
    public PSAppWFDTO name(String strName){
        this.setPSAppWFName(strName);
        return this;
    }

    /**
     * <B>PSSYSAPPID</B>&nbsp;系统应用，指定应用工作流所属的前端应用
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppWFDTO pssysappid(String pSSysAppId){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO pssysappid(PSSysAppDTO pSSysApp){
        if(pSSysApp == null){
    ...
    /**
     * <B>PSSYSAPPNAME</B>&nbsp;前端应用，指定应用工作流所属的前端应用
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppWFDTO pssysappname(String pSSysAppName){
        this.setPSSysAppName(pSSysAppName);
        return this;
    }

    /**
     * <B>PSWORKFLOWID</B>&nbsp;工作流，指定应用工作流引用的系统工作流
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psworkflowid(String pSWorkflowId){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psworkflowid(PSWorkflowDTO pSWorkflow){
        if(pSWorkflow == null){
    ...
    /**
     * <B>PSWORKFLOWNAME</B>&nbsp;工作流，指定应用工作流引用的系统工作流
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppWFDTO psworkflowname(String pSWorkflowName){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSAppWFDTO validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSAppWFDTO id(String strValue){
        this.setPSAppWFId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSAppWFDTO){
            PSAppWFDTO dto = (PSAppWFDTO)iEntity;
        }
