...
/**
 * <B>PSSYSCALENDARLOGIC</B>日历部件逻辑 模型传输对象
 * <P>
 * 
 */
public class PSSysCalendarLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSSysCalendarLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdeid(PSDataEntityDTO pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdelogicid(PSDELogicDTO pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdeuiactionid(PSDEUIActionDTO pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendarid(String pSSysCalendarId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendarid(PSSysCalendarDTO pSSysCalendar){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.centralstudio.dto.PSSysCalendarItemDTO} 
     */
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendaritemid(String pSSysCalendarItemId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendaritemid(PSSysCalendarItemDTO pSSysCalendarItem){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendaritemname(String pSSysCalendarItemName){
        this.setPSSysCalendarItemName(pSSysCalendarItemName);
        return this;
    }

    /**
     * <B>PSSYSCALENDARLOGICID</B>&nbsp;日历部件逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSSYSCALENDARLOGICID = "pssyscalendarlogicid";

    /**
     * 设置 日历部件逻辑标识
     * 
     * @param pSSysCalendarLogicId
     * 
     */
    @JsonProperty(FIELD_PSSYSCALENDARLOGICID)
    public void setPSSysCalendarLogicId(String pSSysCalendarLogicId){
        this.set(FIELD_PSSYSCALENDARLOGICID, pSSysCalendarLogicId);
    }
    ...
    public String getPSSysCalendarLogicId(){
        Object objValue = this.get(FIELD_PSSYSCALENDARLOGICID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 日历部件逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSSysCalendarLogicIdDirty(){
        if(this.contains(FIELD_PSSYSCALENDARLOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSSysCalendarLogicId(){
        this.reset(FIELD_PSSYSCALENDARLOGICID);
    }

    /**
     * 设置 日历部件逻辑标识
     * <P>
     * 等同 {@link #setPSSysCalendarLogicId}
     * @param pSSysCalendarLogicId
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendarlogicid(String pSSysCalendarLogicId){
        this.setPSSysCalendarLogicId(pSSysCalendarLogicId);
        return this;
    }

    /**
     * <B>PSSYSCALENDARLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSSYSCALENDARLOGICNAME = "pssyscalendarlogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSSysCalendarLogicName
     * 
     */
    @JsonProperty(FIELD_PSSYSCALENDARLOGICNAME)
    public void setPSSysCalendarLogicName(String pSSysCalendarLogicName){
        this.set(FIELD_PSSYSCALENDARLOGICNAME, pSSysCalendarLogicName);
    }
    ...
    public String getPSSysCalendarLogicName(){
        Object objValue = this.get(FIELD_PSSYSCALENDARLOGICNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSSysCalendarLogicNameDirty(){
        if(this.contains(FIELD_PSSYSCALENDARLOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSSysCalendarLogicName(){
        this.reset(FIELD_PSSYSCALENDARLOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSSysCalendarLogicName}
     * @param pSSysCalendarLogicName
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendarlogicname(String pSSysCalendarLogicName){
        this.setPSSysCalendarLogicName(pSSysCalendarLogicName);
        return this;
    }

    @JsonIgnore
    public String getName(){
        return this.getPSSysCalendarLogicName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSSysCalendarLogicName(strName);
    }

    @JsonIgnore
    public PSSysCalendarLogicDTO name(String strName){
        this.setPSSysCalendarLogicName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyscalendarname(String pSSysCalendarName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyspfpluginid(PSSysPFPluginDTO pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssysviewlogicid(PSSysViewLogicDTO pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssysviewpanelid(PSSysViewPanelDTO pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO triggertype(net.ibizsys.model.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSSysCalendarLogicDTO validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    public String getSrfkey(){
        return this.getPSSysCalendarLogicId();
    }

    @JsonIgnore
    public void setSrfkey(String strValue){
        this.setPSSysCalendarLogicId(strValue);
    }
    ...
    @JsonIgnore
    public PSSysCalendarLogicDTO id(String strValue){
        this.setPSSysCalendarLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysCalendarLogicDTO){
            PSSysCalendarLogicDTO dto = (PSSysCalendarLogicDTO)iEntity;
        }
