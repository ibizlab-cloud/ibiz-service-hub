 ...
 */
public class PSWXMenuDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {
     ...
     */
    @JsonIgnore
    public PSWXMenuDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSWXMenuDTO){
            PSWXMenuDTO dto = (PSWXMenuDTO)iEntity;
