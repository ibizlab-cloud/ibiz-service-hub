 ...
 */
public class PSAppFuncDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.AppFuncType} 
     */
     ...
     */
    @JsonIgnore
    public PSAppFuncDTO appfunctype(net.ibizsys.model.PSModelEnums.AppFuncType appFuncType){
        if(appFuncType == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.AppFuncOpenMode} 
     */
     ...
     */
    @JsonIgnore
    public PSAppFuncDTO openmode(net.ibizsys.model.PSModelEnums.AppFuncOpenMode openMode){
        if(openMode == null){
     ...
     */
    @JsonIgnore
    public PSAppFuncDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSAppFuncDTO){
            PSAppFuncDTO dto = (PSAppFuncDTO)iEntity;
        }
