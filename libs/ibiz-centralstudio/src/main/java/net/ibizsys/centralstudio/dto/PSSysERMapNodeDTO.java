 ...
 * 
 */
public class PSSysERMapNodeDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSSysERMapNodeDTO(){
    }      
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.centralstudio.dto.PSSysERMapDTO} 
     */
     ...
     */
    @JsonIgnore
    public PSSysERMapNodeDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysERMapNodeDTO){
            PSSysERMapNodeDTO dto = (PSSysERMapNodeDTO)iEntity;
        }
