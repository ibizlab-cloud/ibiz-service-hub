...
/**
 * <B>PSDEDATAVIEW</B>实体卡片视图 模型传输对象
 * <P>
 * 实体卡片视图部件模型，定义容器、卡片及分组项的界面逻辑及数据项等处理逻辑，一般需要指定卡片的布局面板。卡片视图支持启用看板（KanBan）模式，配置卡片在分组间移动的逻辑
 */
public class PSDEDataViewDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEDataViewDTO(){
    }      
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.DataViewStyle} 
     */
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO dataviewstyle(net.ibizsys.model.PSModelEnums.DataViewStyle dataViewStyle){
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO enableedit(net.ibizsys.model.PSModelEnums.MDCtrlEditMode[] enableEdit){
    ...
    /**
     * <B>ENABLEPAGINGBAR</B>&nbsp;启用分页工具栏，指定卡片视图是否支持分页工具栏，未定义时为【否】
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.YesNo} 
     */
    ...
    /**
     * 设置 启用分页工具栏，详细说明：{@link #FIELD_ENABLEPAGINGBAR}
     * 
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO enablepagingbar(Boolean enablePagingBar){
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO groupbarclosemode(net.ibizsys.model.PSModelEnums.GroupTitleBarCloseMode groupBarCloseMode){
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO grouplayout(net.ibizsys.model.PSModelEnums.MDCtrlGroupLayout groupLayout){
        if(groupLayout == null){
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO groupmode(net.ibizsys.model.PSModelEnums.MDCtrlGroupMode groupMode){
        if(groupMode == null){
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO minorsortdir(net.ibizsys.model.PSModelEnums.SortDir minorSortDir){
     ...
     */
    @JsonIgnore
    public PSDEDataViewDTO pagingsize(net.ibizsys.model.PSModelEnums.PagingSize pagingSize){
        if(pagingSize == null){
    ...
    public java.util.List<net.ibizsys.centralstudio.dto.PSDEListItemDTO> getPSDEListItem(){
     ...
     */
    @JsonProperty(FIELD_PSDELISTITEM)
    public void setPSDEListItem(java.util.List<net.ibizsys.centralstudio.dto.PSDEListItemDTO> psdelistitems){
     ...
     */
    @JsonIgnore
    public java.util.List<net.ibizsys.centralstudio.dto.PSDEListItemDTO> getPSDEListItemIf(){
    ...
    private java.util.List<net.ibizsys.centralstudio.dto.PSDEDataViewLogicDTO> psdedataviewlogics;
    ...
    public java.util.List<net.ibizsys.centralstudio.dto.PSDEDataViewLogicDTO> getPSDEDataViewLogics(){
     ...
     */
    @JsonProperty(FIELD_PSDEDATAVIEWLOGICS)
    public void setPSDEDataViewLogics(java.util.List<net.ibizsys.centralstudio.dto.PSDEDataViewLogicDTO> psdedataviewlogics){
     ...
     */
    @JsonIgnore
    public java.util.List<net.ibizsys.centralstudio.dto.PSDEDataViewLogicDTO> getPSDEDataViewLogicsIf(){
        if(this.psdedataviewlogics == null){
            this.psdedataviewlogics = new java.util.ArrayList<net.ibizsys.centralstudio.dto.PSDEDataViewLogicDTO>();          
        }
        return this.psdedataviewlogics;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEDataViewDTO){
            PSDEDataViewDTO dto = (PSDEDataViewDTO)iEntity;
            dto.setPSDEListItem(this.getPSDEListItem());
            dto.setPSDEDataViewLogics(this.getPSDEDataViewLogics());
        }
