...
/**
 * <B>PSDELISTLOGIC</B>实体列表逻辑 模型传输对象
 * <P>
 * 
 */
public class PSDEListLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEListLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdeid(PSDataEntityDTO pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistid(String pSDEListId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistid(PSDEListDTO pSDEList){
        if(pSDEList == null){
    ...
    /**
     * <B>PSDELISTITEMID</B>&nbsp;列表项
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.centralstudio.dto.PSDEListItemDTO} 
     */
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistitemid(String pSDEListItemId){
        this.setPSDEListItemId(pSDEListItemId);
        return this;
    }

    /**
     * 设置 列表项，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSDEListItemId}
     * @param pSDEListItem 引用对象
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistitemid(PSDEListItemDTO pSDEListItem){
        if(pSDEListItem == null){
            this.setPSDEListItemId(null);
            this.setPSDEListItemName(null);
        }
        else{
            this.setPSDEListItemId(pSDEListItem.getPSDEListItemId());
            this.setPSDEListItemName(pSDEListItem.getPSDEListItemName());
        }
        return this;
    }

    /**
     * <B>PSDELISTITEMNAME</B>&nbsp;列表项
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_PSDELISTITEMID}
     */
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistitemname(String pSDEListItemName){
        this.setPSDEListItemName(pSDEListItemName);
        return this;
    }

    /**
     * <B>PSDELISTLOGICID</B>&nbsp;实体列表逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSDELISTLOGICID = "psdelistlogicid";

    /**
     * 设置 实体列表逻辑标识
     * 
     * @param pSDEListLogicId
     * 
     */
    @JsonProperty(FIELD_PSDELISTLOGICID)
    public void setPSDEListLogicId(String pSDEListLogicId){
        this.set(FIELD_PSDELISTLOGICID, pSDEListLogicId);
    }
    ...
    public String getPSDEListLogicId(){
        Object objValue = this.get(FIELD_PSDELISTLOGICID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 实体列表逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSDEListLogicIdDirty(){
        if(this.contains(FIELD_PSDELISTLOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEListLogicId(){
        this.reset(FIELD_PSDELISTLOGICID);
    }

    /**
     * 设置 实体列表逻辑标识
     * <P>
     * 等同 {@link #setPSDEListLogicId}
     * @param pSDEListLogicId
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistlogicid(String pSDEListLogicId){
        this.setPSDEListLogicId(pSDEListLogicId);
        return this;
    }

    /**
     * <B>PSDELISTLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSDELISTLOGICNAME = "psdelistlogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSDEListLogicName
     * 
     */
    @JsonProperty(FIELD_PSDELISTLOGICNAME)
    public void setPSDEListLogicName(String pSDEListLogicName){
        this.set(FIELD_PSDELISTLOGICNAME, pSDEListLogicName);
    }
    ...
    public String getPSDEListLogicName(){
        Object objValue = this.get(FIELD_PSDELISTLOGICNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEListLogicNameDirty(){
        if(this.contains(FIELD_PSDELISTLOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEListLogicName(){
        this.reset(FIELD_PSDELISTLOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSDEListLogicName}
     * @param pSDEListLogicName
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistlogicname(String pSDEListLogicName){
        this.setPSDEListLogicName(pSDEListLogicName);
        return this;
    }

    @JsonIgnore
    public String getName(){
        return this.getPSDEListLogicName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSDEListLogicName(strName);
    }

    @JsonIgnore
    public PSDEListLogicDTO name(String strName){
        this.setPSDEListLogicName(strName);
        return this;
    }

    /**
     * <B>PSDELISTNAME</B>&nbsp;实体列表
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelistname(String pSDEListName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelogicid(PSDELogicDTO pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdeuiactionid(PSDEUIActionDTO pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssyspfpluginid(PSSysPFPluginDTO pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssysviewlogicid(PSSysViewLogicDTO pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssysviewpanelid(PSSysViewPanelDTO pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO triggertype(net.ibizsys.model.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEListLogicDTO validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    public String getSrfkey(){
        return this.getPSDEListLogicId();
    }

    @JsonIgnore
    public void setSrfkey(String strValue){
        this.setPSDEListLogicId(strValue);
    }
    ...
    @JsonIgnore
    public PSDEListLogicDTO id(String strValue){
        this.setPSDEListLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEListLogicDTO){
            PSDEListLogicDTO dto = (PSDEListLogicDTO)iEntity;
        }
