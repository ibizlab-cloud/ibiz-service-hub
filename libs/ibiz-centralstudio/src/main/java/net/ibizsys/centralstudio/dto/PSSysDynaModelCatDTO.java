 ...
 */
public class PSSysDynaModelCatDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSSysDynaModelCatDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO psmoduleid(PSModuleDTO pSModule){
        if(pSModule == null){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO psmodulename(String pSModuleName){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO pssysdynamodelcatid(String pSSysDynaModelCatId){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO pssysdynamodelcatname(String pSSysDynaModelCatName){
    ...
    @JsonIgnore
    public PSSysDynaModelCatDTO name(String strName){
        this.setPSSysDynaModelCatName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysDynaModelCatDTO usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSSysDynaModelCatDTO id(String strValue){
        this.setPSSysDynaModelCatId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysDynaModelCatDTO){
            PSSysDynaModelCatDTO dto = (PSSysDynaModelCatDTO)iEntity;
        }
