 ...
 * 模型 PSDEUTIL 过滤器对象
 */
public class PSDEUtilFilter extends net.ibizsys.centralstudio.util.PSModelSearchContextDTO {
    ...
    public PSDEUtilFilter psdeutilname__eq(String value){
        this.setFieldCond("psdeutilname", Conditions.EQ, value);
        //属性名称与代码标识不一致，设置属性名称
        this.setFieldCond("psdeutildename", Conditions.EQ, value);
        return this;
    }
    ...
    public PSDEUtilFilter psdeutilname__like(String value){
        this.setFieldCond("psdeutilname", Conditions.LIKE, value);
        //属性名称与代码标识不一致，设置属性名称
