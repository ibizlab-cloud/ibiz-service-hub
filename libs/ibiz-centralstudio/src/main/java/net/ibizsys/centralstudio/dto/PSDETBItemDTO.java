 ...
 */
public class PSDETBItemDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDETBItemDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO actionlevel(net.ibizsys.model.PSModelEnums.UIActionLevel actionLevel){
        if(actionLevel == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.ToolbarButtonActionType} 
     */
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO btnactiontype(net.ibizsys.model.PSModelEnums.ToolbarButtonActionType btnActionType){
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO contenttype(net.ibizsys.model.PSModelEnums.RawItemContentType contentType){
        if(contentType == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.UGExtractMode} 
     */
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO groupextractmode(net.ibizsys.model.PSModelEnums.UGExtractMode groupExtractMode){
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO noprivdm(net.ibizsys.model.PSModelEnums.BtnNoPrivDisplayMode noPrivDM){
        if(noPrivDM == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.TBItemShowMode} 
     */
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO showmode(net.ibizsys.model.PSModelEnums.TBItemShowMode showMode){
        if(showMode == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.TBItemType} 
     */
     ...
     */
    @JsonIgnore
    public PSDETBItemDTO tbitemtype(net.ibizsys.model.PSModelEnums.TBItemType tBItemType){
        if(tBItemType == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDETBItemDTO){
            PSDETBItemDTO dto = (PSDETBItemDTO)iEntity;
