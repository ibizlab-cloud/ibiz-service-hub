 ...
 */
public class PSWFWorkTimeDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSWFWorkTimeDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSWFWorkTimeDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSWFWorkTimeDTO){
            PSWFWorkTimeDTO dto = (PSWFWorkTimeDTO)iEntity;
        }
