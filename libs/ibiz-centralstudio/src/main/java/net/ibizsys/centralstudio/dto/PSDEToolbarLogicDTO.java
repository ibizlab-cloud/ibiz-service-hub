 ...
 * 
 */
public class PSDEToolbarLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEToolbarLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.centralstudio.dto.PSDETBItemDTO} 
     */
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogicDTO triggertype(net.ibizsys.model.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEToolbarLogicDTO){
            PSDEToolbarLogicDTO dto = (PSDEToolbarLogicDTO)iEntity;
        }
