...
/**
 * <B>PSDEFORMLOGIC</B>实体表单逻辑 模型传输对象
 * <P>
 * 
 */
public class PSDEFormLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEFormLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO ordervalue(Integer orderValue){
        this.setOrderValue(orderValue);
        return this;
    }

    /**
     * <B>PSDEFORMDETAILID</B>&nbsp;表单成员
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformdetailid(String pSDEFormDetailId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformdetailid(PSDEFormDetailDTO pSDEFormDetail){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformdetailname(String pSDEFormDetailName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformid(String pSDEFormId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformid(PSDEFormDTO pSDEForm){
        if(pSDEForm == null){
    ...
    /**
     * <B>PSDEFORMLOGICID</B>&nbsp;实体表单逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSDEFORMLOGICID = "psdeformlogicid";

    /**
     * 设置 实体表单逻辑标识
     * 
     * @param pSDEFormLogicId
     * 
     */
    @JsonProperty(FIELD_PSDEFORMLOGICID)
    public void setPSDEFormLogicId(String pSDEFormLogicId){
        this.set(FIELD_PSDEFORMLOGICID, pSDEFormLogicId);
    }
    ...
    public String getPSDEFormLogicId(){
        Object objValue = this.get(FIELD_PSDEFORMLOGICID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 实体表单逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSDEFormLogicIdDirty(){
        if(this.contains(FIELD_PSDEFORMLOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEFormLogicId(){
        this.reset(FIELD_PSDEFORMLOGICID);
    }

    /**
     * 设置 实体表单逻辑标识
     * <P>
     * 等同 {@link #setPSDEFormLogicId}
     * @param pSDEFormLogicId
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformlogicid(String pSDEFormLogicId){
        this.setPSDEFormLogicId(pSDEFormLogicId);
        return this;
    }

    /**
     * <B>PSDEFORMLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSDEFORMLOGICNAME = "psdeformlogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSDEFormLogicName
     * 
     */
    @JsonProperty(FIELD_PSDEFORMLOGICNAME)
    public void setPSDEFormLogicName(String pSDEFormLogicName){
        this.set(FIELD_PSDEFORMLOGICNAME, pSDEFormLogicName);
    }
    ...
    public String getPSDEFormLogicName(){
        Object objValue = this.get(FIELD_PSDEFORMLOGICNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEFormLogicNameDirty(){
        if(this.contains(FIELD_PSDEFORMLOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEFormLogicName(){
        this.reset(FIELD_PSDEFORMLOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSDEFormLogicName}
     * @param pSDEFormLogicName
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformlogicname(String pSDEFormLogicName){
        this.setPSDEFormLogicName(pSDEFormLogicName);
        return this;
    }

    @JsonIgnore
    public String getName(){
        return this.getPSDEFormLogicName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSDEFormLogicName(strName);
    }

    @JsonIgnore
    public PSDEFormLogicDTO name(String strName){
        this.setPSDEFormLogicName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeformname(String pSDEFormName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeid(PSDataEntityDTO pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdelogicid(PSDELogicDTO pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeuiactionid(PSDEUIActionDTO pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssyspfpluginid(PSSysPFPluginDTO pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssysviewlogicid(PSSysViewLogicDTO pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssysviewpanelid(PSSysViewPanelDTO pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO triggertype(net.ibizsys.model.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEFormLogicDTO validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    public String getSrfkey(){
        return this.getPSDEFormLogicId();
    }

    @JsonIgnore
    public void setSrfkey(String strValue){
        this.setPSDEFormLogicId(strValue);
    }
    ...
    @JsonIgnore
    public PSDEFormLogicDTO id(String strValue){
        this.setPSDEFormLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEFormLogicDTO){
            PSDEFormLogicDTO dto = (PSDEFormLogicDTO)iEntity;
        }
