 ...
 */
public class PSDERGroupDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDERGroupDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDERGroupDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    private java.util.List<net.ibizsys.centralstudio.dto.PSDERGroupDetailDTO> psdergroupdetails;
    ...
    public java.util.List<net.ibizsys.centralstudio.dto.PSDERGroupDetailDTO> getPSDERGroupDetails(){
     ...
     */
    @JsonProperty(FIELD_PSDERGROUPDETAILS)
    public void setPSDERGroupDetails(java.util.List<net.ibizsys.centralstudio.dto.PSDERGroupDetailDTO> psdergroupdetails){
     ...
     */
    @JsonIgnore
    public java.util.List<net.ibizsys.centralstudio.dto.PSDERGroupDetailDTO> getPSDERGroupDetailsIf(){
        if(this.psdergroupdetails == null){
            this.psdergroupdetails = new java.util.ArrayList<net.ibizsys.centralstudio.dto.PSDERGroupDetailDTO>();          
        }
        return this.psdergroupdetails;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDERGroupDTO){
            PSDERGroupDTO dto = (PSDERGroupDTO)iEntity;
            dto.setPSDERGroupDetails(this.getPSDERGroupDetails());
        }
