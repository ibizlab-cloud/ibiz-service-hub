 ...
 */
public class PSDEMapActionDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEMapActionDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDEMapActionDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEMapActionDTO){
            PSDEMapActionDTO dto = (PSDEMapActionDTO)iEntity;
        }
