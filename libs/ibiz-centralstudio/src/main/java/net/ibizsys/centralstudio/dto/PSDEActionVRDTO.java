 ...
 */
public class PSDEActionVRDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSDEActionVRDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSDEActionVRDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEActionVRDTO vrtype(net.ibizsys.model.PSModelEnums.TargetVRType vRType){
        if(vRType == null){
            this.setVRType(null);
        }
        else{
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSDEActionVRDTO){
            PSDEActionVRDTO dto = (PSDEActionVRDTO)iEntity;
        }
