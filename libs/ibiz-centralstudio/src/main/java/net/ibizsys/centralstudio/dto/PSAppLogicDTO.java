...
/**
 * <B>PSAPPLOGIC</B>前端应用逻辑 模型传输对象
 * <P>
 * 
 */
public class PSAppLogicDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSAppLogicDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO createdate(Timestamp createDate){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO dstlogictype(net.ibizsys.model.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO itemname(String itemName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO ordervalue(Integer orderValue){
        this.setOrderValue(orderValue);
        return this;
    }

    /**
     * <B>PSAPPLOGICID</B>&nbsp;前端应用逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSAPPLOGICID = "psapplogicid";
     ...
     * 
     */
    @JsonProperty(FIELD_PSAPPLOGICID)
    ...
    /**
     * 判断 前端应用逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSAppLogicIdDirty(){
        if(this.contains(FIELD_PSAPPLOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSAppLogicId(){
        this.reset(FIELD_PSAPPLOGICID);
    }

    /**
     * 设置 前端应用逻辑标识
     * <P>
     * 等同 {@link #setPSAppLogicId}
     * @param pSAppLogicId
     */
    @JsonIgnore
    public PSAppLogicDTO psapplogicid(String pSAppLogicId){
        this.setPSAppLogicId(pSAppLogicId);
        return this;
    }

    /**
     * <B>PSAPPLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSAPPLOGICNAME = "psapplogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSAppLogicName
     * 
     */
    @JsonProperty(FIELD_PSAPPLOGICNAME)
    ...
    public boolean isPSAppLogicNameDirty(){
        if(this.contains(FIELD_PSAPPLOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSAppLogicName(){
        this.reset(FIELD_PSAPPLOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSAppLogicName}
     * @param pSAppLogicName
     */
    @JsonIgnore
    public PSAppLogicDTO psapplogicname(String pSAppLogicName){
        this.setPSAppLogicName(pSAppLogicName);
        return this;
    }

    @JsonIgnore
    public String getName(){
        return this.getPSAppLogicName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSAppLogicName(strName);
    }

    @JsonIgnore
    public PSAppLogicDTO name(String strName){
        this.setPSAppLogicName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdeid(PSDataEntityDTO pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdelogicid(PSDELogicDTO pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdeuiactionid(PSDEUIActionDTO pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssysappid(String pSSysAppId){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssysappid(PSSysAppDTO pSSysApp){
        if(pSSysApp == null){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssysappname(String pSSysAppName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssyspfpluginid(PSSysPFPluginDTO pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssysviewlogicid(PSSysViewLogicDTO pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.model.PSModelEnums.AppLogicTrigger} 
     */
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO triggertype(net.ibizsys.model.PSModelEnums.AppLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO updatedate(Timestamp updateDate){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSAppLogicDTO validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSAppLogicDTO id(String strValue){
        this.setPSAppLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSAppLogicDTO){
            PSAppLogicDTO dto = (PSAppLogicDTO)iEntity;
        }
