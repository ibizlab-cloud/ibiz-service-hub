 ...
 * 系统操作者模型
 */
public class PSSysActorDTO extends net.ibizsys.centralstudio.util.PSModelDTOBase {

    public PSSysActorDTO(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysActorDTO usercat(net.ibizsys.model.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
    ...
    public void copyTo(net.ibizsys.centralstudio.util.IEntity iEntity){
        if(iEntity instanceof PSSysActorDTO){
            PSSysActorDTO dto = (PSSysActorDTO)iEntity;
        }
