...
public class PSDEOPPrivRoleRTService extends PSModelRTServiceBase<PSDEOPPrivRole, PSModelFilter>{
    private static final Log log = LogFactory.getLog(PSDEOPPrivRoleRTService.class);
