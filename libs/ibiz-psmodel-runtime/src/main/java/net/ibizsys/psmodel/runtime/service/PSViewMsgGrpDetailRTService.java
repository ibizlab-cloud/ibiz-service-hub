...
public class PSViewMsgGrpDetailRTService extends PSModelRTServiceBase<PSViewMsgGrpDetail, PSModelFilter>{
    private static final Log log = LogFactory.getLog(PSViewMsgGrpDetailRTService.class);
