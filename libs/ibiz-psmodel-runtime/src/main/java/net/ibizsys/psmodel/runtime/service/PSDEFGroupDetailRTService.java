...
public class PSDEFGroupDetailRTService extends PSModelRTServiceBase<PSDEFGroupDetail, PSModelFilter>{
    private static final Log log = LogFactory.getLog(PSDEFGroupDetailRTService.class);
