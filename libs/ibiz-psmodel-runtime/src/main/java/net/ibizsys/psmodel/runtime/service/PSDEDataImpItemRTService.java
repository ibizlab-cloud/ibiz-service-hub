...
public class PSDEDataImpItemRTService extends PSModelRTServiceBase<PSDEDataImpItem, PSModelFilter>{
    private static final Log log = LogFactory.getLog(PSDEDataImpItemRTService.class);
