...
public class PSDEActionParamRTService extends PSModelRTServiceBase<PSDEActionParam, PSModelFilter>{
    private static final Log log = LogFactory.getLog(PSDEActionParamRTService.class);
