...
public class PSDEDBIdxFieldRTService extends PSModelRTServiceBase<PSDEDBIdxField, PSModelFilter>{
    private static final Log log = LogFactory.getLog(PSDEDBIdxFieldRTService.class);
