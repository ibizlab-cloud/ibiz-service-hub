...
import static net.ibizsys.model.control.searchbar.PSSysSearchBarLogicImpl.*;



public class PSSysSearchBarLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.searchbar.PSSysSearchBarLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.searchbar.PSSysSearchBarLogicImpl realPSModelObject = (net.ibizsys.model.control.searchbar.PSSysSearchBarLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "pssyssearchbaritemname", realPSModelObject.getPSSysSearchBarItemName(), realPSModelObject, "getPSSysSearchBarItemName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSSYSSEARCHBARITEMNAME, domain, "pssyssearchbaritemname", java.lang.String.class);
