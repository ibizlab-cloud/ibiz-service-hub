...
public class PSDETBUIActionItemMerger extends net.ibizsys.model.util.merger.control.toolbar.PSDEToolbarItemMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.toolbar.PSDETBUIActionItemImpl.class, strFieldName);
