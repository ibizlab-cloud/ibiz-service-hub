...
import static net.ibizsys.model.control.drctrl.PSDEDRBarGroupImpl.*;



public class PSDEDRBarGroupTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.drctrl.PSDEDRBarGroupImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.drctrl.PSDEDRBarGroupImpl realPSModelObject = (net.ibizsys.model.control.drctrl.PSDEDRBarGroupImpl)iPSModelObject;
