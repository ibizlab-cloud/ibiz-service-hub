...
public class PSSysDBTableTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{
	...
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "tableparams", realPSModelObject.getTableParams(), realPSModelObject, "getTableParams");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETTABLEPARAMS, domain, "tableparams", com.fasterxml.jackson.databind.node.ObjectNode.class);
