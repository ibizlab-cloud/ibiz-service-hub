...
public class PSWFEmbedWFProcessMerger extends net.ibizsys.model.util.merger.wf.PSWFEmbedWFProcessBaseMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.wf.PSWFEmbedWFProcessImpl.class, strFieldName);
