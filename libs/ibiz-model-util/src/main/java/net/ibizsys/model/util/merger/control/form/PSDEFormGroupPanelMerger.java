...
public class PSDEFormGroupPanelMerger extends net.ibizsys.model.util.merger.control.form.PSDEFormBaseGroupPanelMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.form.PSDEFormGroupPanelImpl.class, strFieldName);
