...
public class PSDETreeUAColumnTranspiler extends net.ibizsys.model.util.transpiler.control.tree.PSDETreeColumnTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.tree.PSDETreeUAColumnImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.tree.PSDETreeUAColumnImpl realPSModelObject = (net.ibizsys.model.control.tree.PSDETreeUAColumnImpl)iPSModelObject;
