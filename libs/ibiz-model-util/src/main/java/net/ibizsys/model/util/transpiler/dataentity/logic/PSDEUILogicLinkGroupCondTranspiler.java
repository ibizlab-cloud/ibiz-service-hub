...
public class PSDEUILogicLinkGroupCondTranspiler extends net.ibizsys.model.util.transpiler.dataentity.logic.PSDEUILogicLinkCondTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.logic.PSDEUILogicLinkGroupCondImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.logic.PSDEUILogicLinkGroupCondImpl realPSModelObject = (net.ibizsys.model.dataentity.logic.PSDEUILogicLinkGroupCondImpl)iPSModelObject;
