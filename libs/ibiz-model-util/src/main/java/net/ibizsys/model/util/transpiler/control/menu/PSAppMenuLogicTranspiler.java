...
import static net.ibizsys.model.control.menu.PSAppMenuLogicImpl.*;



public class PSAppMenuLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.menu.PSAppMenuLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.menu.PSAppMenuLogicImpl realPSModelObject = (net.ibizsys.model.control.menu.PSAppMenuLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psappmenuitemname", realPSModelObject.getPSAppMenuItemName(), realPSModelObject, "getPSAppMenuItemName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSAPPMENUITEMNAME, domain, "psappmenuitemname", java.lang.String.class);
