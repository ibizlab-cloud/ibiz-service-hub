...
public class PSDEViewPanelMerger extends net.ibizsys.model.util.merger.control.PSControlMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.viewpanel.PSDEViewPanelImpl.class, strFieldName);
