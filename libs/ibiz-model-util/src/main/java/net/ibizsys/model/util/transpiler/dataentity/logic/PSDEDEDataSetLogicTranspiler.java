...
import static net.ibizsys.model.dataentity.logic.PSDEDEDataSetLogicImpl.*;



public class PSDEDEDataSetLogicTranspiler extends net.ibizsys.model.util.transpiler.dataentity.logic.PSDELogicNodeTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.logic.PSDEDEDataSetLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.logic.PSDEDEDataSetLogicImpl realPSModelObject = (net.ibizsys.model.dataentity.logic.PSDEDEDataSetLogicImpl)iPSModelObject;
