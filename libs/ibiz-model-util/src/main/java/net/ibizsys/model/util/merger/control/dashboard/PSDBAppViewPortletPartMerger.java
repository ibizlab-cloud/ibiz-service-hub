...
public class PSDBAppViewPortletPartMerger extends net.ibizsys.model.util.merger.control.dashboard.PSDBPortletPartMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.dashboard.PSDBAppViewPortletPartImpl.class, strFieldName);
