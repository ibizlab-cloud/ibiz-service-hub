...
import static net.ibizsys.model.app.view.PSAppDERedirectViewImpl.*;



public class PSAppDERedirectViewMerger extends net.ibizsys.model.util.merger.app.view.PSAppDEViewMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.app.view.PSAppDERedirectViewImpl.class, strFieldName);
