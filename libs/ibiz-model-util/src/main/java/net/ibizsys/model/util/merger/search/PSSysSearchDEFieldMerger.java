...
public class PSSysSearchDEFieldMerger extends net.ibizsys.model.util.merger.search.PSSysSearchDEObjectMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.search.PSSysSearchDEFieldImpl.class, strFieldName);
