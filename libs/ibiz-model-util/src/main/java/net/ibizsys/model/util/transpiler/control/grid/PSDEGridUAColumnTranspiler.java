...
public class PSDEGridUAColumnTranspiler extends net.ibizsys.model.util.transpiler.control.grid.PSDEGridColumnTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.grid.PSDEGridUAColumnImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.grid.PSDEGridUAColumnImpl realPSModelObject = (net.ibizsys.model.control.grid.PSDEGridUAColumnImpl)iPSModelObject;
