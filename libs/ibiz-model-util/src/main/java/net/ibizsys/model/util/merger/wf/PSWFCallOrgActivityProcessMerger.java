...
import static net.ibizsys.model.wf.PSWFCallOrgActivityProcessImpl.*;



public class PSWFCallOrgActivityProcessMerger extends net.ibizsys.model.util.merger.wf.PSWFCallActivityProcessMergerBase{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.wf.PSWFCallOrgActivityProcessImpl.class, strFieldName);
