...
import static net.ibizsys.model.control.dashboard.PSSysDashboardLogicImpl.*;



public class PSSysDashboardLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.dashboard.PSSysDashboardLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.dashboard.PSSysDashboardLogicImpl realPSModelObject = (net.ibizsys.model.control.dashboard.PSSysDashboardLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "pssysdbpartname", realPSModelObject.getPSSysDashboardPartName(), realPSModelObject, "getPSSysDashboardPartName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSSYSDASHBOARDPARTNAME, domain, "pssysdbpartname", java.lang.String.class);
