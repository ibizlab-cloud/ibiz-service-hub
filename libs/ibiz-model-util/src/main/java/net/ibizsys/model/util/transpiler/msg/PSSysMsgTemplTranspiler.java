...
public class PSSysMsgTemplTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{
	...
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "contenttypepsdefid", realPSModelObject.getContentTypePSDEField(), realPSModelObject, "getContentTypePSDEField");
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "lanpsdefid", realPSModelObject.getLanPSDEField(), realPSModelObject, "getLanPSDEField");
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "subjectpsdefid", realPSModelObject.getSubjectPSDEField(), realPSModelObject, "getSubjectPSDEField");
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "templtagpsdefid", realPSModelObject.getTemplTagPSDEField(), realPSModelObject, "getTemplTagPSDEField");
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "wccontentpsdefid", realPSModelObject.getWXContentPSDEField(), realPSModelObject, "getWXContentPSDEField");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETCONTENTTYPEPSDEFIELD, domain, "contenttypepsdefid", net.ibizsys.model.dataentity.defield.IPSDEField.class, false);
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETLANPSDEFIELD, domain, "lanpsdefid", net.ibizsys.model.dataentity.defield.IPSDEField.class, false);
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETSUBJECTPSDEFIELD, domain, "subjectpsdefid", net.ibizsys.model.dataentity.defield.IPSDEField.class, false);
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETTEMPLTAGPSDEFIELD, domain, "templtagpsdefid", net.ibizsys.model.dataentity.defield.IPSDEField.class, false);
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETWXCONTENTPSDEFIELD, domain, "wccontentpsdefid", net.ibizsys.model.dataentity.defield.IPSDEField.class, false);
