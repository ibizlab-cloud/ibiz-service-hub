...
import static net.ibizsys.model.dataentity.logic.PSDEBindParamLogicImpl.*;



public class PSDEBindParamLogicTranspiler extends net.ibizsys.model.util.transpiler.dataentity.logic.PSDELogicNodeTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.logic.PSDEBindParamLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.logic.PSDEBindParamLogicImpl realPSModelObject = (net.ibizsys.model.dataentity.logic.PSDEBindParamLogicImpl)iPSModelObject;
