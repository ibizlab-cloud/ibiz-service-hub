...
import static net.ibizsys.model.control.list.PSDEListLogicImpl.*;



public class PSDEListLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.list.PSDEListLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.list.PSDEListLogicImpl realPSModelObject = (net.ibizsys.model.control.list.PSDEListLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdelistitemname", realPSModelObject.getPSDEListItemName(), realPSModelObject, "getPSDEListItemName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDELISTITEMNAME, domain, "psdelistitemname", java.lang.String.class);
