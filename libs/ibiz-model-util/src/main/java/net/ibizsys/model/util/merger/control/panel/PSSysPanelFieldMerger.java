...
public class PSSysPanelFieldMerger extends net.ibizsys.model.util.merger.control.panel.PSSysPanelItemMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.panel.PSSysPanelFieldImpl.class, strFieldName);
