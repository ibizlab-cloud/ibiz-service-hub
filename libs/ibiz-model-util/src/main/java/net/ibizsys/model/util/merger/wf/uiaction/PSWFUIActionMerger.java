...
import static net.ibizsys.model.wf.uiaction.PSWFUIActionImpl.*;



public class PSWFUIActionMerger extends net.ibizsys.model.util.merger.view.PSUIActionMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.wf.uiaction.PSWFUIActionImpl.class, strFieldName);
