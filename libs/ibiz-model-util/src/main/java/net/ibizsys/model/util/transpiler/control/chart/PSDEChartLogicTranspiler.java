...
import static net.ibizsys.model.control.chart.PSDEChartLogicImpl.*;



public class PSDEChartLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.chart.PSDEChartLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.chart.PSDEChartLogicImpl realPSModelObject = (net.ibizsys.model.control.chart.PSDEChartLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdechartaxesname", realPSModelObject.getPSDEChartAxesName(), realPSModelObject, "getPSDEChartAxesName");
		this.setDomainValue(iPSModelTranspileContext, domain, "psdechartparamname", realPSModelObject.getPSDEChartSeriesName(), realPSModelObject, "getPSDEChartSeriesName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDECHARTAXESNAME, domain, "psdechartaxesname", java.lang.String.class);
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDECHARTSERIESNAME, domain, "psdechartparamname", java.lang.String.class);
