...
public class PSDEFormButtonMerger extends net.ibizsys.model.util.merger.control.form.PSDEFormDetailMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.form.PSDEFormButtonImpl.class, strFieldName);
