...
import static net.ibizsys.model.dataentity.dataflow.PSDEDataFlowNodeParamImpl.*;



public class PSDEDataFlowNodeParamTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.dataflow.PSDEDataFlowNodeParamImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.dataflow.PSDEDataFlowNodeParamImpl realPSModelObject = (net.ibizsys.model.dataentity.dataflow.PSDEDataFlowNodeParamImpl)iPSModelObject;
		this.setDomainValue(iPSModelTranspileContext, domain, "aggmode", realPSModelObject.getAggMode(), realPSModelObject, "getAggMode");
		this.setDomainValue(iPSModelTranspileContext, domain, "customdstparam", realPSModelObject.getDstField(), realPSModelObject, "getDstField");
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "paramtype", realPSModelObject.getNodeParamType(), realPSModelObject, "getNodeParamType");
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "customsrcparam", realPSModelObject.getSrcField(), realPSModelObject, "getSrcField");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETDSTFIELD, domain, "customdstparam", java.lang.String.class);
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETNODEPARAMTYPE, domain, "paramtype", java.lang.String.class);
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETSRCFIELD, domain, "customsrcparam", java.lang.String.class);
