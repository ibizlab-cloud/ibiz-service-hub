...
public class PSDEGridGroupColumnMerger extends net.ibizsys.model.util.merger.control.grid.PSDEGridColumnMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.grid.PSDEGridGroupColumnImpl.class, strFieldName);
