...
import static net.ibizsys.model.control.tree.PSDETreeLogicImpl.*;



public class PSDETreeLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.tree.PSDETreeLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.tree.PSDETreeLogicImpl realPSModelObject = (net.ibizsys.model.control.tree.PSDETreeLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdetreecolname", realPSModelObject.getPSDETreeColumnName(), realPSModelObject, "getPSDETreeColumnName");
		this.setDomainValue(iPSModelTranspileContext, domain, "psdetreenodename", realPSModelObject.getPSDETreeNodeName(), realPSModelObject, "getPSDETreeNodeName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDETREECOLUMNNAME, domain, "psdetreecolname", java.lang.String.class);
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDETREENODENAME, domain, "psdetreenodename", java.lang.String.class);
