...
import static net.ibizsys.model.control.tree.HiddenPSDETreeNodeEditItemImpl.*;



public class HiddenPSDETreeNodeEditItemTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.tree.HiddenPSDETreeNodeEditItemImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.tree.HiddenPSDETreeNodeEditItemImpl realPSModelObject = (net.ibizsys.model.control.tree.HiddenPSDETreeNodeEditItemImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdeteiupdateid", realPSModelObject.getPSDETreeNodeEditItemUpdate(), realPSModelObject, "getPSDETreeNodeEditItemUpdate");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDETREENODEEDITITEMUPDATE, domain, "psdeteiupdateid", net.ibizsys.model.control.tree.IPSDETreeNodeEditItemUpdate.class, false);
