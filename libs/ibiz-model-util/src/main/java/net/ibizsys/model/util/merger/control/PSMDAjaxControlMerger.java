...
public class PSMDAjaxControlMerger extends net.ibizsys.model.util.merger.control.PSAjaxControlMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.PSMDAjaxControlImpl.class, strFieldName);
