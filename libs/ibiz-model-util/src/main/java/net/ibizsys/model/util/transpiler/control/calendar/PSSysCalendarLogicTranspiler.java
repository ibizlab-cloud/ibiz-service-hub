...
import static net.ibizsys.model.control.calendar.PSSysCalendarLogicImpl.*;



public class PSSysCalendarLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.calendar.PSSysCalendarLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.calendar.PSSysCalendarLogicImpl realPSModelObject = (net.ibizsys.model.control.calendar.PSSysCalendarLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "pssyscalendaritemname", realPSModelObject.getPSSysCalendarItemName(), realPSModelObject, "getPSSysCalendarItemName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSSYSCALENDARITEMNAME, domain, "pssyscalendaritemname", java.lang.String.class);
