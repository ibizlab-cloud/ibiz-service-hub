...
public class PSChartGeoListTranspiler extends net.ibizsys.model.util.transpiler.PSModelListTranspilerBase{
	...
	protected IPSModelTranspiler getPSModelTranspiler(IPSModelTranspileContext iPSModelTranspileContext, Object type) throws Exception {
		return iPSModelTranspileContext.getPSModelTranspiler(net.ibizsys.model.control.chart.PSDEChartGeoImpl.class, false);
	}
