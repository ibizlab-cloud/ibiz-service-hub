...
public class PSSysBIReportMeasureListTranspilerEx extends net.ibizsys.model.util.transpiler.bi.PSSysBIReportMeasureListTranspiler {

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);

		IPSSysBIReportMeasure iPSSysBIReportMeasure = (IPSSysBIReportMeasure) iPSModelObject;
		PSSysBIReportItem psSysBIReportItem = (PSSysBIReportItem) domain;		
		
		if(iPSSysBIReportMeasure.getItemParams() != null) {
			psSysBIReportItem.setBIRepItemParams(iPSSysBIReportMeasure.getItemParams().toString());
		}
	}
