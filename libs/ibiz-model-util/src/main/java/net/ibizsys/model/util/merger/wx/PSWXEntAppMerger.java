...
public class PSWXEntAppMerger extends net.ibizsys.model.util.merger.wx.PSWXAccountObjectMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.wx.PSWXEntAppImpl.class, strFieldName);
