...
import static net.ibizsys.model.dataentity.logic.PSDEUILoopSubCallLogicImpl.*;



public class PSDEUILoopSubCallLogicTranspiler extends net.ibizsys.model.util.transpiler.dataentity.logic.PSDEUILogicNodeTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.logic.PSDEUILoopSubCallLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.logic.PSDEUILoopSubCallLogicImpl realPSModelObject = (net.ibizsys.model.dataentity.logic.PSDEUILoopSubCallLogicImpl)iPSModelObject;
