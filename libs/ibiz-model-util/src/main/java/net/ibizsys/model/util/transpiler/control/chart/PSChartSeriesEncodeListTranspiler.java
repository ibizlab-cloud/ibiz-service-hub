...
public class PSChartSeriesEncodeListTranspiler extends net.ibizsys.model.util.transpiler.PSModelListTranspilerBase{
	...
	protected IPSModelTranspiler getPSModelTranspiler(IPSModelTranspileContext iPSModelTranspileContext, Object type) throws Exception {
		...
		switch(strTypeValue){
			case "NONE":
				return iPSModelTranspileContext.getPSModelTranspiler(net.ibizsys.model.control.chart.PSDEChartSeriesCSNoneEncodeImpl.class, false);
			case "XY":
				return iPSModelTranspileContext.getPSModelTranspiler(net.ibizsys.model.control.chart.PSDEChartSeriesCSCartesian2DEncodeImpl.class, false);
			default:
	...
	protected IPSModelTranspiler getPSModelTranspiler(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject) throws Exception {
		net.ibizsys.model.control.chart.IPSChartSeriesEncode iPSChartSeriesEncode = (net.ibizsys.model.control.chart.IPSChartSeriesEncode)iPSModelObject;
		Object type = iPSChartSeriesEncode.getType();
