...
import static net.ibizsys.model.dataentity.logic.PSDEDEReportLogicImpl.*;



public class PSDEDEReportLogicTranspiler extends net.ibizsys.model.util.transpiler.dataentity.logic.PSDELogicNodeTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.logic.PSDEDEReportLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.logic.PSDEDEReportLogicImpl realPSModelObject = (net.ibizsys.model.dataentity.logic.PSDEDEReportLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "dstpsdereportid", realPSModelObject.getDstPSDEReport(), realPSModelObject, "getDstPSDEReport");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETDSTPSDEREPORT, domain, "dstpsdereportid", net.ibizsys.model.dataentity.report.IPSDEReport.class, false);
