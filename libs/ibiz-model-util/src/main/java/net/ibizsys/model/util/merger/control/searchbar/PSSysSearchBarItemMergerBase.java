...
public class PSSysSearchBarItemMergerBase extends net.ibizsys.model.util.merger.control.searchbar.PSSysSearchBarObjectMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.searchbar.PSSysSearchBarItemImplBase.class, strFieldName);
