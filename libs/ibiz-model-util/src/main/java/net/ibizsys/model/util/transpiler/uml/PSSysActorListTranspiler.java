...
public class PSSysActorListTranspiler extends net.ibizsys.model.util.transpiler.PSModelListTranspilerBase{
	...
	protected IPSModelTranspiler getPSModelTranspiler(IPSModelTranspileContext iPSModelTranspileContext, Object type) throws Exception {
		return iPSModelTranspileContext.getPSModelTranspiler(net.ibizsys.model.uml.PSSysActorImpl.class, false);
	}
