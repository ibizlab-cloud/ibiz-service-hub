...
public class PSSysPanelContainerMerger extends net.ibizsys.model.util.merger.control.panel.PSSysPanelContainerMergerBase{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.panel.PSSysPanelContainerImpl.class, strFieldName);
