...
public class PSDETreeNodeFieldColumnTranspiler extends net.ibizsys.model.util.transpiler.control.tree.PSDETreeNodeColumnTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.tree.PSDETreeNodeFieldColumnImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.tree.PSDETreeNodeFieldColumnImpl realPSModelObject = (net.ibizsys.model.control.tree.PSDETreeNodeFieldColumnImpl)iPSModelObject;
