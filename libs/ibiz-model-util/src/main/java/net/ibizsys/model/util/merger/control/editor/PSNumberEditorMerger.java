...
public class PSNumberEditorMerger extends net.ibizsys.model.util.merger.control.PSEditorMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.editor.PSNumberEditorImpl.class, strFieldName);
