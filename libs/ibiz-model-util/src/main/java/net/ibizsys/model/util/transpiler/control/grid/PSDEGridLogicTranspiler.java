...
import static net.ibizsys.model.control.grid.PSDEGridLogicImpl.*;



public class PSDEGridLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.grid.PSDEGridLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.grid.PSDEGridLogicImpl realPSModelObject = (net.ibizsys.model.control.grid.PSDEGridLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdegridcolname", realPSModelObject.getPSDEGridColumnName(), realPSModelObject, "getPSDEGridColumnName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDEGRIDCOLUMNNAME, domain, "psdegridcolname", java.lang.String.class);
