...
import static net.ibizsys.model.dataentity.dr.PSDEDRLogicImpl.*;



public class PSDEDRLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.dr.PSDEDRLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.dr.PSDEDRLogicImpl realPSModelObject = (net.ibizsys.model.dataentity.dr.PSDEDRLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdedrdetailname", realPSModelObject.getPSDEDRDetailName(), realPSModelObject, "getPSDEDRDetailName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDEDRDETAILNAME, domain, "psdedrdetailname", java.lang.String.class);
