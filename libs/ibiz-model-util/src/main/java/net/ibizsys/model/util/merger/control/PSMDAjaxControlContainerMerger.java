...
public class PSMDAjaxControlContainerMerger extends net.ibizsys.model.util.merger.control.PSAjaxControlContainerMerger{


	@Override
	protected boolean isEnableMergeChild(IPSModelMergeContext iPSModelMergeContext, String strFieldName) {
		Boolean ret = iPSModelMergeContext.isEnableMergeChild(net.ibizsys.model.control.PSMDAjaxControlContainerImpl.class, strFieldName);
