...
import static net.ibizsys.model.control.toolbar.PSDEToolbarLogicImpl.*;



public class PSDEToolbarLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.toolbar.PSDEToolbarLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.toolbar.PSDEToolbarLogicImpl realPSModelObject = (net.ibizsys.model.control.toolbar.PSDEToolbarLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "psdetbitemname", realPSModelObject.getPSDEToolbarItemName(), realPSModelObject, "getPSDEToolbarItemName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSDETOOLBARITEMNAME, domain, "psdetbitemname", java.lang.String.class);
