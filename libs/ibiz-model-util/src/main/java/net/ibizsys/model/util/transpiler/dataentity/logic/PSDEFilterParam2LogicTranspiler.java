...
import static net.ibizsys.model.dataentity.logic.PSDEFilterParam2LogicImpl.*;



public class PSDEFilterParam2LogicTranspiler extends net.ibizsys.model.util.transpiler.dataentity.logic.PSDELogicNodeTranspiler{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.dataentity.logic.PSDEFilterParam2LogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.dataentity.logic.PSDEFilterParam2LogicImpl realPSModelObject = (net.ibizsys.model.dataentity.logic.PSDEFilterParam2LogicImpl)iPSModelObject;
