...
import static net.ibizsys.model.control.map.PSSysMapLogicImpl.*;



public class PSSysMapLogicTranspiler extends net.ibizsys.model.util.transpiler.PSModelTranspilerBase{

	@Override
	protected void onDecompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModelObject iPSModelObject, IPSModel domain, boolean bFullMode) throws Exception {
		if(!(iPSModelObject instanceof net.ibizsys.model.control.map.PSSysMapLogicImpl)){
			super.onDecompile(iPSModelTranspileContext, iPSModelObject, domain, bFullMode);
			return;
			
		}
		net.ibizsys.model.control.map.PSSysMapLogicImpl realPSModelObject = (net.ibizsys.model.control.map.PSSysMapLogicImpl)iPSModelObject;
		...
		this.setDomainValue(iPSModelTranspileContext, domain, "pssysmapitemname", realPSModelObject.getPSSysMapItemName(), realPSModelObject, "getPSSysMapItemName");
	...
	protected void onCompile(IPSModelTranspileContext iPSModelTranspileContext, IPSModel domain, ObjectNode objectNode) throws Exception {
		...
		this.setModelValue(iPSModelTranspileContext, objectNode, ATTR_GETPSSYSMAPITEMNAME, domain, "pssysmapitemname", java.lang.String.class);
