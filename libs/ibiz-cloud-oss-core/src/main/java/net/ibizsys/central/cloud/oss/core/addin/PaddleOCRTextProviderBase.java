 ...
 * PaddleOCR 文本提供者
 */
public abstract class PaddleOCRTextProviderBase extends OSSTextProviderBase {

    private static final org.apache.commons.logging.Log log = LogFactory.getLog(PaddleOCRTextProviderBase.class);

    private Map<String, Object> ocrParams = new ConcurrentHashMap<String, Object>();

    @Override
    protected void onInit() throws Exception {
        this.getContext().getSettings("paddleocr", this.ocrParams);
