...
public class PSSysMapLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.map.IPSSysMapLogic
	...
	public final static String ATTR_GETPSSYSMAPITEMNAME = "getPSSysMapItemName";
	...
	public java.lang.String getPSSysMapItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSSYSMAPITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
