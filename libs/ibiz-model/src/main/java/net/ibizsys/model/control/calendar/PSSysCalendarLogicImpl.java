...
public class PSSysCalendarLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.calendar.IPSSysCalendarLogic
	...
	public final static String ATTR_GETPSSYSCALENDARITEMNAME = "getPSSysCalendarItemName";
	...
	public java.lang.String getPSSysCalendarItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSSYSCALENDARITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
