...
public class PSDEDRLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.dataentity.dr.IPSDEDRLogic
	...
	public final static String ATTR_GETPSDEDRDETAILNAME = "getPSDEDRDetailName";
	...
	public java.lang.String getPSDEDRDetailName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEDRDETAILNAME);
		if(value == null){
			return null;
		}
		return value.asText();
