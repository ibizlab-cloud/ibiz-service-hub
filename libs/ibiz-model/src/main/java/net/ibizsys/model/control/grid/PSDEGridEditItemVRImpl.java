...
public class PSDEGridEditItemVRImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.grid.IPSDEGridEditItemVR{
	...
	public java.lang.String getPSDEGridEditItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEGRIDEDITITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
