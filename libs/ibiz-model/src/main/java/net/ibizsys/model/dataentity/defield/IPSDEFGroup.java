...
public interface IPSDEFGroup extends net.ibizsys.model.dataentity.IPSDataEntityObject
	 ...
	 * @return
	 */
	java.util.List<net.ibizsys.model.dataentity.defield.IPSDEFGroupDetail> getPSDEFGroupDetails();
	 ...
	 */
	net.ibizsys.model.dataentity.defield.IPSDEFGroupDetail getPSDEFGroupDetail(Object objKey, boolean bTryMode);
	
	/**
	 * 设置属性组成员集合
	 * @param list 属性组成员集合
	 */
	void setPSDEFGroupDetails(java.util.List<net.ibizsys.model.dataentity.defield.IPSDEFGroupDetail> list);
