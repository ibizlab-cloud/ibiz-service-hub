...
public class PSSysUseCaseImpl extends net.ibizsys.model.PSSystemObjectImpl implements net.ibizsys.model.uml.IPSSysUseCase{
	...
	public final static String ATTR_GETUSECASESN = "useCaseSN";
	public final static String ATTR_GETUSECASETAG = "useCaseTag";
	public final static String ATTR_GETUSECASETAG2 = "useCaseTag2";
	...
	public java.lang.String getUseCaseSN(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETUSECASESN);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getUseCaseTag(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETUSECASETAG);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getUseCaseTag2(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETUSECASETAG2);
		if(value == null){
			return null;
		}
		return value.asText();
