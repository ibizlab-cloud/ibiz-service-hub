...
public class PSDEFSearchFormItemImpl extends net.ibizsys.model.dataentity.defield.PSDEFieldObjectImpl implements net.ibizsys.model.control.form.IPSDEFSearchFormItem{
	...
	public net.ibizsys.model.dataentity.ac.IPSDEACMode getRefPSDEACMode(){
		...
		this.refpsdeacmode = getPSModelObject(net.ibizsys.model.dataentity.ac.IPSDEACMode.class, (com.fasterxml.jackson.databind.node.ObjectNode)value, ATTR_GETREFPSDEACMODE);
	...
	public net.ibizsys.model.dataentity.ds.IPSDEDataSet getRefPSDEDataSet(){
		...
		this.refpsdedataset = getPSModelObject(net.ibizsys.model.dataentity.ds.IPSDEDataSet.class, (com.fasterxml.jackson.databind.node.ObjectNode)value, ATTR_GETREFPSDEDATASET);
