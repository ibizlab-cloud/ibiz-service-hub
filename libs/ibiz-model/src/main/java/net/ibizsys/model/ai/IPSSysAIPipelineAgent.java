...
/**
 * AI工厂生产线模型对象接口，标准模型{@link net.ibizsys.centralstudio.dto.PSSysAIPipelineAgentDTO}运行时对象
 *
 */
public interface IPSSysAIPipelineAgent extends net.ibizsys.model.ai.IPSAIPipelineAgent
	 ...
	 * 获取实体对象
	 * <P>
	 * 相关模型：{@link net.ibizsys.centralstudio.dto.PSSysAIPipelineAgentDTO#FIELD_PSDEID}
	 * @return
	 */
