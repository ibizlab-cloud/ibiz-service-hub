...
public class PSDESysDBTableActionLogicImpl extends net.ibizsys.model.dataentity.logic.PSDELogicNodeImpl implements net.ibizsys.model.dataentity.logic.IPSDESysDBTableActionLogic{

	public final static String ATTR_GETDBTABLEACTION = "dBTableAction";
	...
	public java.lang.String getDBTableAction(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETDBTABLEACTION);
		if(value == null){
			return null;
		}
		return value.asText();
