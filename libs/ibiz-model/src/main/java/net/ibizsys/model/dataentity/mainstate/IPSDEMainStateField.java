...
/**
 * 实体主状态属性模型对象接口，标准模型{@link net.ibizsys.centralstudio.dto.PSDEMSFieldDTO}运行时对象
 *
 */
public interface IPSDEMainStateField extends net.ibizsys.model.IPSModelObject{
	 ...
	 * 获取默认值
	 * <P>
	 * 相关模型：{@link net.ibizsys.centralstudio.dto.PSDEMSFieldDTO#FIELD_DEFAULTVALUE}
	 * @return
	 */
	 ...
	 * 获取默认值类型
	 * <P>
	 * 相关模型：{@link net.ibizsys.centralstudio.dto.PSDEMSFieldDTO#FIELD_DVT}
	 * <P>
	 ...
	 * 获取实体属性
	 * <P>
	 * 相关模型：{@link net.ibizsys.centralstudio.dto.PSDEMSFieldDTO#FIELD_PSDEFID}
	 * @return
	 */
