...
public class PSPickerEditorImpl extends net.ibizsys.model.control.editor.PSValueItemEditorImpl implements net.ibizsys.model.control.editor.IPSPickerEditor
