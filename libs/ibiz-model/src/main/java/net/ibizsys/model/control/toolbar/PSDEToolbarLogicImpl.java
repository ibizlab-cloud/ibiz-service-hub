...
public class PSDEToolbarLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.toolbar.IPSDEToolbarLogic
	...
	public final static String ATTR_GETPSDETOOLBARITEMNAME = "getPSDEToolbarItemName";
	...
	public java.lang.String getPSDEToolbarItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDETOOLBARITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
