...
public class PSDEWizardLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.dataentity.wizard.IPSDEWizardLogic
	...
	public final static String ATTR_GETPSDEWIZARDFORMID = "getPSDEWizardFormId";
	public final static String ATTR_GETPSDEWIZARDFORMNAME = "getPSDEWizardFormName";
	public final static String ATTR_GETPSDEWIZARDFORMTAG = "getPSDEWizardFormTag";
	public final static String ATTR_GETPSDEWIZARDSTEPID = "getPSDEWizardStepId";
	public final static String ATTR_GETPSDEWIZARDSTEPNAME = "getPSDEWizardStepName";
	public final static String ATTR_GETPSDEWIZARDSTEPTAG = "getPSDEWizardStepTag";
	...
	public java.lang.String getPSDEWizardFormId(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEWIZARDFORMID);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDEWizardFormName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEWIZARDFORMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDEWizardFormTag(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEWIZARDFORMTAG);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDEWizardStepId(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEWIZARDSTEPID);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDEWizardStepName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEWIZARDSTEPNAME);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDEWizardStepTag(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEWIZARDSTEPTAG);
		if(value == null){
			return null;
		}
		return value.asText();
