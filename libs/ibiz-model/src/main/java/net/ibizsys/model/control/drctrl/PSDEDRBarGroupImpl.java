...
public class PSDEDRBarGroupImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.drctrl.IPSDEDRBarGroup{
	...
	public net.ibizsys.model.res.IPSLanguageRes getCapPSLanguageResMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定标题语言系统对象");}
		return value;
	}
