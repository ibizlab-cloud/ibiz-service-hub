...
public class PSAppUILogicRefViewImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.app.logic.IPSAppUILogicRefView{
	...
	public net.ibizsys.model.app.view.IPSAppViewMsgGroup getPSAppViewMsgGroup(){
		...
		this.psappviewmsggroup = getPSModelObject(net.ibizsys.model.app.view.IPSAppViewMsgGroup.class, (com.fasterxml.jackson.databind.node.ObjectNode)value, ATTR_GETPSAPPVIEWMSGGROUP);
	...
	public net.ibizsys.model.app.view.IPSAppViewMsgGroup getPSAppViewMsgGroupMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "[getPSAppViewMsgGroup]返回空值");}
		return value;
	}
	...
	public net.ibizsys.model.res.IPSSysCss getPSSysCssMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定视图界面样式对象");}
		return value;
	}
	...
	public net.ibizsys.model.res.IPSSysImage getPSSysImageMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定视图图标对象");}
		return value;
	}
	...
	public net.ibizsys.model.app.view.IPSAppView getRefPSAppViewMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定实际引用视图");}
		return value;
	}
	...
	public net.ibizsys.model.res.IPSLanguageRes getSubCapPSLanguageResMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "[getSubCapPSLanguageRes]返回空值");}
		return value;
	}
	...
	public net.ibizsys.model.res.IPSLanguageRes getTitlePSLanguageResMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "[getTitlePSLanguageRes]返回空值");}
		return value;
	}
