...
public class PSDEUILogicGroupImpl extends net.ibizsys.model.dataentity.PSDataEntityObjectImpl implements net.ibizsys.model.dataentity.logic.IPSDEUILogicGroup
		,net.ibizsys.model.app.dataentity.IPSAppDEUILogicGroup{
