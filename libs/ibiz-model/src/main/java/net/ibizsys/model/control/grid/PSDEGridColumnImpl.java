...
public class PSDEGridColumnImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.grid.IPSDEGridColumn{

	public final static String ATTR_GETAGGFIELD = "aggField";
	public final static String ATTR_GETAGGMODE = "aggMode";
	public final static String ATTR_GETAGGVALUEFORMAT = "aggValueFormat";
	...
	public java.lang.String getAggValueFormat(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETAGGVALUEFORMAT);
		if(value == null){
			return null;
		}
		return value.asText();
