...
public class PSDEFormLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.form.IPSDEFormLogic
	...
	public final static String ATTR_GETPSDEFORMDETAILNAME = "getPSDEFormDetailName";
	...
	public java.lang.String getPSDEFormDetailName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEFORMDETAILNAME);
		if(value == null){
			return null;
		}
		return value.asText();
