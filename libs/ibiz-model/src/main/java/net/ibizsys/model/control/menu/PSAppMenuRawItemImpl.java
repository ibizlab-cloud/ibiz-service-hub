...
public class PSAppMenuRawItemImpl extends net.ibizsys.model.control.menu.PSAppMenuItemImplBase implements net.ibizsys.model.control.menu.IPSAppMenuRawItem
