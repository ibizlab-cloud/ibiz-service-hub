...
public class PSAppDEMobTabSearchViewImpl extends net.ibizsys.model.app.view.PSAppDETabSearchViewImpl implements net.ibizsys.model.app.view.IPSAppDEMobTabSearchView{
