...
public class PSDETreeLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.tree.IPSDETreeLogic
	...
	public final static String ATTR_GETPSDETREECOLUMNNAME = "getPSDETreeColumnName";
	public final static String ATTR_GETPSDETREENODENAME = "getPSDETreeNodeName";
	...
	public java.lang.String getPSDETreeColumnName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDETREECOLUMNNAME);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDETreeNodeName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDETREENODENAME);
		if(value == null){
			return null;
		}
		return value.asText();
