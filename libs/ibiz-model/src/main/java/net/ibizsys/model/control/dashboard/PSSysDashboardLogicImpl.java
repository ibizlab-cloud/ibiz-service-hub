...
public class PSSysDashboardLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.dashboard.IPSSysDashboardLogic
	...
	public final static String ATTR_GETPSSYSDASHBOARDPARTNAME = "getPSSysDashboardPartName";
	...
	public java.lang.String getPSSysDashboardPartName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSSYSDASHBOARDPARTNAME);
		if(value == null){
			return null;
		}
		return value.asText();
