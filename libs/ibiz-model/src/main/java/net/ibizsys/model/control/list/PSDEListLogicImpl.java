...
public class PSDEListLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.list.IPSDEListLogic
	...
	public final static String ATTR_GETPSDELISTITEMNAME = "getPSDEListItemName";
	...
	public java.lang.String getPSDEListItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDELISTITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
