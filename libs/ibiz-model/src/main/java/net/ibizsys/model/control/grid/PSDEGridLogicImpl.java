...
public class PSDEGridLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.grid.IPSDEGridLogic
	...
	public final static String ATTR_GETPSDEGRIDCOLUMNNAME = "getPSDEGridColumnName";
	...
	public java.lang.String getPSDEGridColumnName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDEGRIDCOLUMNNAME);
		if(value == null){
			return null;
		}
		return value.asText();
