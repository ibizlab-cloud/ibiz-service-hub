...
public class PSDEChartLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.chart.IPSDEChartLogic
	...
	public final static String ATTR_GETPSDECHARTAXESNAME = "getPSDEChartAxesName";
	public final static String ATTR_GETPSDECHARTSERIESNAME = "getPSDEChartSeriesName";
	...
	public java.lang.String getPSDEChartAxesName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDECHARTAXESNAME);
		if(value == null){
			return null;
		}
		return value.asText();
	...
	public java.lang.String getPSDEChartSeriesName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSDECHARTSERIESNAME);
		if(value == null){
			return null;
		}
		return value.asText();
