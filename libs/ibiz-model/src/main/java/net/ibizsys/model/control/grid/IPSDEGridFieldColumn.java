 ...
 *
 */
public interface IPSDEGridFieldColumn extends net.ibizsys.model.control.grid.IPSDEGridColumn{
	 ...
	 * @return
	 */
	net.ibizsys.model.control.IPSEditor getFilterPSEditor();
	 ...
	 * @return
	 */
	net.ibizsys.model.control.IPSEditor getFilterPSEditorMust();
	 ...
	 * 获取树列模式
	 * <P>
	 * 返回值参考 {@link net.ibizsys.model.PSModelEnums.GridTreeColMode}
	 * @return
	 */
	int getTreeColumnMode();
