...
public class PSSysPanelTabPanelImpl extends net.ibizsys.model.control.panel.PSSysPanelItemImpl implements net.ibizsys.model.control.panel.IPSSysPanelTabPanel{
	...
	public final static String ATTR_GETPSPANELTABPAGES = "getPSPanelTabPages";
	...
	private java.util.List<net.ibizsys.model.control.panel.IPSPanelTabPage> pspaneltabpages = null;
	public java.util.List<net.ibizsys.model.control.panel.IPSPanelTabPage> getPSPanelTabPages(){
		if(this.pspaneltabpages == null){
			com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSPANELTABPAGES);
			if(value == null){return null;}
			com.fasterxml.jackson.databind.node.ArrayNode arrayNode = (com.fasterxml.jackson.databind.node.ArrayNode)value;
			if(arrayNode.size() == 0){return null;}
			java.util.List<net.ibizsys.model.control.panel.IPSPanelTabPage> list = new java.util.ArrayList<net.ibizsys.model.control.panel.IPSPanelTabPage>();
			for(int i = 0;i<arrayNode.size();i++) {
				net.ibizsys.model.control.panel.IPSPanelTabPage obj = this.getPSModelObject(net.ibizsys.model.control.panel.IPSPanelTabPage.class, (com.fasterxml.jackson.databind.node.ObjectNode)arrayNode.get(i),ATTR_GETPSPANELTABPAGES);
				if(obj!=null)list.add(obj);
			}
			this.pspaneltabpages = list;
		}
		return (this.pspaneltabpages.size() == 0)? null : this.pspaneltabpages;
	}

	public net.ibizsys.model.control.panel.IPSPanelTabPage getPSPanelTabPage(Object objKey, boolean bTryMode){
		return getPSModelObject(net.ibizsys.model.control.panel.IPSPanelTabPage.class, this.getPSPanelTabPages(), objKey, bTryMode);
	}
	public void setPSPanelTabPages(java.util.List<net.ibizsys.model.control.panel.IPSPanelTabPage> list){
		this.pspaneltabpages = list;
	}
