...
public class PSDEChartAxisImplBase extends net.ibizsys.model.control.chart.PSDEChartObjectImplBase implements net.ibizsys.model.control.chart.IPSChartAxis{
	...
	public final static String ATTR_GETECHARTSPOS = "eChartsPos";
	...
	public java.lang.String getEChartsPos(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETECHARTSPOS);
		if(value == null){
			return null;
		}
		return value.asText();
