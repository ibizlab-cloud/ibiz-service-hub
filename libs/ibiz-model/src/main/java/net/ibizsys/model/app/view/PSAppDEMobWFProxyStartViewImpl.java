...
public class PSAppDEMobWFProxyStartViewImpl extends net.ibizsys.model.app.view.PSAppDEWFProxyStartViewImpl implements net.ibizsys.model.app.view.IPSAppDEMobWFProxyStartView{
