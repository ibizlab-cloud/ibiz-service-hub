...
public class PSDESubmitWFLogicImpl extends net.ibizsys.model.dataentity.logic.PSDELogicNodeImpl implements net.ibizsys.model.dataentity.logic.IPSDESubmitWFLogic{
	...
	public final static String ATTR_GETOPTPSDELOGICPARAM = "getOptPSDELogicParam";
	...
	public final static String ATTR_GETWFACTION = "wFAction";
	...
	private net.ibizsys.model.dataentity.logic.IPSDELogicParam optpsdelogicparam;

	public net.ibizsys.model.dataentity.logic.IPSDELogicParam getOptPSDELogicParam(){
		if(this.optpsdelogicparam != null) return this.optpsdelogicparam;
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETOPTPSDELOGICPARAM);
		if(value == null){
			return null;
		}
		net.ibizsys.model.dataentity.logic.IPSDELogic ipsdelogic = getParentPSModelObject(net.ibizsys.model.dataentity.logic.IPSDELogic.class);
		this.optpsdelogicparam = ipsdelogic.getPSDELogicParam(value, false);
		return this.optpsdelogicparam;
	}

	public net.ibizsys.model.dataentity.logic.IPSDELogicParam getOptPSDELogicParamMust(){
		net.ibizsys.model.dataentity.logic.IPSDELogicParam value = this.getOptPSDELogicParam();
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定可选逻辑参数对象");}
		return value;
	}

	public void setOptPSDELogicParam(net.ibizsys.model.dataentity.logic.IPSDELogicParam optpsdelogicparam){
		this.optpsdelogicparam = optpsdelogicparam;
	}
	...
	public java.lang.String getWFAction(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETWFACTION);
		if(value == null){
			return null;
		}
		return value.asText();
