...
public class PSRawItemImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.IPSRawItem
		,net.ibizsys.model.control.rawitem.IPSUnkownItem{
