...
public class PSDEUserCustomActionImpl extends net.ibizsys.model.dataentity.action.PSDEActionImplBase implements net.ibizsys.model.dataentity.action.IPSDEUserCustomAction{
	...
	public net.ibizsys.model.dataentity.ds.IPSDEDataSet getPSDEDataSetMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定相关实体数据集");}
		return value;
	}
