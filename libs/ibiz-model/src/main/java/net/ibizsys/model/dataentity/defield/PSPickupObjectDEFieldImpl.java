...
public class PSPickupObjectDEFieldImpl extends net.ibizsys.model.dataentity.defield.PSDEFieldImpl implements net.ibizsys.model.dataentity.defield.IPSPickupObjectDEField{
	...
	public net.ibizsys.model.dataentity.der.IPSDERBase getPSDER(){
		...
		if(value == null){
			throw new net.ibizsys.model.PSModelException(this, "未指定[一对多关系]的值");
		}
	...
	public net.ibizsys.model.dataentity.der.IPSDERBase getPSDERMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定一对多关系");}
		return value;
	}
