...
public class PSAppMenuLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.menu.IPSAppMenuLogic
	...
	public final static String ATTR_GETPSAPPMENUITEMNAME = "getPSAppMenuItemName";
	...
	public java.lang.String getPSAppMenuItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSAPPMENUITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
