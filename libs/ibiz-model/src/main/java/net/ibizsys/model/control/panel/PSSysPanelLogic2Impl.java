...
public class PSSysPanelLogic2Impl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.panel.IPSSysPanelLogic2
	...
	public final static String ATTR_GETPSSYSPANELITEMNAME = "getPSSysPanelItemName";
	...
	public java.lang.String getPSSysPanelItemName(){
		com.fasterxml.jackson.databind.JsonNode value = this.getObjectNode().get(ATTR_GETPSSYSPANELITEMNAME);
		if(value == null){
			return null;
		}
		return value.asText();
