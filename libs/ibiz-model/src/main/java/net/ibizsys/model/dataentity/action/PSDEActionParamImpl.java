...
public class PSDEActionParamImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.dataentity.action.IPSDEActionParam{
	...
	public net.ibizsys.model.dataentity.defield.IPSDEField getPSDEFieldMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "未指定参数实体属性");}
		return value;
	}
