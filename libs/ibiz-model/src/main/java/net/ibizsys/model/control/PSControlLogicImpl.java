...
public abstract class PSControlLogicImpl extends net.ibizsys.model.PSObjectImpl implements net.ibizsys.model.control.IPSControlLogic{
	...
	public net.ibizsys.model.app.dataentity.IPSAppDEUIAction getPSAppDEUIActionMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "[getPSAppDEUIAction]返回空值");}
		return value;
	}
	...
	public net.ibizsys.model.app.dataentity.IPSAppDEUILogic getPSAppDEUILogic(){
		...
		this.psappdeuilogic = getPSModelObject(net.ibizsys.model.app.dataentity.IPSAppDEUILogic.class, (com.fasterxml.jackson.databind.node.ObjectNode)value, ATTR_GETPSAPPDEUILOGIC);
	...
	public net.ibizsys.model.app.dataentity.IPSAppDataEntity getPSAppDataEntityMust(){
		...
		if(value == null){throw new net.ibizsys.model.PSModelException(this, "[getPSAppDataEntity]返回空值");}
		return value;
	}
