...
@Service
public class OrgSystemServiceImpl extends DEServiceBase<OrgSystemDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IOrgSystemService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == OrgSystemServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    OrgSystemDTO dto = (OrgSystemDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    OrgSystemDTO result = (OrgSystemDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(OrgSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(OrgSystemDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(OrgSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(OrgSystemDTO dto) throws Throwable {
    ...
    protected OrgSystemDTO onAfterGet(OrgSystemDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(OrgSystemDTO dto) throws Throwable {
        
     }

    protected OrgSystemDTO onAfterGetDraft(OrgSystemDTO result, OrgSystemDTO dto) throws Throwable {
      return result;
    }
