...
@Service
public class MsgUserAccountServiceImpl extends DEServiceBase<MsgUserAccountDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgUserAccountService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgUserAccountServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgUserAccountDTO dto = (MsgUserAccountDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgUserAccountDTO result = (MsgUserAccountDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MsgUserAccountDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgUserAccountDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgUserAccountDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgUserAccountDTO dto) throws Throwable {
    ...
    protected MsgUserAccountDTO onAfterGet(MsgUserAccountDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgUserAccountDTO dto) throws Throwable {
        
     }

    protected MsgUserAccountDTO onAfterGetDraft(MsgUserAccountDTO result, MsgUserAccountDTO dto) throws Throwable {
      return result;
    }
