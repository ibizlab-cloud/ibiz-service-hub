...
@Service
public class SysEventServiceImpl extends DEServiceBase<SysEventDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.log.service.ISysEventService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SysEventServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    SysEventDTO dto = (SysEventDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SysEventDTO result = (SysEventDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SysEventDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SysEventDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SysEventDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SysEventDTO dto) throws Throwable {
    ...
    protected SysEventDTO onAfterGet(SysEventDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SysEventDTO dto) throws Throwable {
        
     }

    protected SysEventDTO onAfterGetDraft(SysEventDTO result, SysEventDTO dto) throws Throwable {
      return result;
    }
