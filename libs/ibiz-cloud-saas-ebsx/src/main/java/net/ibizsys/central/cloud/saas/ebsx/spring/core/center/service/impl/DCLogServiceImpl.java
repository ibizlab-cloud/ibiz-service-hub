...
@Service
public class DCLogServiceImpl extends DEServiceBase<DCLogDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCLogService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCLogServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCLogDTO result = (DCLogDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_FORMTYPE, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(DCLogDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCLogDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCLogDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCLogDTO dto) throws Throwable {
    ...
    protected DCLogDTO onAfterGet(DCLogDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCLogDTO dto) throws Throwable {
        
     }

    protected DCLogDTO onAfterGetDraft(DCLogDTO result, DCLogDTO dto) throws Throwable {
      return result;
    }
