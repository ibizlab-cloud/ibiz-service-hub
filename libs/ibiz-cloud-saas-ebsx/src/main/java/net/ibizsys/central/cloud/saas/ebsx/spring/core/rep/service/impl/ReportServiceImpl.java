package net.ibizsys.central.cloud.saas.ebsx.spring.core.rep.service.impl;
...
public class ReportServiceImpl extends DEServiceBase<ReportDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.rep.service.IReportService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == ReportServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    ReportDTO dto = (ReportDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    ReportDTO result = (ReportDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_FINDREPORT, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onFindReport((ReportDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(ReportDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(ReportDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(ReportDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(ReportDTO dto) throws Throwable {
    ...
    protected ReportDTO onAfterGet(ReportDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(ReportDTO dto) throws Throwable {
        
     }

    protected ReportDTO onAfterGetDraft(ReportDTO result, ReportDTO dto) throws Throwable {
      return result;
    }

    protected void onFindReport(ReportDTO dto) throws Throwable {
