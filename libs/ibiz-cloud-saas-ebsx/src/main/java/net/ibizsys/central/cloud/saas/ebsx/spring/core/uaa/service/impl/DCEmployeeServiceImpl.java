...
@Service
public class DCEmployeeServiceImpl extends DEServiceBase<DCEmployeeDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IDCEmployeeService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCEmployeeServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCEmployeeDTO dto = (DCEmployeeDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCEmployeeDTO result = (DCEmployeeDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCEmployeeDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCEmployeeDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCEmployeeDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCEmployeeDTO dto) throws Throwable {
    ...
    protected DCEmployeeDTO onAfterGet(DCEmployeeDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCEmployeeDTO dto) throws Throwable {
        
     }

    protected DCEmployeeDTO onAfterGetDraft(DCEmployeeDTO result, DCEmployeeDTO dto) throws Throwable {
      return result;
    }
