...
import net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.dto.DstMicroserviceDTO;
...
@Service
public class DstMicroserviceServiceImpl extends DEServiceBase<DstMicroserviceDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstMicroserviceService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstMicroserviceServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstMicroserviceDTO dto = (DstMicroserviceDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstMicroserviceDTO result = (DstMicroserviceDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DstMicroserviceDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstMicroserviceDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstMicroserviceDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstMicroserviceDTO dto) throws Throwable {
    ...
    protected DstMicroserviceDTO onAfterGet(DstMicroserviceDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstMicroserviceDTO dto) throws Throwable {
        
     }

    protected DstMicroserviceDTO onAfterGetDraft(DstMicroserviceDTO result, DstMicroserviceDTO dto) throws Throwable {
      return result;
    }
