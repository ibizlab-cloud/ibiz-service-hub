...
public class MsgSendQueueHisServiceImpl extends DEServiceBase<MsgSendQueueHisDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgSendQueueHisService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgSendQueueHisServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgSendQueueHisDTO dto = (MsgSendQueueHisDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgSendQueueHisDTO result = (MsgSendQueueHisDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_RESEND, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onResend((MsgSendQueueHisDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(MsgSendQueueHisDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgSendQueueHisDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgSendQueueHisDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgSendQueueHisDTO dto) throws Throwable {
    ...
    protected MsgSendQueueHisDTO onAfterGet(MsgSendQueueHisDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgSendQueueHisDTO dto) throws Throwable {
        
     }

    protected MsgSendQueueHisDTO onAfterGetDraft(MsgSendQueueHisDTO result, MsgSendQueueHisDTO dto) throws Throwable {
      return result;
    }

    protected void onResend(MsgSendQueueHisDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "重新发送"), Errors.NOTIMPL);
    }
