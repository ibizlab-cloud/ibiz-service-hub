...
public class DynaInstServiceImpl extends DEServiceBase<DynaInstDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IDynaInstService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DynaInstServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DynaInstDTO dto = (DynaInstDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DynaInstDTO result = (DynaInstDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_INSTALLDYNAINST, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onInstallDynaInst((DynaInstDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(DynaInstDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DynaInstDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DynaInstDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DynaInstDTO dto) throws Throwable {
    ...
    protected DynaInstDTO onAfterGet(DynaInstDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DynaInstDTO dto) throws Throwable {
        
     }

    protected DynaInstDTO onAfterGetDraft(DynaInstDTO result, DynaInstDTO dto) throws Throwable {
      return result;
    }

    protected void onInstallDynaInst(DynaInstDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "安装实例数据"), Errors.NOTIMPL);
    }
