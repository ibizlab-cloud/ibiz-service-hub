...
@Service
public class DictOptionServiceImpl extends DEServiceBase<DictOptionDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.dict.service.IDictOptionService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DictOptionServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DictOptionDTO dto = (DictOptionDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DictOptionDTO result = (DictOptionDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DictOptionDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DictOptionDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DictOptionDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DictOptionDTO dto) throws Throwable {
    ...
    protected DictOptionDTO onAfterGet(DictOptionDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DictOptionDTO dto) throws Throwable {
        
     }

    protected DictOptionDTO onAfterGetDraft(DictOptionDTO result, DictOptionDTO dto) throws Throwable {
      return result;
    }
