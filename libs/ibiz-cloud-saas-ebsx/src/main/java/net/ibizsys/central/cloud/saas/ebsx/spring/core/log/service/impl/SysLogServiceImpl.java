package net.ibizsys.central.cloud.saas.ebsx.spring.core.log.service.impl;
...
@Service
public class SysLogServiceImpl extends DEServiceBase<SysLogDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.log.service.ISysLogService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SysLogServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    SysLogDTO dto = (SysLogDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SysLogDTO result = (SysLogDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SysLogDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SysLogDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SysLogDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SysLogDTO dto) throws Throwable {
    ...
    protected SysLogDTO onAfterGet(SysLogDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SysLogDTO dto) throws Throwable {
        
     }

    protected SysLogDTO onAfterGetDraft(SysLogDTO result, SysLogDTO dto) throws Throwable {
      return result;
    }
