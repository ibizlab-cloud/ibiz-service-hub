 ...
 */
public class TodoSimpleDTO extends EntityDTO {
  ...
  public final static String FIELD_UPDATEMANNAME = "updatemanname";
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setCreateDate(Timestamp val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetCreateDate() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setCreateMan(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetCreateMan() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setCreateManName(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetCreateManName() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setOrgId(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetOrgId() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setTitle(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetTitle() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setTodoId(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetTodoId() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setUpdateDate(Timestamp val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetUpdateDate() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setUpdateMan(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetUpdateMan() {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO setUpdateManName(String val) {
    ...
    */
    @JsonIgnore
    public TodoSimpleDTO resetUpdateManName() {
