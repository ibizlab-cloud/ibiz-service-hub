...
@Service
public class NotesServiceImpl extends DEServiceBase<NotesDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.INotesService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == NotesServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    NotesDTO result = (NotesDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(NotesDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(NotesDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(NotesDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(NotesDTO dto) throws Throwable {
    ...
    protected NotesDTO onAfterGet(NotesDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(NotesDTO dto) throws Throwable {
        
     }

    protected NotesDTO onAfterGetDraft(NotesDTO result, NotesDTO dto) throws Throwable {
      return result;
    }
