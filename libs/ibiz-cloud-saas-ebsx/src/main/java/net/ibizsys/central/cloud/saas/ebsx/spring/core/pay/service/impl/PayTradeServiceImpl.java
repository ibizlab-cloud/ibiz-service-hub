...
@Service
public class PayTradeServiceImpl extends DEServiceBase<PayTradeDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.pay.service.IPayTradeService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PayTradeServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    PayTradeDTO dto = (PayTradeDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PayTradeDTO result = (PayTradeDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(PayTradeDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PayTradeDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PayTradeDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PayTradeDTO dto) throws Throwable {
    ...
    protected PayTradeDTO onAfterGet(PayTradeDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PayTradeDTO dto) throws Throwable {
        
     }

    protected PayTradeDTO onAfterGetDraft(PayTradeDTO result, PayTradeDTO dto) throws Throwable {
      return result;
    }
