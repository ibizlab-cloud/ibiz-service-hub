package net.ibizsys.central.cloud.saas.ebsx.spring.core.disk.service.impl;
...
@Service
public class SDFileServiceImpl extends DEServiceBase<SDFileDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.disk.service.ISDFileService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SDFileServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    SDFileDTO dto = (SDFileDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SDFileDTO result = (SDFileDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SDFileDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SDFileDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SDFileDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SDFileDTO dto) throws Throwable {
    ...
    protected SDFileDTO onAfterGet(SDFileDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SDFileDTO dto) throws Throwable {
        
     }

    protected SDFileDTO onAfterGetDraft(SDFileDTO result, SDFileDTO dto) throws Throwable {
      return result;
    }
