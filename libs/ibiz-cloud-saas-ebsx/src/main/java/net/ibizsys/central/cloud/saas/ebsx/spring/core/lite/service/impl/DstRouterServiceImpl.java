...
@Service
public class DstRouterServiceImpl extends DEServiceBase<DstRouterDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstRouterService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstRouterServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstRouterDTO dto = (DstRouterDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstRouterDTO result = (DstRouterDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DstRouterDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstRouterDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstRouterDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstRouterDTO dto) throws Throwable {
    ...
    protected DstRouterDTO onAfterGet(DstRouterDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstRouterDTO dto) throws Throwable {
        
     }

    protected DstRouterDTO onAfterGetDraft(DstRouterDTO result, DstRouterDTO dto) throws Throwable {
      return result;
    }
