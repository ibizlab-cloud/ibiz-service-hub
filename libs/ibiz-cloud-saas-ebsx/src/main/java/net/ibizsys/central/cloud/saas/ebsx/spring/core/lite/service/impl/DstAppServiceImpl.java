...
@Service
public class DstAppServiceImpl extends DEServiceBase<DstAppDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstAppService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstAppServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstAppDTO dto = (DstAppDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstAppDTO result = (DstAppDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DstAppDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstAppDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstAppDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstAppDTO dto) throws Throwable {
    ...
    protected DstAppDTO onAfterGet(DstAppDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstAppDTO dto) throws Throwable {
        
     }

    protected DstAppDTO onAfterGetDraft(DstAppDTO result, DstAppDTO dto) throws Throwable {
      return result;
    }
