...
@Service
public class TeamMemberServiceImpl extends DEServiceBase<TeamMemberDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.ITeamMemberService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == TeamMemberServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    TeamMemberDTO dto = (TeamMemberDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    TeamMemberDTO result = (TeamMemberDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(TeamMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(TeamMemberDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(TeamMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(TeamMemberDTO dto) throws Throwable {
    ...
    protected TeamMemberDTO onAfterGet(TeamMemberDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(TeamMemberDTO dto) throws Throwable {
        
     }

    protected TeamMemberDTO onAfterGetDraft(TeamMemberDTO result, TeamMemberDTO dto) throws Throwable {
      return result;
    }
