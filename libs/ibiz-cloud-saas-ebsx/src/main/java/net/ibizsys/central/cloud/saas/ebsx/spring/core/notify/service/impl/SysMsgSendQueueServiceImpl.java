...
@Service
public class SysMsgSendQueueServiceImpl extends DEServiceBase<SysMsgSendQueueDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.ISysMsgSendQueueService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SysMsgSendQueueServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    SysMsgSendQueueDTO dto = (SysMsgSendQueueDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SysMsgSendQueueDTO result = (SysMsgSendQueueDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SysMsgSendQueueDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SysMsgSendQueueDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SysMsgSendQueueDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SysMsgSendQueueDTO dto) throws Throwable {
    ...
    protected SysMsgSendQueueDTO onAfterGet(SysMsgSendQueueDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SysMsgSendQueueDTO dto) throws Throwable {
        
     }

    protected SysMsgSendQueueDTO onAfterGetDraft(SysMsgSendQueueDTO result, SysMsgSendQueueDTO dto) throws Throwable {
      return result;
    }
