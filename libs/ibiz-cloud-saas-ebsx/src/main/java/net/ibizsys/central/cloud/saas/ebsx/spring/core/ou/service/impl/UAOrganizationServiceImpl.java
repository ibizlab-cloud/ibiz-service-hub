...
@Service
public class UAOrganizationServiceImpl extends DEServiceBase<UAOrganizationDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.IUAOrganizationService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == UAOrganizationServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    UAOrganizationDTO dto = (UAOrganizationDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    UAOrganizationDTO result = (UAOrganizationDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(UAOrganizationDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(UAOrganizationDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(UAOrganizationDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(UAOrganizationDTO dto) throws Throwable {
    ...
    protected UAOrganizationDTO onAfterGet(UAOrganizationDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(UAOrganizationDTO dto) throws Throwable {
        
     }

    protected UAOrganizationDTO onAfterGetDraft(UAOrganizationDTO result, UAOrganizationDTO dto) throws Throwable {
      return result;
    }
