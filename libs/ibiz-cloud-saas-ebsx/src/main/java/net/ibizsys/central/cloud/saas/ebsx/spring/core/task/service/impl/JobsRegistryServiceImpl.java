...
@Service
public class JobsRegistryServiceImpl extends DEServiceBase<JobsRegistryDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.task.service.IJobsRegistryService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == JobsRegistryServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    JobsRegistryDTO dto = (JobsRegistryDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    JobsRegistryDTO result = (JobsRegistryDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(JobsRegistryDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(JobsRegistryDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(JobsRegistryDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(JobsRegistryDTO dto) throws Throwable {
    ...
    protected JobsRegistryDTO onAfterGet(JobsRegistryDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(JobsRegistryDTO dto) throws Throwable {
        
     }

    protected JobsRegistryDTO onAfterGetDraft(JobsRegistryDTO result, JobsRegistryDTO dto) throws Throwable {
      return result;
    }
