 ...
 */
public class DCPOSimpleDTO extends EntityDTO {
  ...
  public final static String FIELD_UPDATEMAN = "updateman";
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO setCreateDate(Timestamp val) {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO resetCreateDate() {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO setCreateMan(String val) {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO resetCreateMan() {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO setSysPOId(String val) {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO resetSysPOId() {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO setSysPOName(String val) {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO resetSysPOName() {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO setUpdateDate(Timestamp val) {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO resetUpdateDate() {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO setUpdateMan(String val) {
    ...
    */
    @JsonIgnore
    public DCPOSimpleDTO resetUpdateMan() {
