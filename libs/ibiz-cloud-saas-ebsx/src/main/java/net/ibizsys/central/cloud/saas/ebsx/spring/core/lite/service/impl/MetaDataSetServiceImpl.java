...
@Service
public class MetaDataSetServiceImpl extends DEServiceBase<MetaDataSetDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IMetaDataSetService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MetaDataSetServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MetaDataSetDTO dto = (MetaDataSetDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MetaDataSetDTO result = (MetaDataSetDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MetaDataSetDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MetaDataSetDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MetaDataSetDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MetaDataSetDTO dto) throws Throwable {
    ...
    protected MetaDataSetDTO onAfterGet(MetaDataSetDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MetaDataSetDTO dto) throws Throwable {
        
     }

    protected MetaDataSetDTO onAfterGetDraft(MetaDataSetDTO result, MetaDataSetDTO dto) throws Throwable {
      return result;
    }
