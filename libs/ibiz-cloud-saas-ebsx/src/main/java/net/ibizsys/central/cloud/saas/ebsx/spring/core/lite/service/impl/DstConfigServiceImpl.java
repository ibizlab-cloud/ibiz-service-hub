...
public class DstConfigServiceImpl extends DEServiceBase<DstConfigDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstConfigService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstConfigServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstConfigDTO dto = (DstConfigDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstConfigDTO result = (DstConfigDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_RESET, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onReset((DstConfigDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(DstConfigDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstConfigDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstConfigDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstConfigDTO dto) throws Throwable {
    ...
    protected DstConfigDTO onAfterGet(DstConfigDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstConfigDTO dto) throws Throwable {
        
     }

    protected DstConfigDTO onAfterGetDraft(DstConfigDTO result, DstConfigDTO dto) throws Throwable {
      return result;
    }

    protected void onReset(DstConfigDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "reset"), Errors.NOTIMPL);
    }
