 ...
 */
public class OpenAccessDTO extends EntityDTO {
   ...
   * 回调参数
   *
   * @see ibizmos:/psmodules/uaa/psdataentities/SYS_OPEN_ACCESS/psdefields/CALLBACK_PARAM/.ibizmodel.index
   */
   ...
   * 回调参数2
   *
   * @see ibizmos:/psmodules/uaa/psdataentities/SYS_OPEN_ACCESS/psdefields/CALLBACK_PARAM2/.ibizmodel.index
   */
   ...
   * 回调标识
   *
   * @see ibizmos:/psmodules/uaa/psdataentities/SYS_OPEN_ACCESS/psdefields/CALLBACK_TOKEN/.ibizmodel.index
   */
   ...
   * {@link net.ibizsys.central.cloud.saas.ebsx.spring.core.runtime.dict.StaticDict.YesNo} 
   *
   * @see ibizmos:/psmodules/uaa/psdataentities/SYS_OPEN_ACCESS/psdefields/DEFAULTFLAG/.ibizmodel.index
   * @see ibizmos:/psmodules/uaa/pscodelists/YesNo.ibizmodel.yaml
   */
  ...
  public final static String FIELD_ISMOBACCAPP = "ismobaccapp";
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setId(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setName(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetName() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setOpenType(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetOpenType() {
        this._reset(FIELD_OPENTYPE);
        return this;
    }

    /**
     * 设置「AccessKey(AppId,CropId)」
     *
     * @param val
    */
    @JsonIgnore
    public OpenAccessDTO setAccessKey(String val) {
        this._set(FIELD_ACCESSKEY, val);
        return this;
    }

    /**
     * 获取「AccessKey(AppId,CropId)」值
     *
    */
    @JsonIgnore
    ...
    /**
     * 判断 「AccessKey(AppId,CropId)」是否有值
     *
    */
    @JsonIgnore
    ...
    /**
     * 重置 「AccessKey(AppId,CropId)」
     *
    */
    @JsonIgnore
    public OpenAccessDTO resetAccessKey() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setSecretKey(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetSecretKey() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setRegionId(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetRegionId() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setAccessToken(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetAccessToken() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setExpiresTime(Timestamp val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetExpiresTime() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setDisabled(Integer val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetDisabled() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setRedirectUri(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetRedirectUri() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setNotifyUrl(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetNotifyUrl() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setAgentId(Long val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetAgentId() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setOrgId(String val) {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetOrgId() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setCallbackParam(String val) {
        this._set(FIELD_CALLBACKPARAM, val);
        return this;
    }
    ...
    */
    ...
    public String getCallbackParam() {
        return (String) this._get(FIELD_CALLBACKPARAM);
    }
    ...
    */
    ...
    public boolean containsCallbackParam() {
        return this._contains(FIELD_CALLBACKPARAM);
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetCallbackParam() {
        this._reset(FIELD_CALLBACKPARAM);
        return this;
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setCallbackParam2(String val) {
        this._set(FIELD_CALLBACKPARAM2, val);
        return this;
    }
    ...
    */
    ...
    public String getCallbackParam2() {
        return (String) this._get(FIELD_CALLBACKPARAM2);
    }
    ...
    */
    ...
    public boolean containsCallbackParam2() {
        return this._contains(FIELD_CALLBACKPARAM2);
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetCallbackParam2() {
        this._reset(FIELD_CALLBACKPARAM2);
        return this;
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setCallbackToken(String val) {
        this._set(FIELD_CALLBACKTOKEN, val);
        return this;
    }
    ...
    */
    ...
    public String getCallbackToken() {
        return (String) this._get(FIELD_CALLBACKTOKEN);
    }
    ...
    */
    ...
    public boolean containsCallbackToken() {
        return this._contains(FIELD_CALLBACKTOKEN);
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetCallbackToken() {
        this._reset(FIELD_CALLBACKTOKEN);
        return this;
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setDefaultflag(Integer val) {
    ...
    */
    ...
    public Integer getDefaultflag() {
        try{
            return DataTypeUtils.getIntegerValue(this._get(FIELD_DEFAULTFLAG),null);
        }catch (Exception e){
            throw new RuntimeException(e);
        }
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetDefaultflag() {
    ...
    */
    @JsonIgnore
    public OpenAccessDTO setIsMobAccApp(Integer val) {
        this._set(FIELD_ISMOBACCAPP, val);
        return this;
    }
    ...
    */
    ...
    public Integer getIsMobAccApp() {
        try{
            return DataTypeUtils.getIntegerValue(this._get(FIELD_ISMOBACCAPP),null);
        }catch (Exception e){
            throw new RuntimeException(e);
        }
    }
    ...
    */
    ...
    public boolean containsIsMobAccApp() {
        return this._contains(FIELD_ISMOBACCAPP);
    }
    ...
    */
    @JsonIgnore
    public OpenAccessDTO resetIsMobAccApp() {
        this._reset(FIELD_ISMOBACCAPP);
        return this;
    }
