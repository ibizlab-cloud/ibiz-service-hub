...
@Service
public class WFTaskWayServiceImpl extends DEServiceBase<WFTaskWayDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFTaskWayService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFTaskWayServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFTaskWayDTO dto = (WFTaskWayDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFTaskWayDTO result = (WFTaskWayDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFTaskWayDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFTaskWayDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFTaskWayDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFTaskWayDTO dto) throws Throwable {
    ...
    protected WFTaskWayDTO onAfterGet(WFTaskWayDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFTaskWayDTO dto) throws Throwable {
        
     }

    protected WFTaskWayDTO onAfterGetDraft(WFTaskWayDTO result, WFTaskWayDTO dto) throws Throwable {
      return result;
    }
