...
public class MsgSendQueueServiceImpl extends DEServiceBase<MsgSendQueueDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgSendQueueService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgSendQueueServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgSendQueueDTO dto = (MsgSendQueueDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgSendQueueDTO result = (MsgSendQueueDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SEND, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onSend((MsgSendQueueDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(MsgSendQueueDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgSendQueueDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgSendQueueDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgSendQueueDTO dto) throws Throwable {
    ...
    protected MsgSendQueueDTO onAfterGet(MsgSendQueueDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgSendQueueDTO dto) throws Throwable {
        
     }

    protected MsgSendQueueDTO onAfterGetDraft(MsgSendQueueDTO result, MsgSendQueueDTO dto) throws Throwable {
      return result;
    }

    protected void onSend(MsgSendQueueDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "发送"), Errors.NOTIMPL);
    }
