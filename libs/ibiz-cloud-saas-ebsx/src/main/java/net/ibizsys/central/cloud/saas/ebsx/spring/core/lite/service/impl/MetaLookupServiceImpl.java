...
@Service
public class MetaLookupServiceImpl extends DEServiceBase<MetaLookupDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IMetaLookupService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MetaLookupServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MetaLookupDTO dto = (MetaLookupDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MetaLookupDTO result = (MetaLookupDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MetaLookupDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MetaLookupDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MetaLookupDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MetaLookupDTO dto) throws Throwable {
    ...
    protected MetaLookupDTO onAfterGet(MetaLookupDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MetaLookupDTO dto) throws Throwable {
        
     }

    protected MetaLookupDTO onAfterGetDraft(MetaLookupDTO result, MetaLookupDTO dto) throws Throwable {
      return result;
    }
