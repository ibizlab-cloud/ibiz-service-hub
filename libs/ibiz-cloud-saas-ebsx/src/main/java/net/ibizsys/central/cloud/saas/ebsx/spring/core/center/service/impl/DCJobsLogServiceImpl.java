...
@Service
public class DCJobsLogServiceImpl extends DEServiceBase<DCJobsLogDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCJobsLogService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCJobsLogServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCJobsLogDTO dto = (DCJobsLogDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCJobsLogDTO result = (DCJobsLogDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCJobsLogDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCJobsLogDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCJobsLogDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCJobsLogDTO dto) throws Throwable {
    ...
    protected DCJobsLogDTO onAfterGet(DCJobsLogDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCJobsLogDTO dto) throws Throwable {
        
     }

    protected DCJobsLogDTO onAfterGetDraft(DCJobsLogDTO result, DCJobsLogDTO dto) throws Throwable {
      return result;
    }
