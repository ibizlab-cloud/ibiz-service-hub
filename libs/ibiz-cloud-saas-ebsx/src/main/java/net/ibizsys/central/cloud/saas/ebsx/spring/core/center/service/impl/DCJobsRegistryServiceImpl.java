...
@Service
public class DCJobsRegistryServiceImpl extends DEServiceBase<DCJobsRegistryDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCJobsRegistryService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCJobsRegistryServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCJobsRegistryDTO dto = (DCJobsRegistryDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCJobsRegistryDTO result = (DCJobsRegistryDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCJobsRegistryDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCJobsRegistryDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCJobsRegistryDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCJobsRegistryDTO dto) throws Throwable {
    ...
    protected DCJobsRegistryDTO onAfterGet(DCJobsRegistryDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCJobsRegistryDTO dto) throws Throwable {
        
     }

    protected DCJobsRegistryDTO onAfterGetDraft(DCJobsRegistryDTO result, DCJobsRegistryDTO dto) throws Throwable {
      return result;
    }
