...
@Service
public class DCOrgSystemServiceImpl extends DEServiceBase<DCOrgSystemDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCOrgSystemService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCOrgSystemServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCOrgSystemDTO dto = (DCOrgSystemDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCOrgSystemDTO result = (DCOrgSystemDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCOrgSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCOrgSystemDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCOrgSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCOrgSystemDTO dto) throws Throwable {
    ...
    protected DCOrgSystemDTO onAfterGet(DCOrgSystemDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCOrgSystemDTO dto) throws Throwable {
        
     }

    protected DCOrgSystemDTO onAfterGetDraft(DCOrgSystemDTO result, DCOrgSystemDTO dto) throws Throwable {
      return result;
    }
