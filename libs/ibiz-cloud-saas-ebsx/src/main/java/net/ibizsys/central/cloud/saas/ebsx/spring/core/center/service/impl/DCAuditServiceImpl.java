...
import net.ibizsys.central.cloud.saas.ebsx.spring.core.center.dto.DCAuditDTO;
import net.ibizsys.central.cloud.saas.ebsx.spring.core.center.dto.DCAuditSimpleDTO;
...
@Service
public class DCAuditServiceImpl extends DEServiceBase<DCAuditDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCAuditService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCAuditServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCAuditDTO dto = (DCAuditDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCAuditDTO result = (DCAuditDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCAuditDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCAuditDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCAuditDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCAuditDTO dto) throws Throwable {
    ...
    protected DCAuditDTO onAfterGet(DCAuditDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCAuditDTO dto) throws Throwable {
        
     }

    protected DCAuditDTO onAfterGetDraft(DCAuditDTO result, DCAuditDTO dto) throws Throwable {
      return result;
    }
