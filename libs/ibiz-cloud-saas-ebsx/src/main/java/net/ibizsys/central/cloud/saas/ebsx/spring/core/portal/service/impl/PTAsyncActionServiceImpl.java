package net.ibizsys.central.cloud.saas.ebsx.spring.core.portal.service.impl;
...
@Service
public class PTAsyncActionServiceImpl extends DEServiceBase<PTAsyncActionDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.portal.service.IPTAsyncActionService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PTAsyncActionServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    PTAsyncActionDTO dto = (PTAsyncActionDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PTAsyncActionDTO result = (PTAsyncActionDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(PTAsyncActionDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PTAsyncActionDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PTAsyncActionDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PTAsyncActionDTO dto) throws Throwable {
    ...
    protected PTAsyncActionDTO onAfterGet(PTAsyncActionDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PTAsyncActionDTO dto) throws Throwable {
        
     }

    protected PTAsyncActionDTO onAfterGetDraft(PTAsyncActionDTO result, PTAsyncActionDTO dto) throws Throwable {
      return result;
    }
