...
public class UserRoleServiceImpl extends DEServiceBase<UserRoleDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IUserRoleService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == UserRoleServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    UserRoleDTO dto = (UserRoleDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    UserRoleDTO result = (UserRoleDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_FINDROLE, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onFindRole((UserRoleDTO) args[0]);
                            return null;
                        }
            ...
            //结果集
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_ACCESSDCSYSTEM, new IDEDataSetPluginRuntime() {
                @Override
    ...
    protected void onBeforeCreate(UserRoleDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(UserRoleDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(UserRoleDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(UserRoleDTO dto) throws Throwable {
    ...
    protected UserRoleDTO onAfterGet(UserRoleDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(UserRoleDTO dto) throws Throwable {
        
     }

    protected UserRoleDTO onAfterGetDraft(UserRoleDTO result, UserRoleDTO dto) throws Throwable {
      return result;
    }

    protected void onFindRole(UserRoleDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "查询用户角色"), Errors.NOTIMPL);
    }
