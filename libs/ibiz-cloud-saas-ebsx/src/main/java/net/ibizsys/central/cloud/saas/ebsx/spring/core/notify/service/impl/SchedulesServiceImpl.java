...
@Service
public class SchedulesServiceImpl extends DEServiceBase<SchedulesDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.ISchedulesService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SchedulesServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    SchedulesDTO dto = (SchedulesDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SchedulesDTO result = (SchedulesDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SchedulesDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SchedulesDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SchedulesDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SchedulesDTO dto) throws Throwable {
    ...
    protected SchedulesDTO onAfterGet(SchedulesDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SchedulesDTO dto) throws Throwable {
        
     }

    protected SchedulesDTO onAfterGetDraft(SchedulesDTO result, SchedulesDTO dto) throws Throwable {
      return result;
    }
