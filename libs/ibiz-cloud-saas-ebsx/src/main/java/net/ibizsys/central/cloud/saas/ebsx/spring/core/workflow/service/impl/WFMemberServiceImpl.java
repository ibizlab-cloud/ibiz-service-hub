...
public class WFMemberServiceImpl extends DEServiceBase<WFMemberDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFMemberService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFMemberServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFMemberDTO dto = (WFMemberDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFMemberDTO result = (WFMemberDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SELECTMULTIDEPTUSER, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onSelectMultiDeptUser((WFMemberDTO) args[0]);
                            return null;
                        }
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_MULTIDEPTUSER, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(WFMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFMemberDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFMemberDTO dto) throws Throwable {
    ...
    protected WFMemberDTO onAfterGet(WFMemberDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFMemberDTO dto) throws Throwable {
        
     }

    protected WFMemberDTO onAfterGetDraft(WFMemberDTO result, WFMemberDTO dto) throws Throwable {
      return result;
    }

    protected void onSelectMultiDeptUser(WFMemberDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "查询部门人员"), Errors.NOTIMPL);
    }
