...
@Service
public class WFSystemServiceImpl extends DEServiceBase<WFSystemDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFSystemService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFSystemServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFSystemDTO dto = (WFSystemDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFSystemDTO result = (WFSystemDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFSystemDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFSystemDTO dto) throws Throwable {
    ...
    protected WFSystemDTO onAfterGet(WFSystemDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFSystemDTO dto) throws Throwable {
        
     }

    protected WFSystemDTO onAfterGetDraft(WFSystemDTO result, WFSystemDTO dto) throws Throwable {
      return result;
    }
