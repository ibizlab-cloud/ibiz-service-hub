...
@Service
public class SysPOServiceImpl extends DEServiceBase<SysPODTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.log.service.ISysPOService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SysPOServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SysPODTO result = (SysPODTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SysPODTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SysPODTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SysPODTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SysPODTO dto) throws Throwable {
    ...
    protected SysPODTO onAfterGet(SysPODTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SysPODTO dto) throws Throwable {
        
     }

    protected SysPODTO onAfterGetDraft(SysPODTO result, SysPODTO dto) throws Throwable {
      return result;
    }
