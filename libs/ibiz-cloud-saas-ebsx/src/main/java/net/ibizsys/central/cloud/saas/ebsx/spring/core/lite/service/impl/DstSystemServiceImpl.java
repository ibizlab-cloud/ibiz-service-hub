...
public class DstSystemServiceImpl extends DEServiceBase<DstSystemDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstSystemService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstSystemServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstSystemDTO dto = (DstSystemDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstSystemDTO result = (DstSystemDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_INITDEFAULTDATASOURCE, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onInitDefaultDataSource((DstSystemDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            });
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SYNCSYSMODEL, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onSyncSysModel((DstSystemDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
    ...
    protected void onBeforeCreate(DstSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstSystemDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstSystemDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstSystemDTO dto) throws Throwable {
    ...
    protected DstSystemDTO onAfterGet(DstSystemDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstSystemDTO dto) throws Throwable {
        
     }

    protected DstSystemDTO onAfterGetDraft(DstSystemDTO result, DstSystemDTO dto) throws Throwable {
      return result;
    }

    protected void onInitDefaultDataSource(DstSystemDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "initDefaultDataSource"), Errors.NOTIMPL);
    }

    protected void onSyncSysModel(DstSystemDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "同步系统模型"), Errors.NOTIMPL);
    }
