...
public class DstComponentServiceImpl extends DEServiceBase<DstComponentDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstComponentService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstComponentServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstComponentDTO dto = (DstComponentDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstComponentDTO result = (DstComponentDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SYNC, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onSync((DstComponentDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(DstComponentDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstComponentDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstComponentDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstComponentDTO dto) throws Throwable {
    ...
    protected DstComponentDTO onAfterGet(DstComponentDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstComponentDTO dto) throws Throwable {
        
     }

    protected DstComponentDTO onAfterGetDraft(DstComponentDTO result, DstComponentDTO dto) throws Throwable {
      return result;
    }

    protected void onSync(DstComponentDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "Sync"), Errors.NOTIMPL);
    }
