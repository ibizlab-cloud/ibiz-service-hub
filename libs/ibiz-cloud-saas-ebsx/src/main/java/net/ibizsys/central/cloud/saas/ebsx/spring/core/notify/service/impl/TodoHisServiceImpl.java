...
@Service
public class TodoHisServiceImpl extends DEServiceBase<TodoHisDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.ITodoHisService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == TodoHisServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    TodoHisDTO dto = (TodoHisDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    TodoHisDTO result = (TodoHisDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_CURUSERLAST, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(TodoHisDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(TodoHisDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(TodoHisDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(TodoHisDTO dto) throws Throwable {
    ...
    protected TodoHisDTO onAfterGet(TodoHisDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(TodoHisDTO dto) throws Throwable {
        
     }

    protected TodoHisDTO onAfterGetDraft(TodoHisDTO result, TodoHisDTO dto) throws Throwable {
      return result;
    }
