...
@Service
public class MsgBodyServiceImpl extends DEServiceBase<MsgBodyDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgBodyService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgBodyServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgBodyDTO dto = (MsgBodyDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgBodyDTO result = (MsgBodyDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MsgBodyDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgBodyDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgBodyDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgBodyDTO dto) throws Throwable {
    ...
    protected MsgBodyDTO onAfterGet(MsgBodyDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgBodyDTO dto) throws Throwable {
        
     }

    protected MsgBodyDTO onAfterGetDraft(MsgBodyDTO result, MsgBodyDTO dto) throws Throwable {
      return result;
    }
