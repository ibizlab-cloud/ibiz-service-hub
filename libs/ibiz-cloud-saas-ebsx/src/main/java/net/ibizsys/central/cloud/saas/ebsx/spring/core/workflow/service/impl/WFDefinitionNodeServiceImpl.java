...
public class WFDefinitionNodeServiceImpl extends DEServiceBase<WFDefinitionNodeDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFDefinitionNodeService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFDefinitionNodeServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFDefinitionNodeDTO dto = (WFDefinitionNodeDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFDefinitionNodeDTO result = (WFDefinitionNodeDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GETWFDEFINITIONNODES, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            return onGetWFDefinitionNodes((String) args[0]);
                        }
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_QUERYBYINSTID, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(WFDefinitionNodeDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFDefinitionNodeDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFDefinitionNodeDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFDefinitionNodeDTO dto) throws Throwable {
    ...
    protected WFDefinitionNodeDTO onAfterGet(WFDefinitionNodeDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFDefinitionNodeDTO dto) throws Throwable {
        
     }

    protected WFDefinitionNodeDTO onAfterGetDraft(WFDefinitionNodeDTO result, WFDefinitionNodeDTO dto) throws Throwable {
      return result;
    }

    protected WFDefinitionNodeDTO onGetWFDefinitionNodes(String key) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "获取流程定义节点"), Errors.NOTIMPL);
    }
