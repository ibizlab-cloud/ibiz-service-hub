...
@Service
public class SysAuditServiceImpl extends DEServiceBase<SysAuditDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.log.service.ISysAuditService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == SysAuditServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    SysAuditDTO dto = (SysAuditDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    SysAuditDTO result = (SysAuditDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(SysAuditDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(SysAuditDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(SysAuditDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(SysAuditDTO dto) throws Throwable {
    ...
    protected SysAuditDTO onAfterGet(SysAuditDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(SysAuditDTO dto) throws Throwable {
        
     }

    protected SysAuditDTO onAfterGetDraft(SysAuditDTO result, SysAuditDTO dto) throws Throwable {
      return result;
    }
