...
@Service
public class MetaFieldServiceImpl extends DEServiceBase<MetaFieldDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IMetaFieldService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MetaFieldServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MetaFieldDTO dto = (MetaFieldDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MetaFieldDTO result = (MetaFieldDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MetaFieldDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MetaFieldDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MetaFieldDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MetaFieldDTO dto) throws Throwable {
    ...
    protected MetaFieldDTO onAfterGet(MetaFieldDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MetaFieldDTO dto) throws Throwable {
        
     }

    protected MetaFieldDTO onAfterGetDraft(MetaFieldDTO result, MetaFieldDTO dto) throws Throwable {
      return result;
    }
