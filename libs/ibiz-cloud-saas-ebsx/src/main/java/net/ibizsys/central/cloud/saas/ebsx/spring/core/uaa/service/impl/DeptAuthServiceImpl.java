...
public class DeptAuthServiceImpl extends DEServiceBase<DeptAuthDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IDeptAuthService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DeptAuthServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DeptAuthDTO dto = (DeptAuthDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DeptAuthDTO result = (DeptAuthDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_AUTO, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onAuto((DeptAuthDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(DeptAuthDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DeptAuthDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DeptAuthDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DeptAuthDTO dto) throws Throwable {
    ...
    protected DeptAuthDTO onAfterGet(DeptAuthDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DeptAuthDTO dto) throws Throwable {
        
     }

    protected DeptAuthDTO onAfterGetDraft(DeptAuthDTO result, DeptAuthDTO dto) throws Throwable {
      return result;
    }

    protected void onAuto(DeptAuthDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "自动生成"), Errors.NOTIMPL);
    }

    protected void onBind(DeptAuthDTO dto) throws Throwable {
