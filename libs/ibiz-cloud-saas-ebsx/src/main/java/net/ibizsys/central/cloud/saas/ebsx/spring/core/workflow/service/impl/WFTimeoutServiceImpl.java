...
@Service
public class WFTimeoutServiceImpl extends DEServiceBase<WFTimeoutDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFTimeoutService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFTimeoutServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFTimeoutDTO dto = (WFTimeoutDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFTimeoutDTO result = (WFTimeoutDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFTimeoutDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFTimeoutDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFTimeoutDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFTimeoutDTO dto) throws Throwable {
    ...
    protected WFTimeoutDTO onAfterGet(WFTimeoutDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFTimeoutDTO dto) throws Throwable {
        
     }

    protected WFTimeoutDTO onAfterGetDraft(WFTimeoutDTO result, WFTimeoutDTO dto) throws Throwable {
      return result;
    }
