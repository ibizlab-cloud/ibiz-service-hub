...
@Service
public class WFHistoryServiceImpl extends DEServiceBase<WFHistoryDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFHistoryService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFHistoryServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFHistoryDTO dto = (WFHistoryDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFHistoryDTO result = (WFHistoryDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFHistoryDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFHistoryDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFHistoryDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFHistoryDTO dto) throws Throwable {
    ...
    protected WFHistoryDTO onAfterGet(WFHistoryDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFHistoryDTO dto) throws Throwable {
        
     }

    protected WFHistoryDTO onAfterGetDraft(WFHistoryDTO result, WFHistoryDTO dto) throws Throwable {
      return result;
    }
