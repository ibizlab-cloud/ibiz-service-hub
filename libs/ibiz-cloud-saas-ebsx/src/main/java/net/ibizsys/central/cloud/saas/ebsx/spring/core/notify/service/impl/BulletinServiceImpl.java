...
public class BulletinServiceImpl extends DEServiceBase<BulletinDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IBulletinService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == BulletinServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    BulletinDTO dto = (BulletinDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    BulletinDTO result = (BulletinDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        ...
                        public Object execute(Object[] args) throws Throwable {
                            onPublish((BulletinDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            });
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_RETRACT, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    BulletinDTO dto = (BulletinDTO) args[0];
                    onBeforeRetract(dto);
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_ORGBULLETIN, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
            });
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_PUBLISH, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(BulletinDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(BulletinDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(BulletinDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(BulletinDTO dto) throws Throwable {
    ...
    protected BulletinDTO onAfterGet(BulletinDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(BulletinDTO dto) throws Throwable {
        
     }

    protected BulletinDTO onAfterGetDraft(BulletinDTO result, BulletinDTO dto) throws Throwable {
      return result;
    }

    protected void onPublish(BulletinDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "发布"), Errors.NOTIMPL);
    }

    protected void onBeforeRetract(BulletinDTO dto) throws Throwable {
        
     }

    protected void onAfterRetract(BulletinDTO dto) throws Throwable {
