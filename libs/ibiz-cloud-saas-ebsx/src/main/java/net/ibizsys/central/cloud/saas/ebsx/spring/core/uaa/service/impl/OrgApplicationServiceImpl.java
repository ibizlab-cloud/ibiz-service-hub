...
@Service
public class OrgApplicationServiceImpl extends DEServiceBase<OrgApplicationDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IOrgApplicationService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == OrgApplicationServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    OrgApplicationDTO dto = (OrgApplicationDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    OrgApplicationDTO result = (OrgApplicationDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(OrgApplicationDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(OrgApplicationDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(OrgApplicationDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(OrgApplicationDTO dto) throws Throwable {
    ...
    protected OrgApplicationDTO onAfterGet(OrgApplicationDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(OrgApplicationDTO dto) throws Throwable {
        
     }

    protected OrgApplicationDTO onAfterGetDraft(OrgApplicationDTO result, OrgApplicationDTO dto) throws Throwable {
      return result;
    }
