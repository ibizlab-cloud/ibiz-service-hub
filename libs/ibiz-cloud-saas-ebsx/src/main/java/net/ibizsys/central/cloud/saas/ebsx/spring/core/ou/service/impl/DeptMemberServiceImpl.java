...
@Service
public class DeptMemberServiceImpl extends DEServiceBase<DeptMemberDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.IDeptMemberService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DeptMemberServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DeptMemberDTO dto = (DeptMemberDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DeptMemberDTO result = (DeptMemberDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SAVEDEPTMEMBER, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DeptMemberDTO dto = (DeptMemberDTO) args[0];
                    onBeforeSaveDeptMember(dto);
                    iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
                    onAfterSaveDeptMember(dto);
                    return null;
                }
            });
    ...
    protected void onBeforeCreate(DeptMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DeptMemberDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DeptMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DeptMemberDTO dto) throws Throwable {
    ...
    protected DeptMemberDTO onAfterGet(DeptMemberDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DeptMemberDTO dto) throws Throwable {
        
     }

    protected DeptMemberDTO onAfterGetDraft(DeptMemberDTO result, DeptMemberDTO dto) throws Throwable {
      return result;
    }

    protected void onBeforeSaveDeptMember(DeptMemberDTO dto) throws Throwable {
        
     }

    protected void onAfterSaveDeptMember(DeptMemberDTO dto) throws Throwable {
