...
@Service
public class MsgTemplateServiceImpl extends DEServiceBase<MsgTemplateDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgTemplateService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgTemplateServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgTemplateDTO dto = (MsgTemplateDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgTemplateDTO result = (MsgTemplateDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MsgTemplateDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgTemplateDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgTemplateDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgTemplateDTO dto) throws Throwable {
    ...
    protected MsgTemplateDTO onAfterGet(MsgTemplateDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgTemplateDTO dto) throws Throwable {
        
     }

    protected MsgTemplateDTO onAfterGetDraft(MsgTemplateDTO result, MsgTemplateDTO dto) throws Throwable {
      return result;
    }
