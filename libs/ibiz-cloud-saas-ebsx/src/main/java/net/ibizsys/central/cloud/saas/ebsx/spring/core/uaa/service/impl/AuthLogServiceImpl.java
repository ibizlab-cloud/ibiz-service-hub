...
@Service
public class AuthLogServiceImpl extends DEServiceBase<AuthLogDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IAuthLogService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == AuthLogServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    AuthLogDTO dto = (AuthLogDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    AuthLogDTO result = (AuthLogDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(AuthLogDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(AuthLogDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(AuthLogDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(AuthLogDTO dto) throws Throwable {
    ...
    protected AuthLogDTO onAfterGet(AuthLogDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(AuthLogDTO dto) throws Throwable {
        
     }

    protected AuthLogDTO onAfterGetDraft(AuthLogDTO result, AuthLogDTO dto) throws Throwable {
      return result;
    }
