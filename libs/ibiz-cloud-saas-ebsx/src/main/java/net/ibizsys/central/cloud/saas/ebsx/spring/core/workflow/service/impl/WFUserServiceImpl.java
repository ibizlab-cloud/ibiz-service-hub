...
@Service
public class WFUserServiceImpl extends DEServiceBase<WFUserDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFUserService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFUserServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFUserDTO dto = (WFUserDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFUserDTO result = (WFUserDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFUserDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFUserDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFUserDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFUserDTO dto) throws Throwable {
    ...
    protected WFUserDTO onAfterGet(WFUserDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFUserDTO dto) throws Throwable {
        
     }

    protected WFUserDTO onAfterGetDraft(WFUserDTO result, WFUserDTO dto) throws Throwable {
      return result;
    }
