...
public class MetaModelServiceImpl extends DEServiceBase<MetaModelDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IMetaModelService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MetaModelServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MetaModelDTO dto = (MetaModelDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MetaModelDTO result = (MetaModelDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CHANGE, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onChange((MetaModelDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(MetaModelDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MetaModelDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MetaModelDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MetaModelDTO dto) throws Throwable {
    ...
    protected MetaModelDTO onAfterGet(MetaModelDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MetaModelDTO dto) throws Throwable {
        
     }

    protected MetaModelDTO onAfterGetDraft(MetaModelDTO result, MetaModelDTO dto) throws Throwable {
      return result;
    }

    protected void onChange(MetaModelDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "change"), Errors.NOTIMPL);
    }
