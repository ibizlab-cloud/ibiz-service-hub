...
@Service
public class DCDynaInstServiceImpl extends DEServiceBase<DCDynaInstDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCDynaInstService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCDynaInstServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCDynaInstDTO dto = (DCDynaInstDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCDynaInstDTO result = (DCDynaInstDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCDynaInstDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCDynaInstDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCDynaInstDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCDynaInstDTO dto) throws Throwable {
    ...
    protected DCDynaInstDTO onAfterGet(DCDynaInstDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCDynaInstDTO dto) throws Throwable {
        
     }

    protected DCDynaInstDTO onAfterGetDraft(DCDynaInstDTO result, DCDynaInstDTO dto) throws Throwable {
      return result;
    }
