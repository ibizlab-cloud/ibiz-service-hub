...
@Service
public class MetaModuleServiceImpl extends DEServiceBase<MetaModuleDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IMetaModuleService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MetaModuleServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MetaModuleDTO dto = (MetaModuleDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MetaModuleDTO result = (MetaModuleDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MetaModuleDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MetaModuleDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MetaModuleDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MetaModuleDTO dto) throws Throwable {
    ...
    protected MetaModuleDTO onAfterGet(MetaModuleDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MetaModuleDTO dto) throws Throwable {
        
     }

    protected MetaModuleDTO onAfterGetDraft(MetaModuleDTO result, MetaModuleDTO dto) throws Throwable {
      return result;
    }
