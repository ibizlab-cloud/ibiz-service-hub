...
@Service
public class PTNotesServiceImpl extends DEServiceBase<PTNotesDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.portal.service.IPTNotesService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PTNotesServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    PTNotesDTO dto = (PTNotesDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PTNotesDTO result = (PTNotesDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_MYNOTES, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(PTNotesDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PTNotesDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PTNotesDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PTNotesDTO dto) throws Throwable {
    ...
    protected PTNotesDTO onAfterGet(PTNotesDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PTNotesDTO dto) throws Throwable {
        
     }

    protected PTNotesDTO onAfterGetDraft(PTNotesDTO result, PTNotesDTO dto) throws Throwable {
      return result;
    }
