...
public class UserAuthServiceImpl extends DEServiceBase<UserAuthDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IUserAuthService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == UserAuthServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    UserAuthDTO dto = (UserAuthDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    UserAuthDTO result = (UserAuthDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(UserAuthDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(UserAuthDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(UserAuthDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(UserAuthDTO dto) throws Throwable {
    ...
    protected UserAuthDTO onAfterGet(UserAuthDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(UserAuthDTO dto) throws Throwable {
        
     }

    protected UserAuthDTO onAfterGetDraft(UserAuthDTO result, UserAuthDTO dto) throws Throwable {
      return result;
    }

    protected void onAuto(UserAuthDTO dto) throws Throwable {
