 ...
 */
public class DCAuditSimpleDTO extends EntityDTO {
  ...
  public final static String FIELD_UPDATEMAN = "updateman";
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO setCreateDate(Timestamp val) {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO resetCreateDate() {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO setCreateMan(String val) {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO resetCreateMan() {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO setSysAuditId(String val) {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO resetSysAuditId() {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO setSysAuditName(String val) {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO resetSysAuditName() {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO setUpdateDate(Timestamp val) {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO resetUpdateDate() {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO setUpdateMan(String val) {
    ...
    */
    @JsonIgnore
    public DCAuditSimpleDTO resetUpdateMan() {
