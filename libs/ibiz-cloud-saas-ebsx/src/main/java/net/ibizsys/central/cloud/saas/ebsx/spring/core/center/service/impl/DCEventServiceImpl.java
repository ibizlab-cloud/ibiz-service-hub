...
@Service
public class DCEventServiceImpl extends DEServiceBase<DCEventDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCEventService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCEventServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCEventDTO dto = (DCEventDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCEventDTO result = (DCEventDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCEventDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCEventDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCEventDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCEventDTO dto) throws Throwable {
    ...
    protected DCEventDTO onAfterGet(DCEventDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCEventDTO dto) throws Throwable {
        
     }

    protected DCEventDTO onAfterGetDraft(DCEventDTO result, DCEventDTO dto) throws Throwable {
      return result;
    }
