...
@Service
public class PostServiceImpl extends DEServiceBase<PostDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.IPostService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PostServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PostDTO result = (PostDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(PostDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PostDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PostDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PostDTO dto) throws Throwable {
    ...
    protected PostDTO onAfterGet(PostDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PostDTO dto) throws Throwable {
        
     }

    protected PostDTO onAfterGetDraft(PostDTO result, PostDTO dto) throws Throwable {
      return result;
    }
