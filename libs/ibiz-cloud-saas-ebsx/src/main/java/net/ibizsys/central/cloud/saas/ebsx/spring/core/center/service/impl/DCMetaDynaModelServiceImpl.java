...
public class DCMetaDynaModelServiceImpl extends DEServiceBase<DCMetaDynaModelDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCMetaDynaModelService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCMetaDynaModelServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCMetaDynaModelDTO dto = (DCMetaDynaModelDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCMetaDynaModelDTO result = (DCMetaDynaModelDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        ...
                        public Object execute(Object[] args) throws Throwable {
                            onCleanPublishPath((DCMetaDynaModelDTO) args[0]);
                            return null;
                        }
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_INIT, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onInit((DCMetaDynaModelDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_PUBLISH, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onPublish((DCMetaDynaModelDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SYNCMODEL, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onSyncModel((DCMetaDynaModelDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
    ...
    protected void onBeforeCreate(DCMetaDynaModelDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCMetaDynaModelDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCMetaDynaModelDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCMetaDynaModelDTO dto) throws Throwable {
    ...
    protected DCMetaDynaModelDTO onAfterGet(DCMetaDynaModelDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCMetaDynaModelDTO dto) throws Throwable {
        
     }

    protected DCMetaDynaModelDTO onAfterGetDraft(DCMetaDynaModelDTO result, DCMetaDynaModelDTO dto) throws Throwable {
      return result;
    }
