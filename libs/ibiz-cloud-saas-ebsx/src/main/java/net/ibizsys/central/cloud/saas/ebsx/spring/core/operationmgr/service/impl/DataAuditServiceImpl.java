package net.ibizsys.central.cloud.saas.ebsx.spring.core.operationmgr.service.impl;
...
@Service
public class DataAuditServiceImpl extends DEServiceBase<DataAuditDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.operationmgr.service.IDataAuditService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DataAuditServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DataAuditDTO dto = (DataAuditDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DataAuditDTO result = (DataAuditDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DataAuditDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DataAuditDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DataAuditDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DataAuditDTO dto) throws Throwable {
    ...
    protected DataAuditDTO onAfterGet(DataAuditDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DataAuditDTO dto) throws Throwable {
        
     }

    protected DataAuditDTO onAfterGetDraft(DataAuditDTO result, DataAuditDTO dto) throws Throwable {
      return result;
    }
