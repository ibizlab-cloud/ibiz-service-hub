...
public class RoleServiceImpl extends DEServiceBase<RoleDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IRoleService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == RoleServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    RoleDTO result = (RoleDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_NOREPEAT, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onNoRepeat((RoleDTO) args[0]);
                            return null;
                        }
            ...
            //结果集
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_BYDCSYSTEM, new IDEDataSetPluginRuntime() {
                @Override
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_CHECKAUTHORIZEALL, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_NOREPEAT, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected void onBeforeCreate(RoleDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(RoleDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(RoleDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(RoleDTO dto) throws Throwable {
    ...
    protected RoleDTO onAfterGet(RoleDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(RoleDTO dto) throws Throwable {
        
     }

    protected RoleDTO onAfterGetDraft(RoleDTO result, RoleDTO dto) throws Throwable {
      return result;
    }

    protected void onNoRepeat(RoleDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "角色去重查询"), Errors.NOTIMPL);
    }
