 ...
 */
public class MsgOpenAccessDTO extends EntityDTO {

  /**.
   * 开放应用
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/ACCESSID/.ibizmodel.index
   */
   ...
   * 应用名称
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/ACCESSNAME/.ibizmodel.index
   */
   ...
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/OPEN_TYPE/.ibizmodel.index
   ...
   * AccessKey(AppId)
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/ACCESS_KEY/.ibizmodel.index
   */
   ...
   * SecretKey(AppSecret)
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/SECRET_KEY/.ibizmodel.index
   */
  public final static String FIELD_SECRETKEY = "secretkey";

  /**.
   * RegionId（CorpId)
   * 添加中文名:Corpid(组织标识，钉钉）
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/REGION_ID/.ibizmodel.index
   */
   ...
   * 管理账号token
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/ACCESS_TOKEN/.ibizmodel.index
   */
   ...
   * 管理账号token过期时间
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/EXPIRES_TIME/.ibizmodel.index
   */
   ...
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/DISABLED/.ibizmodel.index
   ...
   * RedirectURI
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/REDIRECT_URI/.ibizmodel.index
   */
   ...
   * NotifyUrl
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/NOTIFY_URL/.ibizmodel.index
   */
  public final static String FIELD_NOTIFYURI = "notifyuri";

  /**.
   * AGENT_ID
   * 20210811:bigint->int
   *
   * @see ibizmos:/psmodules/notify/psdataentities/MSG_OPEN_ACCESS/psdefields/AGENT_ID/.ibizmodel.index
   */
  public final static String FIELD_AGENTID = "agentid";
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setId(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetId() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setName(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetName() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setOpenType(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetOpenType() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setAccessKey(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetAccessKey() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setSecretKey(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetSecretKey() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setRegionId(String val) {
        this._set(FIELD_REGIONID, val);
        return this;
    }

    /**
     * 获取「RegionId（CorpId)」值
     *
    */
    @JsonIgnore
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetRegionId() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setAccessToken(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetAccessToken() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setExpiresTime(Timestamp val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetExpiresTime() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setDisabled(Integer val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetDisabled() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setRedirectUri(String val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetRedirectUri() {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setNotifyUri(String val) {
        this._set(FIELD_NOTIFYURI, val);
        return this;
    }
    ...
    */
    ...
    public String getNotifyUri() {
        return (String) this._get(FIELD_NOTIFYURI);
    }
    ...
    */
    @JsonIgnore
    public boolean containsNotifyUri() {
        return this._contains(FIELD_NOTIFYURI);
    }
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetNotifyUri() {
        this._reset(FIELD_NOTIFYURI);
        return this;
    }
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO setAgentId(Long val) {
    ...
    */
    @JsonIgnore
    public MsgOpenAccessDTO resetAgentId() {
