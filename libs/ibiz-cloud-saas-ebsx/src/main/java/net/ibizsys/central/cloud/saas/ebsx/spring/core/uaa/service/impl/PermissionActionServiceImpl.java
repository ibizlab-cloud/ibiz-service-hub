...
@Service
public class PermissionActionServiceImpl extends DEServiceBase<PermissionActionDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IPermissionActionService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PermissionActionServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    PermissionActionDTO dto = (PermissionActionDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PermissionActionDTO result = (PermissionActionDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            //结果集
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_AUTHORITY, new IDEDataSetPluginRuntime() {
                @Override
    ...
    protected void onBeforeCreate(PermissionActionDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PermissionActionDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PermissionActionDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PermissionActionDTO dto) throws Throwable {
    ...
    protected PermissionActionDTO onAfterGet(PermissionActionDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PermissionActionDTO dto) throws Throwable {
        
     }

    protected PermissionActionDTO onAfterGetDraft(PermissionActionDTO result, PermissionActionDTO dto) throws Throwable {
      return result;
    }
