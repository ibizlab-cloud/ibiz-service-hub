...
@Service
public class MsgAccountServiceImpl extends DEServiceBase<MsgAccountDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgAccountService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgAccountServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgAccountDTO dto = (MsgAccountDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgAccountDTO result = (MsgAccountDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MsgAccountDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgAccountDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgAccountDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgAccountDTO dto) throws Throwable {
    ...
    protected MsgAccountDTO onAfterGet(MsgAccountDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgAccountDTO dto) throws Throwable {
        
     }

    protected MsgAccountDTO onAfterGetDraft(MsgAccountDTO result, MsgAccountDTO dto) throws Throwable {
      return result;
    }
