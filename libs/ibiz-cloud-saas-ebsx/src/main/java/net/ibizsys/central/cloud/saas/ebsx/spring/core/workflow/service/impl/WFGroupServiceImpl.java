...
public class WFGroupServiceImpl extends DEServiceBase<WFGroupDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFGroupService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFGroupServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFGroupDTO dto = (WFGroupDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFGroupDTO result = (WFGroupDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_EXTEND, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onExtend((WFGroupDTO) args[0]);
                            return null;
                        }
    ...
    protected void onBeforeCreate(WFGroupDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFGroupDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFGroupDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFGroupDTO dto) throws Throwable {
    ...
    protected WFGroupDTO onAfterGet(WFGroupDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFGroupDTO dto) throws Throwable {
        
     }

    protected WFGroupDTO onAfterGetDraft(WFGroupDTO result, WFGroupDTO dto) throws Throwable {
      return result;
    }

    protected void onExtend(WFGroupDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "Extend"), Errors.NOTIMPL);
    }
