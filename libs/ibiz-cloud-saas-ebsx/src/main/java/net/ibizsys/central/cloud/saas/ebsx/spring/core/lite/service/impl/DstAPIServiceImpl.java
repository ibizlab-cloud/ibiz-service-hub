...
@Service
public class DstAPIServiceImpl extends DEServiceBase<DstAPIDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstAPIService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstAPIServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstAPIDTO dto = (DstAPIDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstAPIDTO result = (DstAPIDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DstAPIDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstAPIDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstAPIDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstAPIDTO dto) throws Throwable {
    ...
    protected DstAPIDTO onAfterGet(DstAPIDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstAPIDTO dto) throws Throwable {
        
     }

    protected DstAPIDTO onAfterGetDraft(DstAPIDTO result, DstAPIDTO dto) throws Throwable {
      return result;
    }
