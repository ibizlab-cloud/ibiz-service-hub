...
@Service
public class DCPOServiceImpl extends DEServiceBase<DCPODTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCPOService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCPOServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCPODTO result = (DCPODTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCPODTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCPODTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCPODTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCPODTO dto) throws Throwable {
    ...
    protected DCPODTO onAfterGet(DCPODTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCPODTO dto) throws Throwable {
        
     }

    protected DCPODTO onAfterGetDraft(DCPODTO result, DCPODTO dto) throws Throwable {
      return result;
    }
