...
public class DstDataSourceServiceImpl extends DEServiceBase<DstDataSourceDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstDataSourceService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstDataSourceServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstDataSourceDTO dto = (DstDataSourceDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstDataSourceDTO result = (DstDataSourceDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_BUILDDS, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onBuildDS((DstDataSourceDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            });
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_INITDS, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onInitDS((DstDataSourceDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
    ...
    protected void onBeforeCreate(DstDataSourceDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstDataSourceDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstDataSourceDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstDataSourceDTO dto) throws Throwable {
    ...
    protected DstDataSourceDTO onAfterGet(DstDataSourceDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstDataSourceDTO dto) throws Throwable {
        
     }

    protected DstDataSourceDTO onAfterGetDraft(DstDataSourceDTO result, DstDataSourceDTO dto) throws Throwable {
      return result;
    }

    protected void onBuildDS(DstDataSourceDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "buildDS"), Errors.NOTIMPL);
    }

    protected void onInitDS(DstDataSourceDTO dto) throws Throwable {
