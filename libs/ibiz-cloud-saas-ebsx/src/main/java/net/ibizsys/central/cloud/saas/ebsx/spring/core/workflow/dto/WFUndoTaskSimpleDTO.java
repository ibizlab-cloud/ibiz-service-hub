 ...
 */
public class WFUndoTaskSimpleDTO extends EntityDTO {
  ...
  public final static String FIELD_TASKID = "taskid";
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setBusinessKey(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetBusinessKey() {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setDCSystemId(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetDCSystemId() {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setDeptId(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetDeptId() {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setEntityId(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetEntityId() {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setMajorText(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetMajorText() {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setOrgId(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetOrgId() {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO setTaskId(String val) {
    ...
    */
    @JsonIgnore
    public WFUndoTaskSimpleDTO resetTaskId() {
