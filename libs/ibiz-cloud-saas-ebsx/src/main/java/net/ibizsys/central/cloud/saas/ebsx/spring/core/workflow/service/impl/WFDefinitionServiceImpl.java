...
@Service
public class WFDefinitionServiceImpl extends DEServiceBase<WFDefinitionDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFDefinitionService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFDefinitionServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFDefinitionDTO dto = (WFDefinitionDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFDefinitionDTO result = (WFDefinitionDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFDefinitionDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFDefinitionDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFDefinitionDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFDefinitionDTO dto) throws Throwable {
    ...
    protected WFDefinitionDTO onAfterGet(WFDefinitionDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFDefinitionDTO dto) throws Throwable {
        
     }

    protected WFDefinitionDTO onAfterGetDraft(WFDefinitionDTO result, WFDefinitionDTO dto) throws Throwable {
      return result;
    }
