...
public class EmployeeServiceImpl extends DEServiceBase<EmployeeDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.IEmployeeService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == EmployeeServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    EmployeeDTO result = (EmployeeDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        ...
                        public Object execute(Object[] args) throws Throwable {
                            onChangePwd((EmployeeDTO) args[0]);
                            return null;
                        }
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_INITPWD, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onInitPwd((EmployeeDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            });
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_TEST, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    EmployeeDTO dto = (EmployeeDTO) args[0];
                    onBeforeTest(dto);
            ...
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_SYSTEMAUTH, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
            });
            this.getDataEntityRuntime().registerDEDataSetPluginRuntime(DATASET_WFSELECT, new IDEDataSetPluginRuntime() {
                @Override
                public Object fetch(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEDataSet iPSDEDataSet, Object[] args, Object actionData) throws Throwable {
                    return iDataEntityRuntimeContext.fetchDataSetReal(iPSDEDataSet, args, actionData);
                }
    ...
    protected EmployeeDTO onAfterGet(EmployeeDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(EmployeeDTO dto) throws Throwable {
        
     }

    protected EmployeeDTO onAfterGetDraft(EmployeeDTO result, EmployeeDTO dto) throws Throwable {
      return result;
    }
    ...
    protected void onBeforeTest(EmployeeDTO dto) throws Throwable {
        
     }

    protected void onAfterTest(EmployeeDTO dto) throws Throwable {
