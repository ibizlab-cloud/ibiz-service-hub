...
@Service
public class MsgOpenAccessServiceImpl extends DEServiceBase<MsgOpenAccessDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.notify.service.IMsgOpenAccessService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == MsgOpenAccessServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    MsgOpenAccessDTO dto = (MsgOpenAccessDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    MsgOpenAccessDTO result = (MsgOpenAccessDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(MsgOpenAccessDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(MsgOpenAccessDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(MsgOpenAccessDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(MsgOpenAccessDTO dto) throws Throwable {
    ...
    protected MsgOpenAccessDTO onAfterGet(MsgOpenAccessDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(MsgOpenAccessDTO dto) throws Throwable {
        
     }

    protected MsgOpenAccessDTO onAfterGetDraft(MsgOpenAccessDTO result, MsgOpenAccessDTO dto) throws Throwable {
      return result;
    }
