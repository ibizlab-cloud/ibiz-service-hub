...
public class OpenUserServiceImpl extends DEServiceBase<OpenUserDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IOpenUserService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == OpenUserServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    OpenUserDTO dto = (OpenUserDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    OpenUserDTO result = (OpenUserDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CANCELBIND, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onCancelBind((OpenUserDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
    ...
    protected void onBeforeCreate(OpenUserDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(OpenUserDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(OpenUserDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(OpenUserDTO dto) throws Throwable {
    ...
    protected OpenUserDTO onAfterGet(OpenUserDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(OpenUserDTO dto) throws Throwable {
        
     }

    protected OpenUserDTO onAfterGetDraft(OpenUserDTO result, OpenUserDTO dto) throws Throwable {
      return result;
    }

    protected void onBind(OpenUserDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "绑定"), Errors.NOTIMPL);
    }

    protected void onCancelBind(OpenUserDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "取消绑定"), Errors.NOTIMPL);
    }

    protected void onSyncData(OpenUserDTO dto) throws Throwable {
