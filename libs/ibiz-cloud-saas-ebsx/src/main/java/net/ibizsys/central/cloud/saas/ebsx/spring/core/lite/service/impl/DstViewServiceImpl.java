...
@Service
public class DstViewServiceImpl extends DEServiceBase<DstViewDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.lite.service.IDstViewService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DstViewServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DstViewDTO dto = (DstViewDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DstViewDTO result = (DstViewDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DstViewDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DstViewDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DstViewDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DstViewDTO dto) throws Throwable {
    ...
    protected DstViewDTO onAfterGet(DstViewDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DstViewDTO dto) throws Throwable {
        
     }

    protected DstViewDTO onAfterGetDraft(DstViewDTO result, DstViewDTO dto) throws Throwable {
      return result;
    }
