...
@Service
public class PermissionServiceImpl extends DEServiceBase<PermissionDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IPermissionService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PermissionServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    PermissionDTO dto = (PermissionDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PermissionDTO result = (PermissionDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(PermissionDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PermissionDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PermissionDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PermissionDTO dto) throws Throwable {
    ...
    protected PermissionDTO onAfterGet(PermissionDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PermissionDTO dto) throws Throwable {
        
     }

    protected PermissionDTO onAfterGetDraft(PermissionDTO result, PermissionDTO dto) throws Throwable {
      return result;
    }
