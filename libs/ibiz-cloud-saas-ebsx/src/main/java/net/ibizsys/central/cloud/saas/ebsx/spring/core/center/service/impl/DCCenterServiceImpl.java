...
public class DCCenterServiceImpl extends DEServiceBase<DCCenterDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.center.service.IDCCenterService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCCenterServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCCenterDTO dto = (DCCenterDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCCenterDTO result = (DCCenterDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        ...
                        public Object execute(Object[] args) throws Throwable {
                            onInit((DCCenterDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
            });
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_INITDEFAULTOPENACCESS, new IDEActionPluginRuntime() {
                @Override
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onInitDefaultOpenAccess((DCCenterDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
    ...
    protected void onBeforeCreate(DCCenterDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCCenterDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCCenterDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCCenterDTO dto) throws Throwable {
    ...
    protected DCCenterDTO onAfterGet(DCCenterDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCCenterDTO dto) throws Throwable {
        
     }

    protected DCCenterDTO onAfterGetDraft(DCCenterDTO result, DCCenterDTO dto) throws Throwable {
      return result;
    }

    protected void onInit(DCCenterDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "初始化"), Errors.NOTIMPL);
    }

    protected void onInitDefaultOpenAccess(DCCenterDTO dto) throws Throwable {
        throw new DataEntityRuntimeException(this.getDataEntityRuntime(), String.format("行为[%s]未实现", "初始化默认开放平台访问"), Errors.NOTIMPL);
    }
