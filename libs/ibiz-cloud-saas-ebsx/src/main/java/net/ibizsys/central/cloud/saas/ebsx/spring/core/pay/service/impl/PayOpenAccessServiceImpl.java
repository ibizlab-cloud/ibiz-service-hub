package net.ibizsys.central.cloud.saas.ebsx.spring.core.pay.service.impl;
...
@Service
public class PayOpenAccessServiceImpl extends DEServiceBase<PayOpenAccessDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.pay.service.IPayOpenAccessService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == PayOpenAccessServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    PayOpenAccessDTO dto = (PayOpenAccessDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    PayOpenAccessDTO result = (PayOpenAccessDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(PayOpenAccessDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(PayOpenAccessDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(PayOpenAccessDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(PayOpenAccessDTO dto) throws Throwable {
    ...
    protected PayOpenAccessDTO onAfterGet(PayOpenAccessDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(PayOpenAccessDTO dto) throws Throwable {
        
     }

    protected PayOpenAccessDTO onAfterGetDraft(PayOpenAccessDTO result, PayOpenAccessDTO dto) throws Throwable {
      return result;
    }
