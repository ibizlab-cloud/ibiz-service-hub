...
@Service
public class OldAppServiceImpl extends DEServiceBase<OldAppDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IOldAppService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == OldAppServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    OldAppDTO dto = (OldAppDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    OldAppDTO result = (OldAppDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(OldAppDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(OldAppDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(OldAppDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(OldAppDTO dto) throws Throwable {
    ...
    protected OldAppDTO onAfterGet(OldAppDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(OldAppDTO dto) throws Throwable {
        
     }

    protected OldAppDTO onAfterGetDraft(OldAppDTO result, OldAppDTO dto) throws Throwable {
      return result;
    }
