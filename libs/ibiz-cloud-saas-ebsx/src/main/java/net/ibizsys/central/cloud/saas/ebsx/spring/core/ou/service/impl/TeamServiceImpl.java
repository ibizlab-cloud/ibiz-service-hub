...
@Service
public class TeamServiceImpl extends DEServiceBase<TeamDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.ITeamService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == TeamServiceImpl.class)
        ...
        try {
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    TeamDTO result = (TeamDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(TeamDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(TeamDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(TeamDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(TeamDTO dto) throws Throwable {
    ...
    protected TeamDTO onAfterGet(TeamDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(TeamDTO dto) throws Throwable {
        
     }

    protected TeamDTO onAfterGetDraft(TeamDTO result, TeamDTO dto) throws Throwable {
      return result;
    }
