...
public class OpenAccessServiceImpl extends DEServiceBase<OpenAccessDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IOpenAccessService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == OpenAccessServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    OpenAccessDTO dto = (OpenAccessDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    OpenAccessDTO result = (OpenAccessDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_SYNCDATA, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    return ActionSessionManager.getCurrentSession().execute(new IAction() {
                        @Override
                        public Object execute(Object[] args) throws Throwable {
                            onSyncData((OpenAccessDTO) args[0]);
                            return null;
                        }
                    }, args, ITransactionalUtil.PROPAGATION_REQUIRED);
                }
    ...
    protected void onBeforeCreate(OpenAccessDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(OpenAccessDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(OpenAccessDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(OpenAccessDTO dto) throws Throwable {
    ...
    protected OpenAccessDTO onAfterGet(OpenAccessDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(OpenAccessDTO dto) throws Throwable {
        
     }

    protected OpenAccessDTO onAfterGetDraft(OpenAccessDTO result, OpenAccessDTO dto) throws Throwable {
      return result;
    }

    protected OpenAccessDTO onGetIgnoreCenter(String key) throws Throwable {
