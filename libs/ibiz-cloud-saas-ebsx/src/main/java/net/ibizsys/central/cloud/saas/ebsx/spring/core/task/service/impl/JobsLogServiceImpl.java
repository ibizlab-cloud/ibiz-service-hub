...
@Service
public class JobsLogServiceImpl extends DEServiceBase<JobsLogDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.task.service.IJobsLogService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == JobsLogServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    JobsLogDTO dto = (JobsLogDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    JobsLogDTO result = (JobsLogDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(JobsLogDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(JobsLogDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(JobsLogDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(JobsLogDTO dto) throws Throwable {
    ...
    protected JobsLogDTO onAfterGet(JobsLogDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(JobsLogDTO dto) throws Throwable {
        
     }

    protected JobsLogDTO onAfterGetDraft(JobsLogDTO result, JobsLogDTO dto) throws Throwable {
      return result;
    }
