package net.ibizsys.central.cloud.saas.ebsx.spring.core.dict.service.impl;
...
@Service
public class DictCatalogServiceImpl extends DEServiceBase<DictCatalogDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.dict.service.IDictCatalogService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DictCatalogServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DictCatalogDTO dto = (DictCatalogDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DictCatalogDTO result = (DictCatalogDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DictCatalogDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DictCatalogDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DictCatalogDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DictCatalogDTO dto) throws Throwable {
    ...
    protected DictCatalogDTO onAfterGet(DictCatalogDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DictCatalogDTO dto) throws Throwable {
        
     }

    protected DictCatalogDTO onAfterGetDraft(DictCatalogDTO result, DictCatalogDTO dto) throws Throwable {
      return result;
    }
