package net.ibizsys.central.cloud.saas.ebsx.util;
...
public class StaticDict {
    ...
    public enum UserState {
        ...
        UserState(String value , String text) {
            this.value=value;
            this.text = text;
        }
     ...
     * 代码表[后台任务作业类型]
     */
    public enum SysBackendTaskType {
        ...
        SysBackendTaskType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum TodoSubType {
        ...
        TodoSubType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum PermissionType {
        ...
        PermissionType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum AuthCode {
        ...
        AuthCode(String value , String text) {
            this.value=value;
            this.text = text;
        }
     ...
     * 代码表[待办地址类型]
     */
    public enum TodoUrlType {
        FULLURL("FullUrl","完整地址"),
        ROUTERURL("RouterUrl","路由地址");
        ...
        TodoUrlType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum JobsStatus {
        ...
        JobsStatus(int value , String text) {
            this.value=value;
            this.text = text;
        }
     ...
     * 代码表[后台任务作业预置类型]
     */
    public enum SysBackendTaskPredefinedType {
        ...
        SysBackendTaskPredefinedType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum DEOPPriv {
        ...
        DEOPPriv(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum LogCat {
        ...
        LogCat(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum BackendActionState {
        ...
        BackendActionState(int value , String text) {
            this.value=value;
            this.text = text;
        }
     ...
     * 代码表[系统权限分类]
     */
    public enum PermissionCat {
        ALL("ALL","全部用户"),
        ORG("Org","指定单位"),
        USERROLE("UserRole","指定用户角色"),
        DCADMIN("DCADMIN","仅管理员");
        ...
        PermissionCat(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum IdentityType {
        WORKFLOW("workflow","工作流回调"),
        DEVOPS("devops","DevOps回调"),
        REPORT("report","Report回调");
        ...
        IdentityType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum TemplateType2 {
        ...
        TemplateType2(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum ComponentType {
        ...
        DYNAMICSUBFORM("DynamicSubForm","动态子表单"),
        DYNAMICGRID("DynamicGrid","动态表格");
        ...
        ComponentType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum TodoType {
        ...
        TodoType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum SourceType {
        ...
        SourceType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    ...
    public enum UserMode {
        NONE("NONE","无"),
        ACCESSUSER("ACCESSUSER","普通用户"),
        ACCESSADMIN("ACCESSADMIN","管理员");
        ...
        UserMode(String value , String text) {
            this.value=value;
            this.text = text;
        }
