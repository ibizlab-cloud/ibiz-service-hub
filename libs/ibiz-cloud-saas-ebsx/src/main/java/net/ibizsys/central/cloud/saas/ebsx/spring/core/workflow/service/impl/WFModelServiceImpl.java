...
@Service
public class WFModelServiceImpl extends DEServiceBase<WFModelDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFModelService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFModelServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFModelDTO dto = (WFModelDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFModelDTO result = (WFModelDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFModelDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFModelDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFModelDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFModelDTO dto) throws Throwable {
    ...
    protected WFModelDTO onAfterGet(WFModelDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFModelDTO dto) throws Throwable {
        
     }

    protected WFModelDTO onAfterGetDraft(WFModelDTO result, WFModelDTO dto) throws Throwable {
      return result;
    }
