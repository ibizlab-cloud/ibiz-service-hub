...
@Service
public class DCOrganizationServiceImpl extends DEServiceBase<DCOrganizationDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IDCOrganizationService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == DCOrganizationServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    DCOrganizationDTO dto = (DCOrganizationDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    DCOrganizationDTO result = (DCOrganizationDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(DCOrganizationDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(DCOrganizationDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(DCOrganizationDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(DCOrganizationDTO dto) throws Throwable {
    ...
    protected DCOrganizationDTO onAfterGet(DCOrganizationDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(DCOrganizationDTO dto) throws Throwable {
        
     }

    protected DCOrganizationDTO onAfterGetDraft(DCOrganizationDTO result, DCOrganizationDTO dto) throws Throwable {
      return result;
    }
