...
@Service
public class RolePermissionServiceImpl extends DEServiceBase<RolePermissionDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.uaa.service.IRolePermissionService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == RolePermissionServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    RolePermissionDTO dto = (RolePermissionDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    RolePermissionDTO result = (RolePermissionDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(RolePermissionDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(RolePermissionDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(RolePermissionDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(RolePermissionDTO dto) throws Throwable {
    ...
    protected RolePermissionDTO onAfterGet(RolePermissionDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(RolePermissionDTO dto) throws Throwable {
        
     }

    protected RolePermissionDTO onAfterGetDraft(RolePermissionDTO result, RolePermissionDTO dto) throws Throwable {
      return result;
    }
