...
@Service
public class WFUndoTaskServiceImpl extends DEServiceBase<WFUndoTaskDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.workflow.service.IWFUndoTaskService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == WFUndoTaskServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    WFUndoTaskDTO dto = (WFUndoTaskDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    WFUndoTaskDTO result = (WFUndoTaskDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(WFUndoTaskDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(WFUndoTaskDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(WFUndoTaskDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(WFUndoTaskDTO dto) throws Throwable {
    ...
    protected WFUndoTaskDTO onAfterGet(WFUndoTaskDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(WFUndoTaskDTO dto) throws Throwable {
        
     }

    protected WFUndoTaskDTO onAfterGetDraft(WFUndoTaskDTO result, WFUndoTaskDTO dto) throws Throwable {
      return result;
    }
