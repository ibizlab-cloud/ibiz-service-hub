...
@Service
public class EmpBindServiceImpl extends DEServiceBase<EmpBindDTO, SearchContextDTO> implements net.ibizsys.central.cloud.saas.ebsx.spring.core.ou.service.IEmpBindService {
    ...
    private void postConstruct() throws Exception {
        if (systemGateway != null && !systemGateway.isMultiInstanceMode(EBSXSystemRuntime.class)) {
            try {
                ...
                if(iDEService == null || iDEService.getClass() == EmpBindServiceImpl.class)
        ...
        try {
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_CREATE, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    EmpBindDTO dto = (EmpBindDTO) args[0];
                    onBeforeCreate(dto);
            ...
            this.getDataEntityRuntime().registerDEActionPluginRuntime(ACTION_GET, new IDEActionPluginRuntime() {
                ...
                public Object execute(IDataEntityRuntimeContext iDataEntityRuntimeContext, IPSDEAction iPSDEAction, Object[] args, Object actionData) throws Throwable {
                    String dto = (String) args[0];
                    onBeforeGet(dto);
                    EmpBindDTO result = (EmpBindDTO) iDataEntityRuntimeContext.executeActionReal(iPSDEAction, args, actionData);
    ...
    protected void onBeforeCreate(EmpBindDTO dto) throws Throwable {
        
     }

    protected void onAfterCreate(EmpBindDTO dto) throws Throwable {
      
    }

    protected void onBeforeUpdate(EmpBindDTO dto) throws Throwable {
        
     }

    protected void onAfterUpdate(EmpBindDTO dto) throws Throwable {
    ...
    protected EmpBindDTO onAfterGet(EmpBindDTO result, String key) throws Throwable {
      return result;
    }

    protected void onBeforeGetDraft(EmpBindDTO dto) throws Throwable {
        
     }

    protected EmpBindDTO onAfterGetDraft(EmpBindDTO result, EmpBindDTO dto) throws Throwable {
      return result;
    }
