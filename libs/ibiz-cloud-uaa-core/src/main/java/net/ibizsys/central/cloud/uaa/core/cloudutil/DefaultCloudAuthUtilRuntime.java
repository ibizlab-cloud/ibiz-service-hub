...
//import net.ibizsys.central.cloud.core.CoreSystemRuntime;
//import net.ibizsys.central.cloud.core.spring.core.ou.dto.SysEmployeeDTO;
//import net.ibizsys.central.cloud.core.spring.core.uaa.dto.SysUserDTO;
//import net.ibizsys.central.cloud.core.spring.core.uaa.service.ISysUserService;
import net.ibizsys.central.cloud.core.security.AuthenticationUser;
import net.ibizsys.central.cloud.core.util.domain.User;

public class DefaultCloudAuthUtilRuntime extends CloudAuthUtilRuntimeBase {

	private static final org.apache.commons.logging.Log log = LogFactory.getLog(DefaultCloudAuthUtilRuntime.class);

	

	@Override
	protected AuthenticationUser onGetUserByName(String srfsystem, String srforgid, String username) throws Throwable {
...
//	@Override
//	protected AuthenticationUser onGetUserByLogin(String srfsystem, String srforgid, String username, String password) throws Throwable {
//
//		if (!StringUtils.hasLength(username))
//			throw new UsernameNotFoundException("用户名为空");
//
...
//
//		// 校验密码是否正确
//		boolean bMatchPwd = user.getPassword().equals(password);
//		// 启用账户锁，记录登陆失败次数
...
//	protected AuthenticationUser getAuthenticationUser(SysEmployeeDTO sysEmployeeDTO) {
//		AuthenticationUser authenticationUser = new AuthenticationUser();
//		EntityUtils.copyTo(sysEmployeeDTO, authenticationUser);
//		
//		return authenticationUser;
//	}
}
