...
public class PSAppMenu extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     */
    @JsonIgnore
    public PSAppMenu fromobjid(String fromObjId){
     ...
     */
    @JsonIgnore
    public PSAppMenu ownerid(String ownerId){
     ...
     */
    @JsonIgnore
    public PSAppMenu ownertag(String ownerTag){
     ...
     */
    @JsonIgnore
    public PSAppMenu ownertype(String ownerType){
