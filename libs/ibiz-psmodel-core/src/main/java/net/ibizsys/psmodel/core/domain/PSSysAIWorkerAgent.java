...
public class PSSysAIWorkerAgent extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     */
    @JsonIgnore
    public PSSysAIWorkerAgent aiplatformtype(String aIPlatformType){
     ...
     */
    @JsonIgnore
    public PSSysAIWorkerAgent customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSSysAIWorkerAgent custommode(Integer customMode){
     ...
     */
    @JsonIgnore
    public PSSysAIWorkerAgent custommode(Boolean customMode){
        if(customMode == null){
