 ...
 */
public class PSDEDataQuery extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSDEDataQuery(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSDEDataQuery codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery custommode(Integer customMode){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery custommode(Boolean customMode){
        if(customMode == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery defaultmode(Integer defaultMode){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery defaultmode(Boolean defaultMode){
        if(defaultMode == null){
     ...
     * <B>DQOPTION</B>&nbsp;数据查询选项
     */
    public final static String FIELD_DQOPTION = "dqoption";
     ...
     * 
     */
    @JsonProperty(FIELD_DQOPTION)
    public void setDQOption(Integer dQOption){
        this.set(FIELD_DQOPTION, dQOption);
    }
    ...
    public Integer getDQOption(){
        Object objValue = this.get(FIELD_DQOPTION);
        if(objValue==null){
            return null;
        }
        return (Integer)objValue;
    ...
    /**
     * 判断 数据查询选项 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isDQOptionDirty(){
        if(this.contains(FIELD_DQOPTION)){
            return true;
        }
        return false;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataQuery dqoption(Integer dQOption){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery dqsn(String dQSN){
        this.setDQSN(dQSN);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataQuery dqtag(String dQTag){
        this.setDQTag(dQTag);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataQuery dqtag2(String dQTag2){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery dqtag3(String dQTag3){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery dqtag4(String dQTag4){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery enablepql(Integer enablePQL){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery enablepql(Boolean enablePQL){
        if(enablePQL == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery extendmode(Integer extendMode){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery extendmode(net.ibizsys.psmodel.core.util.PSModelEnums.DEExtendMode extendMode){
        if(extendMode == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery filtermodel(String filterModel){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery logicname(String logicName){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataQuery ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery privmode(Integer privMode){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery privmode(Boolean privMode){
        if(privMode == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdedataqueryid(String pSDEDataQueryId){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdedataqueryname(String pSDEDataQueryName){
    ...
    @JsonIgnore
    public PSDEDataQuery name(String strName){
        this.setPSDEDataQueryName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdefgroupid(String pSDEFGroupId){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdefgroupid(PSDEFGroup pSDEFGroup){
        if(pSDEFGroup == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdefgroupname(String pSDEFGroupName){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery pubmode(Integer pubMode){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery pubmode(Boolean pubMode){
        if(pubMode == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery queryviewflag(Integer queryViewFlag){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery queryviewflag(Boolean queryViewFlag){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery requestmethod(String requestMethod){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery requestmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod requestMethod){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery requestpath(String requestPath){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery servicecodename(String serviceCodeName){
        this.setServiceCodeName(serviceCodeName);
        return this;
    }

    /**
     * <B>SUBSYSSADETAILMODE</B>&nbsp;外部服务接口模式
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.YesNo} 
     */
     ...
     */
    @JsonIgnore
    public PSDEDataQuery subsyssadetailmode(Integer subSysSADetailMode){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery subsyssadetailmode(Boolean subSysSADetailMode){
        if(subSysSADetailMode == null){
            this.setSubSysSADetailMode(null);
        }
        else{
            this.setSubSysSADetailMode(subSysSADetailMode?BOOLEAN_TRUE:BOOLEAN_FALSE);
        }
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEDataQuery updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery validflag(Boolean validFlag){
        if(validFlag == null){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery viewcollevel(Integer viewColLevel){
     ...
     */
    @JsonIgnore
    public PSDEDataQuery viewcollevel(net.ibizsys.psmodel.core.util.PSModelEnums.DEDataQueryViewLevel viewColLevel){
    ...
    @JsonIgnore
    public PSDEDataQuery id(String strValue){
        this.setPSDEDataQueryId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDEDataQuery){
            PSDEDataQuery model = (PSDEDataQuery)iPSModel;
