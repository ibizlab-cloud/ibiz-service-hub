 ...
 */
public class PSSysDBColumn extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSSysDBColumn(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysDBColumn allowempty(Integer allowEmpty){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn allowempty(Boolean allowEmpty){
        if(allowEmpty == null){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn codename2(String codeName2){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn coldesc(String colDesc){
     ...
     * 字符串：最大长度 100
     */
    public final static String FIELD_COLUMNTAG = "columntag";
     ...
     * 
     */
    @JsonProperty(FIELD_COLUMNTAG)
    public void setColumnTag(String columnTag){
        this.set(FIELD_COLUMNTAG, columnTag);
    }
    ...
    public String getColumnTag(){
        Object objValue = this.get(FIELD_COLUMNTAG);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isColumnTagDirty(){
        if(this.contains(FIELD_COLUMNTAG)){
            return true;
        }
        return false;
    }
    ...
    public void resetColumnTag(){
        this.reset(FIELD_COLUMNTAG);
    }

    /**
     * 设置 列标记
     * <P>
     * 等同 {@link #setColumnTag}
     * @param columnTag
     */
    @JsonIgnore
    public PSSysDBColumn columntag(String columnTag){
     ...
     * 字符串：最大长度 100
     */
    public final static String FIELD_COLUMNTAG2 = "columntag2";
     ...
     * 
     */
    @JsonProperty(FIELD_COLUMNTAG2)
    public void setColumnTag2(String columnTag2){
        this.set(FIELD_COLUMNTAG2, columnTag2);
    }
    ...
    public String getColumnTag2(){
        Object objValue = this.get(FIELD_COLUMNTAG2);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isColumnTag2Dirty(){
        if(this.contains(FIELD_COLUMNTAG2)){
            return true;
        }
        return false;
    }
    ...
    public void resetColumnTag2(){
        this.reset(FIELD_COLUMNTAG2);
    }

    /**
     * 设置 列标记2
     * <P>
     * 等同 {@link #setColumnTag2}
     * @param columnTag2
     */
    @JsonIgnore
    public PSSysDBColumn columntag2(String columnTag2){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn createsql(String createSql){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn datatype(String dataType){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn datatypes(String dataTypes){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn defaultvalue(String defaultValue){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn dropsql(String dropSql){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn fkey(Integer fKey){
        this.setFKey(fKey);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDBColumn fkey(Boolean fKey){
        if(fKey == null){
            this.setFKey(null);
        }
        else{
     ...
     */
    @JsonIgnore
    public PSSysDBColumn identitymode(Integer identityMode){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn identitymode(Boolean identityMode){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn length(Integer length){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn logicname(String logicName){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDBColumn ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pkey(Integer pKey){
        this.setPKey(pKey);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pkey(Boolean pKey){
        if(pKey == null){
            this.setPKey(null);
        }
        else{
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pssysdbcolumnid(String pSSysDBColumnId){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pssysdbcolumnname(String pSSysDBColumnName){
    ...
    @JsonIgnore
    public PSSysDBColumn name(String strName){
        this.setPSSysDBColumnName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pssysdbschemeid(String pSSysDBSchemeId){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pssysdbtableid(String pSSysDBTableId){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pssysdbtableid(PSSysDBTable pSSysDBTable){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn pssysdbtablename(String pSSysDBTableName){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn refpssysdbcolumnid(String refPSSysDBColumnId){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn refpssysdbcolumnid(PSSysDBColumn pSSysDBColumn){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn refpssysdbcolumnname(String refPSSysDBColumnName){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn refpssysdbtableid(String refPSSysDBTableId){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn refpssysdbtableid(PSSysDBTable pSSysDBTable){
        if(pSSysDBTable == null){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn refpssysdbtablename(String refPSSysDBTableName){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn stddatatype(Integer stdDataType){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn stddatatype(net.ibizsys.psmodel.core.util.PSModelEnums.StdDataType stdDataType){
        if(stdDataType == null){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn unsignedmode(Integer unsignedMode){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn unsignedmode(Boolean unsignedMode){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysDBColumn usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSSysDBColumn id(String strValue){
        this.setPSSysDBColumnId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysDBColumn){
            PSSysDBColumn model = (PSSysDBColumn)iPSModel;
        }
