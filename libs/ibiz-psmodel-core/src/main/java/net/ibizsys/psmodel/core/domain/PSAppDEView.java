 ...
 */
public class PSAppDEView extends PSAppView {
     ...
     */
    @JsonIgnore
    public PSAppDEView createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSAppDEView createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSAppDEView psappdeviewid(String pSAppDEViewId){
     ...
     */
    @JsonIgnore
    public PSAppDEView psappdeviewname(String pSAppDEViewName){
    ...
    @JsonIgnore
    public PSAppDEView name(String strName){
        this.setPSAppDEViewName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSAppDEView updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSAppDEView updateman(String updateMan){
    ...
    @JsonIgnore
    public PSAppDEView id(String strValue){
        this.setPSAppDEViewId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSAppDEView){
            PSAppDEView model = (PSAppDEView)iPSModel;
        }
