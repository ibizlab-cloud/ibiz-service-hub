 ...
 */
public class PSACHandlerAction extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSACHandlerAction(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSACHandlerAction actiondesc(String actionDesc){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction actiontimeout(Integer actionTimeout){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.CtrlHandlerActionType} 
     */
     ...
     */
    @JsonIgnore
    public PSACHandlerAction actiontype(String actionType){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction actiontype(net.ibizsys.psmodel.core.util.PSModelEnums.CtrlHandlerActionType actionType){
        if(actionType == null){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction dataaccaction(String dataAccAction){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psachandleractionid(String pSACHandlerActionId){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psachandleractionname(String pSACHandlerActionName){
    ...
    @JsonIgnore
    public PSACHandlerAction name(String strName){
        this.setPSACHandlerActionName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psachandlerid(String pSACHandlerId){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psachandlerid(PSACHandler pSACHandler){
        if(pSACHandler == null){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psachandlername(String pSACHandlerName){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psdeactionid(String pSDEActionId){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psdeactionid(PSDEAction pSDEAction){
        if(pSDEAction == null){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psdeactionname(String pSDEActionName){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psdeopprivid(String pSDEOPPrivId){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psdeopprivid(PSDEOPPriv pSDEOPPriv){
        if(pSDEOPPriv == null){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction psdeopprivname(String pSDEOPPrivName){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSACHandlerAction validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSACHandlerAction id(String strValue){
        this.setPSACHandlerActionId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSACHandlerAction){
            PSACHandlerAction model = (PSACHandlerAction)iPSModel;
        }
