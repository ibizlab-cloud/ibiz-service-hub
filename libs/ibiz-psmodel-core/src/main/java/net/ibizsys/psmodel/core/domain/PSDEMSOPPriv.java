 ...
 */
public class PSDEMSOPPriv extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdemainstateid(String pSDEMainStateId){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdemainstateid(PSDEMainState pSDEMainState){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdemainstatename(String pSDEMainStateName){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdemsopprivid(String pSDEMSOPPrivId){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdemsopprivname(String pSDEMSOPPrivName){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdeopprivid(String pSDEOPPrivId){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdeopprivid(PSDEOPPriv pSDEOPPriv){
        if(pSDEOPPriv == null){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv psdeopprivname(String pSDEOPPrivName){
    ...
    @JsonIgnore
    public PSDEMSOPPriv name(String strName){
        this.setPSDEOPPrivName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEMSOPPriv validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSDEMSOPPriv id(String strValue){
        this.setPSDEMSOPPrivId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDEMSOPPriv){
            PSDEMSOPPriv model = (PSDEMSOPPriv)iPSModel;
        }
