...
public class PSSysAIPipelineAgent extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.AIPipelineAgentType} 
     */
     ...
     */
    @JsonIgnore
    public PSSysAIPipelineAgent aipipelineagenttype(net.ibizsys.psmodel.core.util.PSModelEnums.AIPipelineAgentType aIPipelineAgentType){
        if(aIPipelineAgentType == null){
            this.setAIPipelineAgentType(null);
        }
        else{
            this.setAIPipelineAgentType(aIPipelineAgentType.value);
        }
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysAIPipelineAgent aiplatformtype(String aIPlatformType){
     ...
     */
    @JsonIgnore
    public PSSysAIPipelineAgent customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSSysAIPipelineAgent custommode(Integer customMode){
     ...
     */
    @JsonIgnore
    public PSSysAIPipelineAgent custommode(Boolean customMode){
        if(customMode == null){
