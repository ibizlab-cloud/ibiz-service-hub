 ...
 */
public class PSDELogicNode extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSDELogicNode(){
    }      
     ...
     */
    @JsonIgnore
    public PSDELogicNode codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDELogicNode createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDELogicNode customdstparam(String customDSTParam){
     ...
     */
    @JsonIgnore
    public PSDELogicNode customsrcparam(String customSrcParam){
     ...
     */
    @JsonIgnore
    public PSDELogicNode debugmode(Integer debugMode){
     ...
     */
    @JsonIgnore
    public PSDELogicNode debugmode(net.ibizsys.psmodel.core.util.PSModelEnums.DELogicDebugMode debugMode){
        if(debugMode == null){
    ...
    /**
     * <B>DSTPSDEUTILDEID</B>&nbsp;目标实体功能
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDEUtil} 
     */
    public final static String FIELD_DSTPSDEUTILDEID = "dstpsdeutildeid";

    /**
     * 设置 目标实体功能
     * 
     * @param dstPSDEUtilDEId
     * 
     */
    @JsonProperty(FIELD_DSTPSDEUTILDEID)
    public void setDstPSDEUtilDEId(String dstPSDEUtilDEId){
        this.set(FIELD_DSTPSDEUTILDEID, dstPSDEUtilDEId);
        //属性名称与代码标识不一致，设置属性名称
        this.set("dstdeutildeid", dstPSDEUtilDEId);
    }
    ...
    public String getDstPSDEUtilDEId(){
        Object objValue = this.get(FIELD_DSTPSDEUTILDEID);
        if(objValue==null){
            //属性名称与代码标识不一致，使用属性名称
            objValue = this.get("dstdeutildeid");
            if(objValue == null){
                return null;
            }
        }
    ...
    /**
     * 判断 目标实体功能 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isDstPSDEUtilDEIdDirty(){
        if(this.contains(FIELD_DSTPSDEUTILDEID)){
            return true;
        }
        //属性名称与代码标识不一致，判断属性名称
        if(this.contains("dstdeutildeid")){
            return true;
        }
        return false;
    }
    ...
    public void resetDstPSDEUtilDEId(){
        this.reset(FIELD_DSTPSDEUTILDEID);
        //属性名称与代码标识不一致，重置属性名称
        this.reset("dstdeutildeid");
    }

    /**
     * 设置 目标实体功能
     * <P>
     * 等同 {@link #setDstPSDEUtilDEId}
     * @param dstPSDEUtilDEId
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeutildeid(String dstPSDEUtilDEId){
        this.setDstPSDEUtilDEId(dstPSDEUtilDEId);
        return this;
    }

    /**
     * 设置 目标实体功能，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setDstPSDEUtilDEId}
     * @param pSDEUtil 引用对象
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeutildeid(PSDEUtil pSDEUtil){
        if(pSDEUtil == null){
    ...
    /**
     * <B>DSTPSDEUTILDENAME</B>&nbsp;目标实体功能
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_DSTPSDEUTILDEID}
     */
    public final static String FIELD_DSTPSDEUTILDENAME = "dstpsdeutildename";

    /**
     * 设置 目标实体功能
     * 
     * @param dstPSDEUtilDEName
     * 
     */
    @JsonProperty(FIELD_DSTPSDEUTILDENAME)
    public void setDstPSDEUtilDEName(String dstPSDEUtilDEName){
        this.set(FIELD_DSTPSDEUTILDENAME, dstPSDEUtilDEName);
        //属性名称与代码标识不一致，设置属性名称
        this.set("dstdeutildename", dstPSDEUtilDEName);
    }
    ...
    public String getDstPSDEUtilDEName(){
        Object objValue = this.get(FIELD_DSTPSDEUTILDENAME);
        if(objValue==null){
            //属性名称与代码标识不一致，使用属性名称
            objValue = this.get("dstdeutildename");
            if(objValue == null){
                return null;
            }
        }
    ...
    public boolean isDstPSDEUtilDENameDirty(){
        if(this.contains(FIELD_DSTPSDEUTILDENAME)){
            return true;
        }
        //属性名称与代码标识不一致，判断属性名称
        if(this.contains("dstdeutildename")){
            return true;
        }
        return false;
    }
    ...
    public void resetDstPSDEUtilDEName(){
        this.reset(FIELD_DSTPSDEUTILDENAME);
        //属性名称与代码标识不一致，重置属性名称
        this.reset("dstdeutildename");
    }

    /**
     * 设置 目标实体功能
     * <P>
     * 等同 {@link #setDstPSDEUtilDEName}
     * @param dstPSDEUtilDEName
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeutildename(String dstPSDEUtilDEName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstindex(Integer dstIndex){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.DELogicParamAction2} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstparamaction(String dstParamAction){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstparamaction(net.ibizsys.psmodel.core.util.PSModelEnums.DELogicParamAction2 dstParamAction){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeactionid(String dstPSDEActionId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeactionid(PSDEAction pSDEAction){
        if(pSDEAction == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeactionname(String dstPSDEActionName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataexpid(String dstPSDEDataExpId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataexpid(PSDEDataExp pSDEDataExp){
        if(pSDEDataExp == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataexpname(String dstPSDEDataExpName){
        this.setDstPSDEDataExpName(dstPSDEDataExpName);
        return this;
    }

    /**
     * <B>DSTPSDEDATAFLOWID</B>&nbsp;目标数据流逻辑
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDELogic} 
     */
    public final static String FIELD_DSTPSDEDATAFLOWID = "dstpsdedataflowid";

    /**
     * 设置 目标数据流逻辑
     * 
     * @param dstPSDEDataFlowId
     * 
     */
    @JsonProperty(FIELD_DSTPSDEDATAFLOWID)
    public void setDstPSDEDataFlowId(String dstPSDEDataFlowId){
        this.set(FIELD_DSTPSDEDATAFLOWID, dstPSDEDataFlowId);
    }
    ...
    public String getDstPSDEDataFlowId(){
        Object objValue = this.get(FIELD_DSTPSDEDATAFLOWID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 目标数据流逻辑 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isDstPSDEDataFlowIdDirty(){
        if(this.contains(FIELD_DSTPSDEDATAFLOWID)){
            return true;
        }
        return false;
    }
    ...
    public void resetDstPSDEDataFlowId(){
        this.reset(FIELD_DSTPSDEDATAFLOWID);
    }

    /**
     * 设置 目标数据流逻辑
     * <P>
     * 等同 {@link #setDstPSDEDataFlowId}
     * @param dstPSDEDataFlowId
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataflowid(String dstPSDEDataFlowId){
        this.setDstPSDEDataFlowId(dstPSDEDataFlowId);
        return this;
    }

    /**
     * 设置 目标数据流逻辑，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setDstPSDEDataFlowId}
     * @param pSDELogic 引用对象
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataflowid(PSDELogic pSDELogic){
        if(pSDELogic == null){
    ...
    /**
     * <B>DSTPSDEDATAFLOWNAME</B>&nbsp;目标数据流逻辑
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_DSTPSDEDATAFLOWID}
     */
    public final static String FIELD_DSTPSDEDATAFLOWNAME = "dstpsdedataflowname";

    /**
     * 设置 目标数据流逻辑
     * 
     * @param dstPSDEDataFlowName
     * 
     */
    @JsonProperty(FIELD_DSTPSDEDATAFLOWNAME)
    public void setDstPSDEDataFlowName(String dstPSDEDataFlowName){
        this.set(FIELD_DSTPSDEDATAFLOWNAME, dstPSDEDataFlowName);
    }
    ...
    public String getDstPSDEDataFlowName(){
        Object objValue = this.get(FIELD_DSTPSDEDATAFLOWNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isDstPSDEDataFlowNameDirty(){
        if(this.contains(FIELD_DSTPSDEDATAFLOWNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetDstPSDEDataFlowName(){
        this.reset(FIELD_DSTPSDEDATAFLOWNAME);
    }

    /**
     * 设置 目标数据流逻辑
     * <P>
     * 等同 {@link #setDstPSDEDataFlowName}
     * @param dstPSDEDataFlowName
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataflowname(String dstPSDEDataFlowName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataimpid(String dstPSDEDataImpId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataimpid(PSDEDataImp pSDEDataImp){
        if(pSDEDataImp == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataimpname(String dstPSDEDataImpName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataqueryid(String dstPSDEDataQueryId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataqueryid(PSDEDataQuery pSDEDataQuery){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedataqueryname(String dstPSDEDataQueryName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedatasetid(String dstPSDEDataSetId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedatasetid(PSDEDataSet pSDEDataSet){
        if(pSDEDataSet == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedatasetname(String dstPSDEDataSetName){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDEDataSync} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedatasyncid(String dstPSDEDataSyncId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedatasyncid(PSDEDataSync pSDEDataSync){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedatasyncname(String dstPSDEDataSyncName){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDEDTSQueue} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedtsqueueid(String dstPSDEDTSQueueId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedtsqueueid(PSDEDTSQueue pSDEDTSQueue){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdedtsqueuename(String dstPSDEDTSQueueName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdefgroupid(String dstPSDEFGroupId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdefgroupid(PSDEFGroup pSDEFGroup){
        if(pSDEFGroup == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdefgroupname(String dstPSDEFGroupName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeformid(String dstPSDEFormId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeformid(PSDEForm pSDEForm){
        if(pSDEForm == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeformname(String dstPSDEFormName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdefvalueruleid(String dstPSDEFValueRuleId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdefvalueruleid(PSDEFValueRule pSDEFValueRule){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdefvaluerulename(String dstPSDEFValueRuleName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeid(String dstPSDEId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdelogicid(String dstPSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdelogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdelogicname(String dstPSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdemapid(String dstPSDEMapId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdemapid(PSDEMap pSDEMap){
        if(pSDEMap == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdemapname(String dstPSDEMapName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdename(String dstPSDEName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdenotifyid(String dstPSDENotifyId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdenotifyid(PSDENotify pSDENotify){
        if(pSDENotify == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdenotifyname(String dstPSDENotifyName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeprintid(String dstPSDEPrintId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeprintid(PSDEPrint pSDEPrint){
        if(pSDEPrint == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeprintname(String dstPSDEPrintName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdereportid(String dstPSDEReportId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdereportid(PSDEReport pSDEReport){
        if(pSDEReport == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdereportname(String dstPSDEReportName){
        this.setDstPSDEReportName(dstPSDEReportName);
        return this;
    }

    /**
     * <B>DSTPSDESAMPLEDATAID</B>&nbsp;目标实体示例数
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDESampleData} 
     */
    public final static String FIELD_DSTPSDESAMPLEDATAID = "dstpsdesampledataid";

    /**
     * 设置 目标实体示例数
     * 
     * @param dstPSDESampleDataId
     * 
     */
    @JsonProperty(FIELD_DSTPSDESAMPLEDATAID)
    public void setDstPSDESampleDataId(String dstPSDESampleDataId){
        this.set(FIELD_DSTPSDESAMPLEDATAID, dstPSDESampleDataId);
    }
    ...
    public String getDstPSDESampleDataId(){
        Object objValue = this.get(FIELD_DSTPSDESAMPLEDATAID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 目标实体示例数 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isDstPSDESampleDataIdDirty(){
        if(this.contains(FIELD_DSTPSDESAMPLEDATAID)){
            return true;
        }
        return false;
    }
    ...
    public void resetDstPSDESampleDataId(){
        this.reset(FIELD_DSTPSDESAMPLEDATAID);
    }

    /**
     * 设置 目标实体示例数
     * <P>
     * 等同 {@link #setDstPSDESampleDataId}
     * @param dstPSDESampleDataId
     */
    @JsonIgnore
    public PSDELogicNode dstpsdesampledataid(String dstPSDESampleDataId){
        this.setDstPSDESampleDataId(dstPSDESampleDataId);
        return this;
    }

    /**
     * 设置 目标实体示例数，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setDstPSDESampleDataId}
     * @param pSDESampleData 引用对象
     */
    @JsonIgnore
    public PSDELogicNode dstpsdesampledataid(PSDESampleData pSDESampleData){
    ...
    /**
     * <B>DSTPSDESAMPLEDATANAME</B>&nbsp;目标实体示例数
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_DSTPSDESAMPLEDATAID}
     */
    public final static String FIELD_DSTPSDESAMPLEDATANAME = "dstpsdesampledataname";

    /**
     * 设置 目标实体示例数
     * 
     * @param dstPSDESampleDataName
     * 
     */
    @JsonProperty(FIELD_DSTPSDESAMPLEDATANAME)
    public void setDstPSDESampleDataName(String dstPSDESampleDataName){
        this.set(FIELD_DSTPSDESAMPLEDATANAME, dstPSDESampleDataName);
    }
    ...
    public String getDstPSDESampleDataName(){
        Object objValue = this.get(FIELD_DSTPSDESAMPLEDATANAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isDstPSDESampleDataNameDirty(){
        if(this.contains(FIELD_DSTPSDESAMPLEDATANAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetDstPSDESampleDataName(){
        this.reset(FIELD_DSTPSDESAMPLEDATANAME);
    }

    /**
     * 设置 目标实体示例数
     * <P>
     * 等同 {@link #setDstPSDESampleDataName}
     * @param dstPSDESampleDataName
     */
    @JsonIgnore
    public PSDELogicNode dstpsdesampledataname(String dstPSDESampleDataName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeuagroupid(String dstPSDEUAGroupId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeuagroupid(PSDEUAGroup pSDEUAGroup){
        if(pSDEUAGroup == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeuagroupname(String dstPSDEUAGroupName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeuilogicid(String dstPSDEUILogicId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeuilogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeuilogicname(String dstPSDEUILogicName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeviewid(String dstPSDEViewId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeviewid(PSDEViewBase pSDEViewBase){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdeviewname(String dstPSDEViewName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdevrgroupid(String dstPSDEVRGroupId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdevrgroupid(PSDEVRGroup pSDEVRGroup){
        if(pSDEVRGroup == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdevrgroupname(String dstPSDEVRGroupName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdewizardid(String dstPSDEWizardId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdewizardid(PSDEWizard pSDEWizard){
        if(pSDEWizard == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdewizardname(String dstPSDEWizardName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdlparamid(String dstPSDLParamId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdlparamid(PSDELogicParam pSDELogicParam){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstpsdlparamname(String dstPSDLParamName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstsortdir(String dstSortDir){
     ...
     */
    @JsonIgnore
    public PSDELogicNode dstsortdir(net.ibizsys.psmodel.core.util.PSModelEnums.SortDir dstSortDir){
        if(dstSortDir == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ispsdlparamid(String iSPSDLParamId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ispsdlparamid(PSDELogicParam pSDELogicParam){
        if(pSDELogicParam == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ispsdlparamname(String iSPSDLParamName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode leftpos(Integer leftPos){
     ...
     */
    @JsonIgnore
    public PSDELogicNode logicnodesubtype(String logicNodeSubType){
     ...
     */
    @JsonIgnore
    public PSDELogicNode logicnodetype(String logicNodeType){
     ...
     */
    @JsonIgnore
    public PSDELogicNode logicnodetype(net.ibizsys.psmodel.core.util.PSModelEnums.LogicNodeType logicNodeType){
     ...
     */
    @JsonIgnore
    public PSDELogicNode memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDELogicNode msgpslanresid(String msgPSLanResId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode msgpslanresid(PSLanguageRes pSLanguageRes){
     ...
     */
    @JsonIgnore
    public PSDELogicNode msgpslanresname(String msgPSLanResName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode nodeparams(String nodeParams){
        this.setNodeParams(nodeParams);
        return this;
    }

    /**
     * <B>OPTPSDLPARAMID</B>&nbsp;可选参数
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDELogicParam} 
     */
    public final static String FIELD_OPTPSDLPARAMID = "optpsdlparamid";

    /**
     * 设置 可选参数
     * 
     * @param optPSDLParamId
     * 
     */
    @JsonProperty(FIELD_OPTPSDLPARAMID)
    public void setOptPSDLParamId(String optPSDLParamId){
        this.set(FIELD_OPTPSDLPARAMID, optPSDLParamId);
    }
    ...
    public String getOptPSDLParamId(){
        Object objValue = this.get(FIELD_OPTPSDLPARAMID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isOptPSDLParamIdDirty(){
        if(this.contains(FIELD_OPTPSDLPARAMID)){
            return true;
        }
        return false;
    }
    ...
    public void resetOptPSDLParamId(){
        this.reset(FIELD_OPTPSDLPARAMID);
    }

    /**
     * 设置 可选参数
     * <P>
     * 等同 {@link #setOptPSDLParamId}
     * @param optPSDLParamId
     */
    @JsonIgnore
    public PSDELogicNode optpsdlparamid(String optPSDLParamId){
        this.setOptPSDLParamId(optPSDLParamId);
        return this;
    }

    /**
     * 设置 可选参数，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setOptPSDLParamId}
     * @param pSDELogicParam 引用对象
     */
    @JsonIgnore
    public PSDELogicNode optpsdlparamid(PSDELogicParam pSDELogicParam){
        if(pSDELogicParam == null){
    ...
    /**
     * <B>OPTPSDLPARAMNAME</B>&nbsp;可选参数
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_OPTPSDLPARAMID}
     */
    public final static String FIELD_OPTPSDLPARAMNAME = "optpsdlparamname";

    /**
     * 设置 可选参数
     * 
     * @param optPSDLParamName
     * 
     */
    @JsonProperty(FIELD_OPTPSDLPARAMNAME)
    public void setOptPSDLParamName(String optPSDLParamName){
        this.set(FIELD_OPTPSDLPARAMNAME, optPSDLParamName);
    }
    ...
    public String getOptPSDLParamName(){
        Object objValue = this.get(FIELD_OPTPSDLPARAMNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isOptPSDLParamNameDirty(){
        if(this.contains(FIELD_OPTPSDLPARAMNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetOptPSDLParamName(){
        this.reset(FIELD_OPTPSDLPARAMNAME);
    }

    /**
     * 设置 可选参数
     * <P>
     * 等同 {@link #setOptPSDLParamName}
     * @param optPSDLParamName
     */
    @JsonIgnore
    public PSDELogicNode optpsdlparamname(String optPSDLParamName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ospsdlparamid(String oSPSDLParamId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ospsdlparamid(PSDELogicParam pSDELogicParam){
        if(pSDELogicParam == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode ospsdlparamname(String oSPSDLParamName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode paralleloutput(Integer parallelOutput){
     ...
     */
    @JsonIgnore
    public PSDELogicNode paralleloutput(Boolean parallelOutput){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param1(String param1){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param10(Integer param10){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param10(Boolean param10){
        if(param10 == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param11(String param11){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param12(String param12){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param13(String param13){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param14(String param14){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param2(String param2){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param3(String param3){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param4(String param4){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param5(String param5){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param6(String param6){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param7(Integer param7){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param8(Integer param8){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param9(Integer param9){
     ...
     */
    @JsonIgnore
    public PSDELogicNode param9(Boolean param9){
        if(param9 == null){
            this.setParam9(null);
        }
        else{
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdelogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdelogicnodeid(String pSDELogicNodeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdelogicnodename(String pSDELogicNodeName){
    ...
    @JsonIgnore
    public PSDELogicNode name(String strName){
        this.setPSDELogicNodeName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdemainstateid(String pSDEMainStateId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdemainstateid(PSDEMainState pSDEMainState){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdemainstatename(String pSDEMainStateName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdeuiactionid(PSDEUIAction pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssubsyssadetailid(String pSSubSysSADetailId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssubsyssadetailid(PSSubSysSADetail pSSubSysSADetail){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssubsyssadetailname(String pSSubSysSADetailName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssubsysserviceapiid(String pSSubSysServiceAPIId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssubsysserviceapiid(PSSubSysServiceAPI pSSubSysServiceAPI){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssubsysserviceapiname(String pSSubSysServiceAPIName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaichatagentid(String pSSysAIChatAgentId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaichatagentid(PSSysAIChatAgent pSSysAIChatAgent){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaichatagentname(String pSSysAIChatAgentName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaifactoryid(String pSSysAIFactoryId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaifactoryid(PSSysAIFactory pSSysAIFactory){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaifactoryname(String pSSysAIFactoryName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaipipelineagentid(String pSSysAIPipelineAgentId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaipipelineagentid(PSSysAIPipelineAgent pSSysAIPipelineAgent){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaipipelineagentname(String pSSysAIPipelineAgentName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaiworkeragentid(String pSSysAIWorkerAgentId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaiworkeragentid(PSSysAIWorkerAgent pSSysAIWorkerAgent){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysaiworkeragentname(String pSSysAIWorkerAgentName){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSSysBackService} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbackserviceid(String pSSysBackServiceId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbackserviceid(PSSysBackService pSSysBackService){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbackservicename(String pSSysBackServiceName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbdschemeid(String pSSysBDSchemeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbdschemeid(PSSysBDScheme pSSysBDScheme){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbdschemename(String pSSysBDSchemeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbdtableid(String pSSysBDTableId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbdtableid(PSSysBDTable pSSysBDTable){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbdtablename(String pSSysBDTableName){
        this.setPSSysBDTableName(pSSysBDTableName);
        return this;
    }

    /**
     * <B>PSSYSBIAGGTABLEID</B>&nbsp;智能报表聚合表
     * <P>
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbiaggtableid(String pSSysBIAggTableId){
        this.setPSSysBIAggTableId(pSSysBIAggTableId);
        return this;
    }

    /**
     * 设置 智能报表聚合表，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSSysBIAggTableId}
     * @param pSSysBIAggTable 引用对象
     */
    @JsonIgnore
    public PSDELogicNode pssysbiaggtableid(PSSysBIAggTable pSSysBIAggTable){
    ...
    /**
     * <B>PSSYSBIAGGTABLENAME</B>&nbsp;智能报表聚合表
     * <P>
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbiaggtablename(String pSSysBIAggTableName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbicubeid(String pSSysBICubeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbicubeid(PSSysBICube pSSysBICube){
        if(pSSysBICube == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbicubename(String pSSysBICubeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbireportid(String pSSysBIReportId){
        this.setPSSysBIReportId(pSSysBIReportId);
        return this;
    }

    /**
     * 设置 智能报表，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSSysBIReportId}
     * @param pSSysBIReport 引用对象
     */
    @JsonIgnore
    public PSDELogicNode pssysbireportid(PSSysBIReport pSSysBIReport){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbireportname(String pSSysBIReportName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbischemeid(String pSSysBISchemeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbischemeid(PSSysBIScheme pSSysBIScheme){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysbischemename(String pSSysBISchemeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdatasyncagentid(String pSSysDataSyncAgentId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdatasyncagentid(PSSysDataSyncAgent pSSysDataSyncAgent){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdatasyncagentname(String pSSysDataSyncAgentName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdbschemeid(String pSSysDBSchemeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdbschemeid(PSSysDBScheme pSSysDBScheme){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdbschemename(String pSSysDBSchemeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdbtableid(String pSSysDBTableId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdbtableid(PSSysDBTable pSSysDBTable){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdbtablename(String pSSysDBTableName){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSSysDELogicNode} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdelogicnodeid(String pSSysDELogicNodeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdelogicnodeid(PSSysDELogicNode pSSysDELogicNode){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysdelogicnodename(String pSSysDELogicNodeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyseaielementid(String pSSysEAIElementId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyseaielementid(PSSysEAIElement pSSysEAIElement){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyseaielementname(String pSSysEAIElementName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyseaischemeid(String pSSysEAISchemeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyseaischemeid(PSSysEAIScheme pSSysEAIScheme){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyseaischemename(String pSSysEAISchemeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysmsgtemplid(String pSSysMsgTemplId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysmsgtemplid(PSSysMsgTempl pSSysMsgTempl){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysmsgtemplname(String pSSysMsgTemplName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyspfpluginid(PSSysPFPlugin pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysresourceid(String pSSysResourceId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysresourceid(PSSysResource pSSysResource){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysresourcename(String pSSysResourceName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssearchdocid(String pSSysSearchDocId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssearchdocid(PSSysSearchDoc pSSysSearchDoc){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssearchdocname(String pSSysSearchDocName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssearchschemeid(String pSSysSearchSchemeId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssearchschemeid(PSSysSearchScheme pSSysSearchScheme){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssearchschemename(String pSSysSearchSchemeName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssfpluginname(String pSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssqlcmdid(String pSSysSQLCmdId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssyssqlcmdname(String pSSysSQLCmdName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysunistateid(String pSSysUniStateId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysunistateid(PSSysUniState pSSysUniState){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysunistatename(String pSSysUniStateName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysutildeid(String pSSysUtilDEId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysutildeid(PSSysUtil pSSysUtil){
        if(pSSysUtil == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pssysutildename(String pSSysUtilDEName){
        this.setPSSysUtilDEName(pSSysUtilDEName);
        return this;
    }

    /**
     * <B>PSVIEWMSGID</B>&nbsp;视图消息
     * <P>
     ...
     */
    @JsonIgnore
    public PSDELogicNode psviewmsgid(String pSViewMsgId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psviewmsgid(PSViewMsg pSViewMsg){
        if(pSViewMsg == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psviewmsgname(String pSViewMsgName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pswfdeid(String pSWFDEId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pswfdeid(PSWFDE pSWFDE){
        if(pSWFDE == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode pswfdename(String pSWFDEName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psworkflowid(String pSWorkflowId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psworkflowid(PSWorkflow pSWorkflow){
        if(pSWorkflow == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode psworkflowname(String pSWorkflowName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode retpsdlparamid(String retPSDLParamId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode retpsdlparamid(PSDELogicParam pSDELogicParam){
        if(pSDELogicParam == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode retpsdlparamname(String retPSDLParamName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode shapeparams(String shapeParams){
     ...
     */
    @JsonIgnore
    public PSDELogicNode srcindex(Integer srcIndex){
     ...
     */
    @JsonIgnore
    public PSDELogicNode srcpsdlparamid(String srcPSDLParamId){
     ...
     */
    @JsonIgnore
    public PSDELogicNode srcpsdlparamid(PSDELogicParam pSDELogicParam){
        if(pSDELogicParam == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode srcpsdlparamname(String srcPSDLParamName){
     ...
     */
    @JsonIgnore
    public PSDELogicNode srcsize(Integer srcSize){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.DELogicNodeThreadRunMode} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode threadrunmode(Integer threadRunMode){
     ...
     */
    @JsonIgnore
    public PSDELogicNode threadrunmode(net.ibizsys.psmodel.core.util.PSModelEnums.DELogicNodeThreadRunMode threadRunMode){
     ...
     */
    @JsonIgnore
    public PSDELogicNode threadruntimer(Integer threadRunTimer){
     ...
     */
    @JsonIgnore
    public PSDELogicNode toppos(Integer topPos){
     ...
     * <B>TSMODE</B>&nbsp;事务模式
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.DELogicNodeTSMode} 
     */
     ...
     */
    @JsonIgnore
    public PSDELogicNode tsmode(Integer tSMode){
     ...
     */
    @JsonIgnore
    public PSDELogicNode tsmode(net.ibizsys.psmodel.core.util.PSModelEnums.DELogicNodeTSMode tSMode){
        if(tSMode == null){
            this.setTSMode(null);
        }
        else{
     ...
     */
    @JsonIgnore
    public PSDELogicNode updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDELogicNode updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDELogicNode usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDELogicNode usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDELogicNode userparams(String userParams){
     ...
     */
    @JsonIgnore
    public PSDELogicNode usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDELogicNode usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDELogicNode usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDELogicNode usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSDELogicNode id(String strValue){
        this.setPSDELogicNodeId(strValue);
        return this;
    }
    ...
    private java.util.List<net.ibizsys.psmodel.core.domain.PSDELNParam> psdelnparams;
    ...
    public java.util.List<net.ibizsys.psmodel.core.domain.PSDELNParam> getPSDELNParams(){
     ...
     */
    @JsonProperty(FIELD_PSDELNPARAMS)
    public void setPSDELNParams(java.util.List<net.ibizsys.psmodel.core.domain.PSDELNParam> psdelnparams){
     ...
     */
    @JsonIgnore
    public java.util.List<net.ibizsys.psmodel.core.domain.PSDELNParam> getPSDELNParamsIf(){
        if(this.psdelnparams == null){
            this.psdelnparams = new java.util.ArrayList<net.ibizsys.psmodel.core.domain.PSDELNParam>();          
        }
        return this.psdelnparams;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDELogicNode){
            PSDELogicNode model = (PSDELogicNode)iPSModel;
            model.setPSDELNParams(this.getPSDELNParams());
        }
