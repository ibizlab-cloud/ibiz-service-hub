 ...
 * 
 */
public class PSAppDynaDEView extends PSAppView {

    public PSAppDynaDEView(){
     ...
     */
    @JsonIgnore
    public PSAppDynaDEView createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSAppDynaDEView createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSAppDynaDEView psappdynadeviewid(String pSAppDynaDEViewId){
     ...
     */
    @JsonIgnore
    public PSAppDynaDEView psappdynadeviewname(String pSAppDynaDEViewName){
    ...
    @JsonIgnore
    public PSAppDynaDEView name(String strName){
        this.setPSAppDynaDEViewName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSAppDynaDEView updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSAppDynaDEView updateman(String updateMan){
    ...
    @JsonIgnore
    public PSAppDynaDEView id(String strValue){
        this.setPSAppDynaDEViewId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSAppDynaDEView){
            PSAppDynaDEView model = (PSAppDynaDEView)iPSModel;
        }
