...
/**
 * <B>PSAPPUSERMODE</B>应用用户模式 模型传输对象
 * <P>
 * 应用用户模式模型，定义应用支持的用户模式，包括默认视图、默认应用菜单等
 */
public class PSAppUserMode extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSAppUserMode(){
    }      

    /**
     * <B>CODENAME</B>&nbsp;代码标识，指定应用用户模式的代码标识，需在所在的前端应用中具备唯一性
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppUserMode codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSAppUserMode createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSAppUserMode createman(String createMan){
        this.setCreateMan(createMan);
        return this;
    }

    /**
     * <B>DEFAULTFLAG</B>&nbsp;默认模式，指定应用用户模式是否为所在前端应用的默认用户模式，未定义时为【否】
     * <P>
    ...
    /**
     * 设置 默认模式，详细说明：{@link #FIELD_DEFAULTFLAG}
     * 
     * @param defaultFlag
     * 
     */
     ...
     */
    @JsonIgnore
    public PSAppUserMode defaultflag(Integer defaultFlag){
     ...
     */
    @JsonIgnore
    public PSAppUserMode defaultflag(Boolean defaultFlag){
        if(defaultFlag == null){
    ...
    /**
     * <B>LOGICNAME</B>&nbsp;中文名称，指定应用用户模式的逻辑名称
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSAppUserMode logicname(String logicName){
     ...
     */
    @JsonIgnore
    public PSAppUserMode memo(String memo){
        this.setMemo(memo);
        return this;
    }

    /**
     * <B>PSAPPMENUID</B>&nbsp;应用菜单，指定应用用户模式的默认应用菜单
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppUserMode psappmenuid(String pSAppMenuId){
     ...
     */
    @JsonIgnore
    public PSAppUserMode psappmenuid(PSAppMenu pSAppMenu){
        if(pSAppMenu == null){
    ...
    /**
     * <B>PSAPPMENUNAME</B>&nbsp;应用菜单，指定应用用户模式的默认应用菜单
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppUserMode psappmenuname(String pSAppMenuName){
        this.setPSAppMenuName(pSAppMenuName);
        return this;
    }

    /**
     * <B>PSAPPUSERMODEID</B>&nbsp;应用用户模式标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSAPPUSERMODEID = "psappusermodeid";

    /**
     * 设置 应用用户模式标识
     * 
     * @param pSAppUserModeId
     * 
     */
    @JsonProperty(FIELD_PSAPPUSERMODEID)
    ...
    /**
     * 判断 应用用户模式标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSAppUserModeIdDirty(){
        if(this.contains(FIELD_PSAPPUSERMODEID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSAppUserModeId(){
        this.reset(FIELD_PSAPPUSERMODEID);
    }

    /**
     * 设置 应用用户模式标识
     * <P>
     * 等同 {@link #setPSAppUserModeId}
     * @param pSAppUserModeId
     */
    @JsonIgnore
    public PSAppUserMode psappusermodeid(String pSAppUserModeId){
        this.setPSAppUserModeId(pSAppUserModeId);
        return this;
    }

    /**
     * <B>PSAPPUSERMODENAME</B>&nbsp;应用用户模式，指定应用用户模式的名称，需在所在前端应用中具备唯一性
     * <P>
     * 字符串：最大长度 200
     */
    public final static String FIELD_PSAPPUSERMODENAME = "psappusermodename";

    /**
     * 设置 应用用户模式，详细说明：{@link #FIELD_PSAPPUSERMODENAME}
     * 
     * @param pSAppUserModeName
     * 
     */
    @JsonProperty(FIELD_PSAPPUSERMODENAME)
    ...
    /**
     * 判断 应用用户模式 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSAppUserModeNameDirty(){
        if(this.contains(FIELD_PSAPPUSERMODENAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSAppUserModeName(){
        this.reset(FIELD_PSAPPUSERMODENAME);
    }

    /**
     * 设置 应用用户模式，详细说明：{@link #FIELD_PSAPPUSERMODENAME}
     * <P>
     * 等同 {@link #setPSAppUserModeName}
     * @param pSAppUserModeName
     */
    @JsonIgnore
    public PSAppUserMode psappusermodename(String pSAppUserModeName){
    ...
    @JsonIgnore
    public PSAppUserMode name(String strName){
        this.setPSAppUserModeName(strName);
        return this;
    }

    /**
     * <B>PSAPPVIEWID</B>&nbsp;默认视图，指定应用用户模式的默认应用视图
     * <P>
    ...
    /**
     * 设置 默认视图，详细说明：{@link #FIELD_PSAPPVIEWID}
     * 
     * @param pSAppViewId
     * 
     */
     ...
     */
    @JsonIgnore
    public PSAppUserMode psappviewid(String pSAppViewId){
     ...
     */
    @JsonIgnore
    public PSAppUserMode psappviewid(PSAppView pSAppView){
        if(pSAppView == null){
    ...
    /**
     * <B>PSAPPVIEWNAME</B>&nbsp;默认视图，指定应用用户模式的默认应用视图
     * <P>
    ...
    /**
     * 设置 默认视图，详细说明：{@link #FIELD_PSAPPVIEWNAME}
     * 
     * @param pSAppViewName
     * 
     */
     ...
     */
    @JsonIgnore
    public PSAppUserMode psappviewname(String pSAppViewName){
        this.setPSAppViewName(pSAppViewName);
        return this;
    }

    /**
     * <B>PSSYSAPPID</B>&nbsp;系统应用，指定应用用户模式所在的前端应用
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppUserMode pssysappid(String pSSysAppId){
     ...
     */
    @JsonIgnore
    public PSAppUserMode pssysappid(PSSysApp pSSysApp){
        if(pSSysApp == null){
    ...
    /**
     * <B>PSSYSAPPNAME</B>&nbsp;前端应用，指定应用用户模式所在的前端应用
     * <P>
     ...
     */
    @JsonIgnore
    public PSAppUserMode pssysappname(String pSSysAppName){
        this.setPSSysAppName(pSSysAppName);
        return this;
    }

    /**
     * <B>PSSYSUSERMODEID</B>&nbsp;系统用户模式，指定应用用户模式相关的系统用户模式
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSSysUserMode} 
     */
    public final static String FIELD_PSSYSUSERMODEID = "pssysusermodeid";

    /**
     * 设置 系统用户模式，详细说明：{@link #FIELD_PSSYSUSERMODEID}
     * 
     ...
     */
    @JsonIgnore
    public PSAppUserMode pssysusermodeid(String pSSysUserModeId){
        this.setPSSysUserModeId(pSSysUserModeId);
        return this;
    }

    /**
     * 设置 系统用户模式，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSSysUserModeId}
     * @param pSSysUserMode 引用对象
     */
    @JsonIgnore
    public PSAppUserMode pssysusermodeid(PSSysUserMode pSSysUserMode){
    ...
    /**
     * <B>PSSYSUSERMODENAME</B>&nbsp;系统用户模式，指定应用用户模式相关的系统用户模式
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_PSSYSUSERMODEID}
     */
    public final static String FIELD_PSSYSUSERMODENAME = "pssysusermodename";

    /**
     * 设置 系统用户模式，详细说明：{@link #FIELD_PSSYSUSERMODENAME}
     * 
     ...
     */
    @JsonIgnore
    public PSAppUserMode pssysusermodename(String pSSysUserModeName){
     ...
     */
    @JsonIgnore
    public PSAppUserMode updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSAppUserMode updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSAppUserMode usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSAppUserMode usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSAppUserMode usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSAppUserMode usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSAppUserMode usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSAppUserMode usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSAppUserMode id(String strValue){
        this.setPSAppUserModeId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSAppUserMode){
            PSAppUserMode model = (PSAppUserMode)iPSModel;
        }
