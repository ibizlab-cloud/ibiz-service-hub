...
/**
 * <B>PSDETOOLBARLOGIC</B>工具栏逻辑 模型传输对象
 * <P>
 * 
 */
public class PSDEToolbarLogic extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSDEToolbarLogic(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic dstlogictype(net.ibizsys.psmodel.core.util.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdelogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdename(String pSDEName){
        this.setPSDEName(pSDEName);
        return this;
    }

    /**
     * <B>PSDETBITEMID</B>&nbsp;工具拦项
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetbitemid(String pSDETBItemId){
        this.setPSDETBItemId(pSDETBItemId);
        return this;
    }

    /**
     * 设置 工具拦项，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSDETBItemId}
     * @param pSDETBItem 引用对象
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetbitemid(PSDETBItem pSDETBItem){
        if(pSDETBItem == null){
    ...
    /**
     * <B>PSDETBITEMNAME</B>&nbsp;工具拦项
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_PSDETBITEMID}
     */
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetbitemname(String pSDETBItemName){
        this.setPSDETBItemName(pSDETBItemName);
        return this;
    }

    /**
     * <B>PSDETOOLBARID</B>&nbsp;工具栏
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetoolbarid(String pSDEToolbarId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetoolbarid(PSDEToolbar pSDEToolbar){
        if(pSDEToolbar == null){
    ...
    /**
     * <B>PSDETOOLBARLOGICID</B>&nbsp;工具栏逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSDETOOLBARLOGICID = "psdetoolbarlogicid";

    /**
     * 设置 工具栏逻辑标识
     * 
     * @param pSDEToolbarLogicId
     * 
     */
    @JsonProperty(FIELD_PSDETOOLBARLOGICID)
    public void setPSDEToolbarLogicId(String pSDEToolbarLogicId){
        this.set(FIELD_PSDETOOLBARLOGICID, pSDEToolbarLogicId);
    }
    ...
    public String getPSDEToolbarLogicId(){
        Object objValue = this.get(FIELD_PSDETOOLBARLOGICID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 工具栏逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSDEToolbarLogicIdDirty(){
        if(this.contains(FIELD_PSDETOOLBARLOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEToolbarLogicId(){
        this.reset(FIELD_PSDETOOLBARLOGICID);
    }

    /**
     * 设置 工具栏逻辑标识
     * <P>
     * 等同 {@link #setPSDEToolbarLogicId}
     * @param pSDEToolbarLogicId
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetoolbarlogicid(String pSDEToolbarLogicId){
        this.setPSDEToolbarLogicId(pSDEToolbarLogicId);
        return this;
    }

    /**
     * <B>PSDETOOLBARLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSDETOOLBARLOGICNAME = "psdetoolbarlogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSDEToolbarLogicName
     * 
     */
    @JsonProperty(FIELD_PSDETOOLBARLOGICNAME)
    public void setPSDEToolbarLogicName(String pSDEToolbarLogicName){
        this.set(FIELD_PSDETOOLBARLOGICNAME, pSDEToolbarLogicName);
    }
    ...
    public String getPSDEToolbarLogicName(){
        Object objValue = this.get(FIELD_PSDETOOLBARLOGICNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDEToolbarLogicNameDirty(){
        if(this.contains(FIELD_PSDETOOLBARLOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEToolbarLogicName(){
        this.reset(FIELD_PSDETOOLBARLOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSDEToolbarLogicName}
     * @param pSDEToolbarLogicName
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetoolbarlogicname(String pSDEToolbarLogicName){
    ...
    @JsonIgnore
    public PSDEToolbarLogic name(String strName){
        this.setPSDEToolbarLogicName(strName);
        return this;
    }

    /**
     * <B>PSDETOOLBARNAME</B>&nbsp;工具栏
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdetoolbarname(String pSDEToolbarName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdeuiactionid(PSDEUIAction pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssyspfpluginid(PSSysPFPlugin pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssysviewlogicid(PSSysViewLogic pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssysviewpanelid(PSSysViewPanel pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic triggertype(net.ibizsys.psmodel.core.util.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEToolbarLogic validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSDEToolbarLogic id(String strValue){
        this.setPSDEToolbarLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDEToolbarLogic){
            PSDEToolbarLogic model = (PSDEToolbarLogic)iPSModel;
        }
