...
public class PSAppPortalViewFilter extends PSAppViewFilter {
     ...
     */
    @JsonIgnore
    public PSAppPortalViewFilter dashboardstyle__eq(String value){
     ...
     */
    @JsonIgnore
    public PSAppPortalViewFilter psappportalviewname__eq(String value){
        this.setFieldCond("psappportalviewname", EQ, value);
        return this;
    }
    ...
    public PSAppPortalViewFilter psappportalviewname__like(String value){
        this.setFieldCond("psappportalviewname", LIKE, value);
        return this;
    }
