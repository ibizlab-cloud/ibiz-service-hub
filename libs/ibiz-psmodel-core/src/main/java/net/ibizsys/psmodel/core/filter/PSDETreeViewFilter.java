 ...
 */
public class PSDETreeViewFilter extends net.ibizsys.psmodel.core.util.PSModelFilterBase {
    ...
    public PSDETreeViewFilter catpscodelistid__eq(String value){
        this.setFieldCond("catpscodelistid", EQ, value);
        return this;
    }
    ...
    public PSDETreeViewFilter catpscodelistname__eq(String value){
        this.setFieldCond("catpscodelistname", EQ, value);
        return this;
    }
    ...
    public PSDETreeViewFilter catpscodelistname__like(String value){
        this.setFieldCond("catpscodelistname", LIKE, value);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter codename__eq(String value){
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter colenablefilter__eq(Integer value){
        this.setFieldCond("colenablefilter", EQ, value);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter colenablelink__eq(Integer value){
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter navviewpos__eq(String value){
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter navviewshowmode__eq(Integer value){
    ...
    /**
     * 设置属性[实体树视图名称]过滤操作[EQ]
     * @param value
     * @return
     */
    @JsonIgnore
    public PSDETreeViewFilter psdetreeviewname__eq(String value){
        this.setFieldCond("psdetreeviewname", EQ, value);
        return this;
    }
    ...
    public PSDETreeViewFilter psdetreeviewname__like(String value){
        this.setFieldCond("psdetreeviewname", LIKE, value);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter psviewmsggroupid__eq(String value){
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter psviewmsggroupname__eq(String value){
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter psviewmsggroupname__like(String value){
     ...
     */
    @JsonIgnore
    public PSDETreeViewFilter treestyle__eq(String value){
        this.setFieldCond("treestyle", EQ, value);
        return this;
    }
