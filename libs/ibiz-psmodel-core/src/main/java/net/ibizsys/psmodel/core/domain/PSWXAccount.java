...
/**
 * <B>PSWXACCOUNT</B>微信公众号 模型传输对象
 * <P>
 * 微信公众号模型，定义系统中的微信公众号信息。iBiz未提供对钉钉的模型直接支持，如需使用可通过微信公众号模型进行相应标记，在模板中进行区分
 */
public class PSWXAccount extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSWXAccount(){
    }      

    /**
     * <B>CODENAME</B>&nbsp;代码标识，指定微信公众号的代码标识，需要在所在的模型域（系统模块或系统）中具有唯一性
     * <P>
     ...
     */
    @JsonIgnore
    public PSWXAccount codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSWXAccount createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSWXAccount createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSWXAccount memo(String memo){
        this.setMemo(memo);
        return this;
    }

    /**
     * <B>PSMODULEID</B>&nbsp;系统模块，指定微信公众号所在的系统模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSWXAccount psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSWXAccount psmoduleid(PSModule pSModule){
        if(pSModule == null){
    ...
    /**
     * <B>PSMODULENAME</B>&nbsp;系统模块，指定微信公众号所在的系统模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSWXAccount psmodulename(String pSModuleName){
     ...
     */
    @JsonIgnore
    public PSWXAccount pssysresourceid(String pSSysResourceId){
     ...
     */
    @JsonIgnore
    public PSWXAccount pssysresourceid(PSSysResource pSSysResource){
     ...
     */
    @JsonIgnore
    public PSWXAccount pssysresourcename(String pSSysResourceName){
     ...
     */
    @JsonIgnore
    public PSWXAccount pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSWXAccount pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
     ...
     */
    @JsonIgnore
    public PSWXAccount pssyssfpluginname(String pSSysSFPluginName){
        this.setPSSysSFPluginName(pSSysSFPluginName);
        return this;
    }

    /**
     * <B>PSWXACCOUNTID</B>&nbsp;微信公众号标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSWXAccount pswxaccountid(String pSWXAccountId){
        this.setPSWXAccountId(pSWXAccountId);
        return this;
    }

    /**
     * <B>PSWXACCOUNTNAME</B>&nbsp;微信公众号名称，指定微信公众号的名称
     * <P>
     * 字符串：最大长度 200
     */
    ...
    /**
     * 设置 微信公众号名称，详细说明：{@link #FIELD_PSWXACCOUNTNAME}
     * 
     ...
     */
    @JsonIgnore
    public PSWXAccount pswxaccountname(String pSWXAccountName){
    ...
    @JsonIgnore
    public PSWXAccount name(String strName){
        this.setPSWXAccountName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSWXAccount updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSWXAccount updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSWXAccount usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSWXAccount usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSWXAccount usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSWXAccount usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSWXAccount usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSWXAccount usertag4(String userTag4){
        this.setUserTag4(userTag4);
        return this;
    }

    /**
     * <B>WXACCOUNTPARAMS</B>&nbsp;账户参数
     */
    public final static String FIELD_WXACCOUNTPARAMS = "wxaccountparams";

    /**
     * 设置 账户参数
     * 
     * @param wXAccountParams
     * 
     */
    @JsonProperty(FIELD_WXACCOUNTPARAMS)
    public void setWXAccountParams(String wXAccountParams){
        this.set(FIELD_WXACCOUNTPARAMS, wXAccountParams);
    }
    ...
    public String getWXAccountParams(){
        Object objValue = this.get(FIELD_WXACCOUNTPARAMS);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isWXAccountParamsDirty(){
        if(this.contains(FIELD_WXACCOUNTPARAMS)){
            return true;
        }
        return false;
    }
    ...
    public void resetWXAccountParams(){
        this.reset(FIELD_WXACCOUNTPARAMS);
    }

    /**
     * 设置 账户参数
     * <P>
     * 等同 {@link #setWXAccountParams}
     * @param wXAccountParams
     */
    @JsonIgnore
    public PSWXAccount wxaccountparams(String wXAccountParams){
        this.setWXAccountParams(wXAccountParams);
        return this;
    }

    /**
     * <B>WXACCOUNTTYPE</B>&nbsp;公众号类型，指定微信公众号的类型
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.WXAccountType} 
     */
    public final static String FIELD_WXACCOUNTTYPE = "wxaccounttype";

    /**
     * 设置 公众号类型，详细说明：{@link #FIELD_WXACCOUNTTYPE}
     * 
     * @param wXAccountType
     * 
     */
    @JsonProperty(FIELD_WXACCOUNTTYPE)
    ...
    public boolean isWXAccountTypeDirty(){
        if(this.contains(FIELD_WXACCOUNTTYPE)){
            return true;
        }
        return false;
    }
    ...
    public void resetWXAccountType(){
        this.reset(FIELD_WXACCOUNTTYPE);
    }

    /**
     * 设置 公众号类型，详细说明：{@link #FIELD_WXACCOUNTTYPE}
     * <P>
     * 等同 {@link #setWXAccountType}
     * @param wXAccountType
     */
    @JsonIgnore
    public PSWXAccount wxaccounttype(String wXAccountType){
     ...
     */
    @JsonIgnore
    public PSWXAccount wxaccounttype(net.ibizsys.psmodel.core.util.PSModelEnums.WXAccountType wXAccountType){
    ...
    @JsonIgnore
    public PSWXAccount id(String strValue){
        this.setPSWXAccountId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSWXAccount){
            PSWXAccount model = (PSWXAccount)iPSModel;
        }
