 ...
 */
public class PSSysSearchBarFilter extends net.ibizsys.psmodel.core.util.PSModelFilterBase {
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter codename__eq(String value){
    ...
    public PSSysSearchBarFilter groupmoretextpslanresid__eq(String value){
        this.setFieldCond("groupmoretextpslanresid", EQ, value);
        return this;
    }
    ...
    public PSSysSearchBarFilter groupmoretextpslanresname__eq(String value){
        this.setFieldCond("groupmoretextpslanresname", EQ, value);
        return this;
    }
    ...
    public PSSysSearchBarFilter groupmoretextpslanresname__like(String value){
        this.setFieldCond("groupmoretextpslanresname", LIKE, value);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter pssyssearchbarname__eq(String value){
        this.setFieldCond("pssyssearchbarname", EQ, value);
        return this;
    }
    ...
    public PSSysSearchBarFilter pssyssearchbarname__like(String value){
        this.setFieldCond("pssyssearchbarname", LIKE, value);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter psviewmsggroupid__eq(String value){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter psviewmsggroupname__eq(String value){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter psviewmsggroupname__like(String value){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter usertag__eq(String value){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarFilter usertag2__eq(String value){
