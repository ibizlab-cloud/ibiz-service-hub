...
/**
 * <B>PSDEGRIDLOGIC</B>实体表格逻辑 模型传输对象
 * <P>
 * 
 */
public class PSDEGridLogic extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSDEGridLogic(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSDEGridLogic attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic dstlogictype(net.ibizsys.psmodel.core.util.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEGridLogic ordervalue(Integer orderValue){
        this.setOrderValue(orderValue);
        return this;
    }

    /**
     * <B>PSDEGRIDCOLID</B>&nbsp;表格列
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdegridcolid(String pSDEGridColId){
        this.setPSDEGridColId(pSDEGridColId);
        return this;
    }

    /**
     * 设置 表格列，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSDEGridColId}
     * @param pSDEGridCol 引用对象
     */
    @JsonIgnore
    public PSDEGridLogic psdegridcolid(PSDEGridCol pSDEGridCol){
        if(pSDEGridCol == null){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdegridcolname(String pSDEGridColName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdegridid(String pSDEGridId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdegridid(PSDEGrid pSDEGrid){
        if(pSDEGrid == null){
    ...
    /**
     * <B>PSDEGRIDCOLLOGICID</B>&nbsp;实体表格逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSDEGRIDCOLLOGICID = "psdegridcollogicid";

    /**
     * 设置 实体表格逻辑标识
     * 
     * @param pSDEGridColLogicId
     * 
     */
    @JsonProperty(FIELD_PSDEGRIDCOLLOGICID)
    public void setPSDEGridColLogicId(String pSDEGridColLogicId){
        this.set(FIELD_PSDEGRIDCOLLOGICID, pSDEGridColLogicId);
        //属性名称与代码标识不一致，设置属性名称
        this.set("psdegridlogicid", pSDEGridColLogicId);
    }
    ...
    public String getPSDEGridColLogicId(){
        Object objValue = this.get(FIELD_PSDEGRIDCOLLOGICID);
        if(objValue==null){
            //属性名称与代码标识不一致，使用属性名称
            objValue = this.get("psdegridlogicid");
            if(objValue == null){
                return null;
            }
        }
    ...
    /**
     * 判断 实体表格逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSDEGridColLogicIdDirty(){
        if(this.contains(FIELD_PSDEGRIDCOLLOGICID)){
            return true;
        }
        //属性名称与代码标识不一致，判断属性名称
        if(this.contains("psdegridlogicid")){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEGridColLogicId(){
        this.reset(FIELD_PSDEGRIDCOLLOGICID);
        //属性名称与代码标识不一致，重置属性名称
        this.reset("psdegridlogicid");
    }

    /**
     * 设置 实体表格逻辑标识
     * <P>
     * 等同 {@link #setPSDEGridColLogicId}
     * @param pSDEGridColLogicId
     */
    @JsonIgnore
    public PSDEGridLogic psdegridcollogicid(String pSDEGridColLogicId){
        this.setPSDEGridColLogicId(pSDEGridColLogicId);
        return this;
    }

    /**
     * <B>PSDEGRIDCOLLOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSDEGRIDCOLLOGICNAME = "psdegridcollogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSDEGridColLogicName
     * 
     */
    @JsonProperty(FIELD_PSDEGRIDCOLLOGICNAME)
    public void setPSDEGridColLogicName(String pSDEGridColLogicName){
        this.set(FIELD_PSDEGRIDCOLLOGICNAME, pSDEGridColLogicName);
        //属性名称与代码标识不一致，设置属性名称
        this.set("psdegridlogicname", pSDEGridColLogicName);
    }
    ...
    public String getPSDEGridColLogicName(){
        Object objValue = this.get(FIELD_PSDEGRIDCOLLOGICNAME);
        if(objValue==null){
            //属性名称与代码标识不一致，使用属性名称
            objValue = this.get("psdegridlogicname");
            if(objValue == null){
                return null;
            }
        }
    ...
    public boolean isPSDEGridColLogicNameDirty(){
        if(this.contains(FIELD_PSDEGRIDCOLLOGICNAME)){
            return true;
        }
        //属性名称与代码标识不一致，判断属性名称
        if(this.contains("psdegridlogicname")){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDEGridColLogicName(){
        this.reset(FIELD_PSDEGRIDCOLLOGICNAME);
        //属性名称与代码标识不一致，重置属性名称
        this.reset("psdegridlogicname");
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSDEGridColLogicName}
     * @param pSDEGridColLogicName
     */
    @JsonIgnore
    public PSDEGridLogic psdegridcollogicname(String pSDEGridColLogicName){
        this.setPSDEGridColLogicName(pSDEGridColLogicName);
        return this;
    }

    @JsonIgnore
    public String getName(){
        return this.getPSDEGridColLogicName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSDEGridColLogicName(strName);
    }

    @JsonIgnore
    public PSDEGridLogic name(String strName){
        this.setPSDEGridColLogicName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdegridname(String pSDEGridName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdelogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdeuiactionid(PSDEUIAction pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssyspfpluginid(PSSysPFPlugin pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssysviewlogicid(PSSysViewLogic pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssysviewpanelid(PSSysViewPanel pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEGridLogic triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic triggertype(net.ibizsys.psmodel.core.util.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEGridLogic validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public String getId(){
        return this.getPSDEGridColLogicId();
    }

    @JsonIgnore
    public void setId(String strValue){
        this.setPSDEGridColLogicId(strValue);
    }

    @JsonIgnore
    public PSDEGridLogic id(String strValue){
        this.setPSDEGridColLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDEGridLogic){
            PSDEGridLogic model = (PSDEGridLogic)iPSModel;
        }
