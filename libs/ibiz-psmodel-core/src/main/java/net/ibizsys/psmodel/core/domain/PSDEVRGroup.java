...
public class PSDEVRGroup extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     */
    @JsonIgnore
    public PSDEVRGroup codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup grouptag(String groupTag){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup grouptag2(String groupTag2){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEVRGroup ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup psdename(String pSDEName){
        this.setPSDEName(pSDEName);
        return this;
    }

    /**
     * <B>PSDEVRGROUPID</B>&nbsp;实体属性值规则组标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSDEVRGroup psdevrgroupid(String pSDEVRGroupId){
        this.setPSDEVRGroupId(pSDEVRGroupId);
        return this;
    }

    /**
     * <B>PSDEVRGROUPNAME</B>&nbsp;值规则组名称
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSDEVRGroup psdevrgroupname(String pSDEVRGroupName){
    ...
    @JsonIgnore
    public PSDEVRGroup name(String strName){
        this.setPSDEVRGroupName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEVRGroup updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup userparams(String userParams){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEVRGroup usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSDEVRGroup id(String strValue){
        this.setPSDEVRGroupId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDEVRGroup){
            PSDEVRGroup model = (PSDEVRGroup)iPSModel;
        }
