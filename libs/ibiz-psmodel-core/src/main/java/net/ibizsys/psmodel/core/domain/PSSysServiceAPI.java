...
public class PSSysServiceAPI extends net.ibizsys.psmodel.core.util.PSModelBase {
    ...
    public PSSysServiceAPI(){
        this.setValidFlag(1);
    }      

    /**
     * <B>APILEVEL</B>&nbsp;接口级别，指定服务接口的级别，默认为【用户级】
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPILevel} 
     */
    public final static String FIELD_APILEVEL = "apilevel";

    /**
     * 设置 接口级别，详细说明：{@link #FIELD_APILEVEL}
     * 
     * @param aPILevel
     * 
     */
    @JsonProperty(FIELD_APILEVEL)
    ...
    public boolean isAPILevelDirty(){
        if(this.contains(FIELD_APILEVEL)){
            return true;
        }
        return false;
    }
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apilevel(Integer aPILevel){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apilevel(net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPILevel aPILevel){
        if(aPILevel == null){
            this.setAPILevel(null);
        }
        else{
            this.setAPILevel(aPILevel.value);
        }
        return this;
    }

    /**
     * <B>APIMODE</B>&nbsp;接口模式，指定服务接口模式，默认为【实体服务接口（指定实体）（默认）】
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPIMode} 
     */
    public final static String FIELD_APIMODE = "apimode";

    /**
     * 设置 接口模式，详细说明：{@link #FIELD_APIMODE}
     * 
     * @param aPIMode
     * 
     */
    @JsonProperty(FIELD_APIMODE)
    ...
    public boolean isAPIModeDirty(){
        if(this.contains(FIELD_APIMODE)){
            return true;
        }
        return false;
    }
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apimode(Integer aPIMode){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apimode(net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPIMode aPIMode){
        if(aPIMode == null){
            this.setAPIMode(null);
        }
        else{
            this.setAPIMode(aPIMode.value);
        }
        return this;
    }

    /**
     * <B>APITAG</B>&nbsp;接口标记，指定服务接口的标记
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apitag(String aPITag){
        this.setAPITag(aPITag);
        return this;
    }

    /**
     * <B>APITAG2</B>&nbsp;接口标记2，指定服务接口的标记2
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apitag2(String aPITag2){
        this.setAPITag2(aPITag2);
        return this;
    }

    /**
     * <B>APITYPE</B>&nbsp;接口类型，指定服务接口的类型，默认为【RESTful API】
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPIType} 
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apitype(String aPIType){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI apitype(net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPIType aPIType){
        if(aPIType == null){
    ...
    /**
     * <B>AUTHCHECKTOKENURI</B>&nbsp;认证token路径，指定服务接口的认证路径，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 500
     */
    ...
    /**
     * 设置 认证token路径，详细说明：{@link #FIELD_AUTHCHECKTOKENURI}
     * 
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authchecktokenuri(String authCheckTokenUri){
        this.setAuthCheckTokenUri(authCheckTokenUri);
        return this;
    }

    /**
     * <B>AUTHCLIENTID</B>&nbsp;认证客户端标识，指定服务接口的认证客户端标识，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authclientid(String authClientId){
        this.setAuthClientId(authClientId);
        return this;
    }

    /**
     * <B>AUTHCLIENTSECRET</B>&nbsp;认证客户端密钥，指定服务接口的认证客户端密钥，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 1000
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authclientsecret(String authClientSecret){
        this.setAuthClientSecret(authClientSecret);
        return this;
    }

    /**
     * <B>AUTHMODE</B>&nbsp;认证模式，指定服务接口的认证模式，支持在运行环境进行配置调整
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authmode(String authMode){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authmode(net.ibizsys.psmodel.core.util.PSModelEnums.APIAuthMode authMode){
        if(authMode == null){
    ...
    /**
     * <B>AUTHPARAM</B>&nbsp;认证参数，指定服务接口的认证参数，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authparam(String authParam){
        this.setAuthParam(authParam);
        return this;
    }

    /**
     * <B>AUTHPARAM2</B>&nbsp;认证参数2，指定服务接口的认证参数2，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authparam2(String authParam2){
        this.setAuthParam2(authParam2);
        return this;
    }

    /**
     * <B>AUTHPARAM3</B>&nbsp;认证参数3，指定服务接口的认证参数3，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authparam3(String authParam3){
        this.setAuthParam3(authParam3);
        return this;
    }

    /**
     * <B>AUTHPARAM4</B>&nbsp;认证参数4，指定服务接口的认证参数4，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI authparam4(String authParam4){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI baseclsparams(String baseClsParams){
        this.setBaseClsParams(baseClsParams);
        return this;
    }

    /**
     * <B>CFGPSMODELSTORAGEID</B>&nbsp;配置模型存储标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_CFGPSMODELSTORAGEID = "cfgpsmodelstorageid";

    /**
     * 设置 配置模型存储标识
     * 
     * @param cfgPSModelStorageId
     * 
     */
    @JsonProperty(FIELD_CFGPSMODELSTORAGEID)
    ...
    /**
     * 判断 配置模型存储标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isCfgPSModelStorageIdDirty(){
        if(this.contains(FIELD_CFGPSMODELSTORAGEID)){
            return true;
        }
        return false;
    }
    ...
    public void resetCfgPSModelStorageId(){
        this.reset(FIELD_CFGPSMODELSTORAGEID);
    }

    /**
     * 设置 配置模型存储标识
     * <P>
     * 等同 {@link #setCfgPSModelStorageId}
     * @param cfgPSModelStorageId
     */
    @JsonIgnore
    public PSSysServiceAPI cfgpsmodelstorageid(String cfgPSModelStorageId){
        this.setCfgPSModelStorageId(cfgPSModelStorageId);
        return this;
    }
     ...
     * 字符串：最大长度 100
     */
    public final static String FIELD_CFGTAG = "cfgtag";
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI cfgtag(String cfgTag){
        this.setCfgTag(cfgTag);
        return this;
    }

    /**
     * <B>CODENAME</B>&nbsp;代码标识，指定服务接口的代码标识，需要在服务接口所在的模型域（系统模块或系统）中具有唯一性
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI codenamemode(String codeNameMode){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI codenamemode(net.ibizsys.psmodel.core.util.PSModelEnums.CodeNameMode codeNameMode){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI custommode(Integer customMode){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI custommode(net.ibizsys.psmodel.core.util.PSModelEnums.ScriptMode2 customMode){
        if(customMode == null){
    ...
    /**
     * <B>DEFAULTPORT</B>&nbsp;默认端口，指定服务接口的服务端口，支持在运行环境进行配置调整
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defaultport(Integer defaultPort){
        this.setDefaultPort(defaultPort);
        return this;
    }

    /**
     * <B>DEFAULTPSDEOPPRIVID</B>&nbsp;默认访问操作标识
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSDEOPPriv} 
     */
    public final static String FIELD_DEFAULTPSDEOPPRIVID = "defaultpsdeopprivid";

    /**
     * 设置 默认访问操作标识
     * 
     * @param defaultPSDEOPPrivId
     * 
     */
    @JsonProperty(FIELD_DEFAULTPSDEOPPRIVID)
    ...
    /**
     * 判断 默认访问操作标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isDefaultPSDEOPPrivIdDirty(){
        if(this.contains(FIELD_DEFAULTPSDEOPPRIVID)){
            return true;
        }
        return false;
    }
    ...
    public void resetDefaultPSDEOPPrivId(){
        this.reset(FIELD_DEFAULTPSDEOPPRIVID);
    }

    /**
     * 设置 默认访问操作标识
     * <P>
     * 等同 {@link #setDefaultPSDEOPPrivId}
     * @param defaultPSDEOPPrivId
     */
    @JsonIgnore
    public PSSysServiceAPI defaultpsdeopprivid(String defaultPSDEOPPrivId){
        this.setDefaultPSDEOPPrivId(defaultPSDEOPPrivId);
        return this;
    }

    /**
     * 设置 默认访问操作标识，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setDefaultPSDEOPPrivId}
     * @param pSDEOPPriv 引用对象
     */
    @JsonIgnore
    public PSSysServiceAPI defaultpsdeopprivid(PSDEOPPriv pSDEOPPriv){
        if(pSDEOPPriv == null){
            this.setDefaultPSDEOPPrivId(null);
            this.setDefaultPSDEOPPrivName(null);
        }
        else{
            this.setDefaultPSDEOPPrivId(pSDEOPPriv.getPSDEOPPrivId());
            this.setDefaultPSDEOPPrivName(pSDEOPPriv.getPSDEOPPrivName());
        }
        return this;
    }

    /**
     * <B>DEFAULTPSDEOPPRIVNAME</B>&nbsp;默认访问操作标识
     * <P>
     * 引用附加属性：连接&nbsp;{@link #FIELD_DEFAULTPSDEOPPRIVID}
     */
    public final static String FIELD_DEFAULTPSDEOPPRIVNAME = "defaultpsdeopprivname";

    /**
     * 设置 默认访问操作标识
     * 
     * @param defaultPSDEOPPrivName
     * 
     */
    @JsonProperty(FIELD_DEFAULTPSDEOPPRIVNAME)
    ...
    public boolean isDefaultPSDEOPPrivNameDirty(){
        if(this.contains(FIELD_DEFAULTPSDEOPPRIVNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetDefaultPSDEOPPrivName(){
        this.reset(FIELD_DEFAULTPSDEOPPRIVNAME);
    }

    /**
     * 设置 默认访问操作标识
     * <P>
     * 等同 {@link #setDefaultPSDEOPPrivName}
     * @param defaultPSDEOPPrivName
     */
    @JsonIgnore
    public PSSysServiceAPI defaultpsdeopprivname(String defaultPSDEOPPrivName){
        this.setDefaultPSDEOPPrivName(defaultPSDEOPPrivName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defcreatereqmethod(String defCreateReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defcreatereqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defCreateReqMethod){
    ...
    /**
     * <B>DEFDEACTIONREQMETHOD</B>&nbsp;默认实体行为请求方式，指定到服务接口中实体行为默认的请求方式，供未定义请求方式的实体行为使用
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod} 
     */
    ...
    /**
     * 设置 默认实体行为请求方式，详细说明：{@link #FIELD_DEFDEACTIONREQMETHOD}
     * 
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defdeactionreqmethod(String defDEActionReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defdeactionreqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defDEActionReqMethod){
    ...
    /**
     * <B>DEFDEDATASETREQMETHOD</B>&nbsp;默认结果集请求方式，指定到服务接口中实体数据集合默认的请求方式，供未定义请求方式的实体数据集合使用
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod} 
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defdedatasetreqmethod(String defDEDataSetReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defdedatasetreqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defDEDataSetReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defdeletereqmethod(String defDeleteReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defdeletereqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defDeleteReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defgetdraftreqmethod(String defGetDraftReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defgetdraftreqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defGetDraftReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defgetreqmethod(String defGetReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defgetreqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defGetReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defneedresourcekey(Integer defNeedResourceKey){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defneedresourcekey(Boolean defNeedResourceKey){
    ...
    /**
     * <B>DEFSELECTREQMETHOD</B>&nbsp;默认查询请求方式，指定到服务接口中实体数据查询默认的请求方式，供未定义请求方式的实体数据查询使用
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod} 
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defselectreqmethod(String defSelectReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defselectreqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defSelectReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defupdatereqmethod(String defUpdateReqMethod){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI defupdatereqmethod(net.ibizsys.psmodel.core.util.PSModelEnums.RequestMethod defUpdateReqMethod){
    ...
    /**
     * <B>DEPSSYSSFPLUGINID</B>&nbsp;实体后台扩展插件，指定实体服务接口的后台模板扩展插件，用于扩展实体服务接口代码
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI depssyssfpluginid(String dEPSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI depssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
    ...
    /**
     * <B>DEPSSYSSFPLUGINNAME</B>&nbsp;实体后台扩展插件，指定实体服务接口的后台模板扩展插件，用于扩展实体服务接口代码
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI depssyssfpluginname(String dEPSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI enableapimodelex(Integer enableAPIModelEx){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI enableapimodelex(Boolean enableAPIModelEx){
    ...
    /**
     * <B>ENABLEGATEWAY</B>&nbsp;启用接口网关
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.YesNo} 
     */
    public final static String FIELD_ENABLEGATEWAY = "enablegateway";
     ...
     * 
     */
    @JsonProperty(FIELD_ENABLEGATEWAY)
    public void setEnableGateway(Integer enableGateway){
        this.set(FIELD_ENABLEGATEWAY, enableGateway);
    }
    ...
    public Integer getEnableGateway(){
        Object objValue = this.get(FIELD_ENABLEGATEWAY);
        if(objValue==null){
            return null;
        }
        return (Integer)objValue;
    ...
    /**
     * 判断 启用接口网关 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isEnableGatewayDirty(){
        if(this.contains(FIELD_ENABLEGATEWAY)){
            return true;
        }
        return false;
    }
    ...
    public void resetEnableGateway(){
        this.reset(FIELD_ENABLEGATEWAY);
    }

    /**
     * 设置 启用接口网关
     * <P>
     * 等同 {@link #setEnableGateway}
     * @param enableGateway
     */
    @JsonIgnore
    public PSSysServiceAPI enablegateway(Integer enableGateway){
        this.setEnableGateway(enableGateway);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI enablegateway(Boolean enableGateway){
        if(enableGateway == null){
            this.setEnableGateway(null);
        }
        else{
            this.setEnableGateway(enableGateway?BOOLEAN_TRUE:BOOLEAN_FALSE);
        }
        return this;
    }

    /**
     * <B>IGNOREAUTHPATTERNS</B>&nbsp;忽略认证路径集合
     */
    public final static String FIELD_IGNOREAUTHPATTERNS = "ignoreauthpatterns";

    /**
     * 设置 忽略认证路径集合
     * 
     * @param ignoreAuthPatterns
     * 
     */
    @JsonProperty(FIELD_IGNOREAUTHPATTERNS)
    public void setIgnoreAuthPatterns(String ignoreAuthPatterns){
        this.set(FIELD_IGNOREAUTHPATTERNS, ignoreAuthPatterns);
    }
    ...
    public String getIgnoreAuthPatterns(){
        Object objValue = this.get(FIELD_IGNOREAUTHPATTERNS);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 忽略认证路径集合 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isIgnoreAuthPatternsDirty(){
        if(this.contains(FIELD_IGNOREAUTHPATTERNS)){
            return true;
        }
        return false;
    }
    ...
    public void resetIgnoreAuthPatterns(){
        this.reset(FIELD_IGNOREAUTHPATTERNS);
    }

    /**
     * 设置 忽略认证路径集合
     * <P>
     * 等同 {@link #setIgnoreAuthPatterns}
     * @param ignoreAuthPatterns
     */
    @JsonIgnore
    public PSSysServiceAPI ignoreauthpatterns(String ignoreAuthPatterns){
        this.setIgnoreAuthPatterns(ignoreAuthPatterns);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI memo(String memo){
        this.setMemo(memo);
        return this;
    }

    /**
     * <B>NAMINGSERVICE</B>&nbsp;命名服务
     * <P>
     * 字符串：最大长度 60
     */
    public final static String FIELD_NAMINGSERVICE = "namingservice";
     ...
     * 
     */
    @JsonProperty(FIELD_NAMINGSERVICE)
    public void setNamingService(String namingService){
        this.set(FIELD_NAMINGSERVICE, namingService);
    }
    ...
    public String getNamingService(){
        Object objValue = this.get(FIELD_NAMINGSERVICE);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isNamingServiceDirty(){
        if(this.contains(FIELD_NAMINGSERVICE)){
            return true;
        }
        return false;
    }
    ...
    public void resetNamingService(){
        this.reset(FIELD_NAMINGSERVICE);
    }

    /**
     * 设置 命名服务
     * <P>
     * 等同 {@link #setNamingService}
     * @param namingService
     */
    @JsonIgnore
    public PSSysServiceAPI namingservice(String namingService){
        this.setNamingService(namingService);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI outpssystranslatorid(String outPSSysTranslatorId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI outpssystranslatorid(PSSysTranslator pSSysTranslator){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI outpssystranslatorname(String outPSSysTranslatorName){
        this.setOutPSSysTranslatorName(outPSSysTranslatorName);
        return this;
    }

    /**
     * <B>PREDEFINEDTYPE</B>&nbsp;预定义类型，指定服务接口的预定义类型
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPIPredefinedType} 
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI predefinedtype(String predefinedType){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI predefinedtype(net.ibizsys.psmodel.core.util.PSModelEnums.ServiceAPIPredefinedType predefinedType){
    ...
    /**
     * <B>PSMODULEID</B>&nbsp;系统模块，指定服务接口所属模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI psmoduleid(PSModule pSModule){
        if(pSModule == null){
    ...
    /**
     * <B>PSMODULENAME</B>&nbsp;系统模块，指定服务接口所属模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI psmodulename(String pSModuleName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysdynamodelid(String pSSysDynaModelId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysdynamodelid(PSSysDynaModel pSSysDynaModel){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysdynamodelname(String pSSysDynaModelName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysreqitemid(String pSSysReqItemId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysreqitemid(PSSysReqItem pSSysReqItem){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysreqitemname(String pSSysReqItemName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysresourceid(String pSSysResourceId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysresourceid(PSSysResource pSSysResource){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysresourcename(String pSSysResourceName){
        this.setPSSysResourceName(pSSysResourceName);
        return this;
    }

    /**
     * <B>PSSYSSAHANDLERID</B>&nbsp;服务接口处理器，指定系统服务接口的处理对象
     * <P>
    ...
    /**
     * 设置 服务接口处理器，详细说明：{@link #FIELD_PSSYSSAHANDLERID}
     * 
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssyssahandlerid(String pSSysSAHandlerId){
        this.setPSSysSAHandlerId(pSSysSAHandlerId);
        return this;
    }

    /**
     * 设置 服务接口处理器，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSSysSAHandlerId}
     * @param pSSysSAHandler 引用对象
     */
    @JsonIgnore
    public PSSysServiceAPI pssyssahandlerid(PSSysSAHandler pSSysSAHandler){
    ...
    /**
     * <B>PSSYSSAHANDLERNAME</B>&nbsp;接口处理器，指定系统服务接口的处理对象
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssyssahandlername(String pSSysSAHandlerName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysserviceapiid(String pSSysServiceAPIId){
        this.setPSSysServiceAPIId(pSSysServiceAPIId);
        return this;
    }

    /**
     * <B>PSSYSSERVICEAPINAME</B>&nbsp;服务接口名称，指定服务接口的名称，需在所在模型域（系统模块或系统）中具备唯一性
     * <P>
     * 字符串：最大长度 200
     */
    ...
    /**
     * 设置 服务接口名称，详细说明：{@link #FIELD_PSSYSSERVICEAPINAME}
     * 
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssysserviceapiname(String pSSysServiceAPIName){
    ...
    public String getName(){
        return this.getPSSysServiceAPIName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSSysServiceAPIName(strName);
    }

    @JsonIgnore
    public PSSysServiceAPI name(String strName){
        this.setPSSysServiceAPIName(strName);
        return this;
    }

    /**
     * <B>PSSYSSFPLUGINID</B>&nbsp;后台扩展插件，指定服务接口的后台模板扩展插件，用于扩展服务接口代码
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSSysSFPlugin} 
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
        if(pSSysSFPlugin == null){
    ...
    /**
     * <B>PSSYSSFPLUGINNAME</B>&nbsp;后台扩展插件，指定服务接口的后台模板扩展插件，用于扩展服务接口代码
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI pssyssfpluginname(String pSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI resetdefactioncodename(Integer resetDefActionCodeName){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI resetdefactioncodename(Boolean resetDefActionCodeName){
    ...
    /**
     * <B>SERVICECODENAME</B>&nbsp;服务代码标识，指定服务接口的服务代码标识，未定义时使用接口的【代码标识】
     * <P>
     * 字符串：最大长度 50
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI servicecodename(String serviceCodeName){
        this.setServiceCodeName(serviceCodeName);
        return this;
    }

    /**
     * <B>SERVICEDTOFLAG</B>&nbsp;使用DTO
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.YesNo} 
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI servicedtoflag(Integer serviceDTOFlag){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI servicedtoflag(Boolean serviceDTOFlag){
    ...
    /**
     * <B>SERVICEPARAM</B>&nbsp;服务参数，指定服务接口的参数，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI serviceparam(String serviceParam){
        this.setServiceParam(serviceParam);
        return this;
    }

    /**
     * <B>SERVICEPARAM2</B>&nbsp;服务参数2，指定服务接口的参数2，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI serviceparam2(String serviceParam2){
        this.setServiceParam2(serviceParam2);
        return this;
    }

    /**
     * <B>SERVICEPARAM3</B>&nbsp;服务参数3，指定服务接口的参数3，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI serviceparam3(String serviceParam3){
        this.setServiceParam3(serviceParam3);
        return this;
    }

    /**
     * <B>SERVICEPARAM4</B>&nbsp;服务参数4，指定服务接口的参数4，支持在运行环境进行配置调整
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI serviceparam4(String serviceParam4){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI serviceparams(String serviceParams){
        this.setServiceParams(serviceParams);
        return this;
    }

    /**
     * <B>SERVICETYPE</B>&nbsp;服务类型，指定服务接口的服务类型，未指定时为【默认】
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI servicetype(String serviceType){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI servicetype(net.ibizsys.psmodel.core.util.PSModelEnums.ServiceType serviceType){
        if(serviceType == null){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI uniquetag(String uniqueTag){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI validflag(Boolean validFlag){
        if(validFlag == null){
     ...
     */
    @JsonIgnore
    public PSSysServiceAPI ver(Integer ver){
        this.setVer(ver);
        return this;
    }
    ...
    @JsonIgnore
    public PSSysServiceAPI id(String strValue){
        this.setPSSysServiceAPIId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysServiceAPI){
            PSSysServiceAPI model = (PSSysServiceAPI)iPSModel;
        }
