...
public class PSSysDELogicNode extends net.ibizsys.psmodel.core.util.PSModelBase {
    ...
    public PSSysDELogicNode(){
    }      

    /**
     * <B>CODENAME</B>&nbsp;代码标识，指定系统处理逻辑的代码标识，需要在所在的模型域（系统模块或系统）中具有唯一性
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode custommode(Integer customMode){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode custommode(net.ibizsys.psmodel.core.util.PSModelEnums.ScriptMode customMode){
        if(customMode == null){
    ...
    /**
     * <B>CUSTOMOBJ</B>&nbsp;自定义对象，指定处理逻辑的程序对象名称，一般为组件的完全名称
     * <P>
     * 字符串：最大长度 250
     */
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode customobj(String customObj){
        this.setCustomObj(customObj);
        return this;
    }

    /**
     * <B>CUSTOMPARAMS</B>&nbsp;自定义参数，指定传入功能组件的参数
     * <P>
     * 字符串：最大长度 4000
     */
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode customparams(String customParams){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode logictag(String logicTag){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode logictag2(String logicTag2){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode memo(String memo){
        this.setMemo(memo);
        return this;
    }

    /**
     * <B>PSMODULEID</B>&nbsp;系统模块，指定系统处理逻辑所在的系统模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode psmoduleid(PSModule pSModule){
        if(pSModule == null){
    ...
    /**
     * <B>PSMODULENAME</B>&nbsp;系统模块，指定系统处理逻辑所在的系统模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode psmodulename(String pSModuleName){
        this.setPSModuleName(pSModuleName);
        return this;
    }

    /**
     * <B>PSSYSDELOGICNODEID</B>&nbsp;系统逻辑处理节点标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysdelogicnodeid(String pSSysDELogicNodeId){
        this.setPSSysDELogicNodeId(pSSysDELogicNodeId);
        return this;
    }

    /**
     * <B>PSSYSDELOGICNODENAME</B>&nbsp;处理逻辑名称，指定系统处理逻辑的名称，需要在所在的模型域（系统模块或系统）中具有唯一性
     * <P>
     * 字符串：最大长度 200
     */
    ...
    /**
     * 设置 处理逻辑名称，详细说明：{@link #FIELD_PSSYSDELOGICNODENAME}
     * 
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysdelogicnodename(String pSSysDELogicNodeName){
    ...
    public String getName(){
        return this.getPSSysDELogicNodeName();
    }

    @JsonIgnore
    public void setName(String strName){
        this.setPSSysDELogicNodeName(strName);
    }

    @JsonIgnore
    public PSSysDELogicNode name(String strName){
        this.setPSSysDELogicNodeName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysdynamodelid(String pSSysDynaModelId){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysdynamodelid(PSSysDynaModel pSSysDynaModel){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysdynamodelname(String pSSysDynaModelName){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysreqitemid(String pSSysReqItemId){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysreqitemid(PSSysReqItem pSSysReqItem){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssysreqitemname(String pSSysReqItemName){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode pssyssfpluginname(String pSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysDELogicNode usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSSysDELogicNode id(String strValue){
        this.setPSSysDELogicNodeId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysDELogicNode){
            PSSysDELogicNode model = (PSSysDELogicNode)iPSModel;
        }
