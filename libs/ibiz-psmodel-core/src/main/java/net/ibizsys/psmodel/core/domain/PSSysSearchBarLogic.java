 ...
 * 
 */
public class PSSysSearchBarLogic extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSSysSearchBarLogic(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic dstlogictype(net.ibizsys.psmodel.core.util.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdelogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdename(String pSDEName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdeuiactionid(PSDEUIAction pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyspfpluginid(PSSysPFPlugin pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbarid(String pSSysSearchBarId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbarid(PSSysSearchBar pSSysSearchBar){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSSysSearchBarItem} 
     */
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbaritemid(String pSSysSearchBarItemId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbaritemid(PSSysSearchBarItem pSSysSearchBarItem){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbaritemname(String pSSysSearchBarItemName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbarlogicid(String pSSysSearchBarLogicId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbarlogicname(String pSSysSearchBarLogicName){
    ...
    @JsonIgnore
    public PSSysSearchBarLogic name(String strName){
        this.setPSSysSearchBarLogicName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssyssearchbarname(String pSSysSearchBarName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssysviewlogicid(PSSysViewLogic pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssysviewpanelid(PSSysViewPanel pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic triggertype(net.ibizsys.psmodel.core.util.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSSysSearchBarLogic validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSSysSearchBarLogic id(String strValue){
        this.setPSSysSearchBarLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysSearchBarLogic){
            PSSysSearchBarLogic model = (PSSysSearchBarLogic)iPSModel;
        }
