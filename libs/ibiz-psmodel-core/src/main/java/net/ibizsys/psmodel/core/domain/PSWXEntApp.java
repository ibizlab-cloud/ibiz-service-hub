 ...
 */
public class PSWXEntApp extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.WXAppType} 
     */
     ...
     */
    @JsonIgnore
    public PSWXEntApp apptype(String appType){
     ...
     */
    @JsonIgnore
    public PSWXEntApp apptype(net.ibizsys.psmodel.core.util.PSModelEnums.WXAppType appType){
        if(appType == null){
     ...
     */
    @JsonIgnore
    public PSWXEntApp appurl(String appUrl){
     ...
     */
    @JsonIgnore
    public PSWXEntApp codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSWXEntApp createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSWXEntApp createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSWXEntApp memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSWXEntApp ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssysappid(String pSSysAppId){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssysappid(PSSysApp pSSysApp){
        if(pSSysApp == null){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssysappname(String pSSysAppName){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssysresourceid(String pSSysResourceId){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssysresourceid(PSSysResource pSSysResource){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssysresourcename(String pSSysResourceName){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pssyssfpluginname(String pSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pswxaccountid(String pSWXAccountId){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pswxaccountid(PSWXAccount pSWXAccount){
        if(pSWXAccount == null){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pswxaccountname(String pSWXAccountName){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pswxentappid(String pSWXEntAppId){
     ...
     */
    @JsonIgnore
    public PSWXEntApp pswxentappname(String pSWXEntAppName){
    ...
    @JsonIgnore
    public PSWXEntApp name(String strName){
        this.setPSWXEntAppName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSWXEntApp repenterflag(Integer repEnterFlag){
     ...
     */
    @JsonIgnore
    public PSWXEntApp repenterflag(Boolean repEnterFlag){
     ...
     */
    @JsonIgnore
    public PSWXEntApp replocationflag(Integer repLocationFlag){
     ...
     */
    @JsonIgnore
    public PSWXEntApp replocationflag(Boolean repLocationFlag){
     ...
     */
    @JsonIgnore
    public PSWXEntApp updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSWXEntApp updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSWXEntApp usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSWXEntApp usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSWXEntApp usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSWXEntApp usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSWXEntApp usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSWXEntApp usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSWXEntApp validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSWXEntApp validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    /**
     * <B>WXENTAPPPARAMS</B>&nbsp;应用参数
     */
    public final static String FIELD_WXENTAPPPARAMS = "wxentappparams";

    /**
     * 设置 应用参数
     * 
     * @param wXEntAppParams
     * 
     */
    @JsonProperty(FIELD_WXENTAPPPARAMS)
    public void setWXEntAppParams(String wXEntAppParams){
        this.set(FIELD_WXENTAPPPARAMS, wXEntAppParams);
    }
    ...
    public String getWXEntAppParams(){
        Object objValue = this.get(FIELD_WXENTAPPPARAMS);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isWXEntAppParamsDirty(){
        if(this.contains(FIELD_WXENTAPPPARAMS)){
            return true;
        }
        return false;
    }
    ...
    public void resetWXEntAppParams(){
        this.reset(FIELD_WXENTAPPPARAMS);
    }

    /**
     * 设置 应用参数
     * <P>
     * 等同 {@link #setWXEntAppParams}
     * @param wXEntAppParams
     */
    @JsonIgnore
    public PSWXEntApp wxentappparams(String wXEntAppParams){
    ...
    @JsonIgnore
    public PSWXEntApp id(String strValue){
        this.setPSWXEntAppId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSWXEntApp){
            PSWXEntApp model = (PSWXEntApp)iPSModel;
        }
