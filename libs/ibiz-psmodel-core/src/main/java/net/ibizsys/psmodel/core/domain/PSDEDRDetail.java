...
public class PSDEDRDetail extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     */
    @JsonIgnore
    public PSDEDRDetail pssysuniresid(String pSSysUniResId){
     ...
     */
    @JsonIgnore
    public PSDEDRDetail pssysuniresid(PSSysUniRes pSSysUniRes){
        if(pSSysUniRes == null){
     ...
     */
    @JsonIgnore
    public PSDEDRDetail pssysuniresname(String pSSysUniResName){
