 ...
 * 系统的代码表项模型，支持定义层级代码项
 */
public class PSCodeItem extends net.ibizsys.psmodel.core.util.PSModelBase {
     ...
     */
    @JsonIgnore
    public PSCodeItem beginvalue(BigDecimal beginValue){
     ...
     */
    @JsonIgnore
    public PSCodeItem bkcolor(String bKColor){
     ...
     */
    @JsonIgnore
    public PSCodeItem codeitemvalue(String codeItemValue){
     ...
     */
    @JsonIgnore
    public PSCodeItem codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSCodeItem color(String color){
        this.setColor(color);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSCodeItem createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSCodeItem createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSCodeItem cssclass(String cssClass){
     ...
     */
    @JsonIgnore
    public PSCodeItem data(String data){
        this.setData(data);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSCodeItem defaultflag(Integer defaultFlag){
     ...
     */
    @JsonIgnore
    public PSCodeItem defaultflag(Boolean defaultFlag){
        if(defaultFlag == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem disableselect(Integer disableSelect){
     ...
     */
    @JsonIgnore
    public PSCodeItem disableselect(Boolean disableSelect){
     ...
     */
    @JsonIgnore
    public PSCodeItem endvalue(BigDecimal endValue){
     ...
     */
    @JsonIgnore
    public PSCodeItem iconcls(String iconCls){
     ...
     */
    @JsonIgnore
    public PSCodeItem incbeginvalue(Integer incBeginValue){
     ...
     */
    @JsonIgnore
    public PSCodeItem incbeginvalue(Boolean incBeginValue){
     ...
     */
    @JsonIgnore
    public PSCodeItem incendvalue(Integer incEndValue){
     ...
     */
    @JsonIgnore
    public PSCodeItem incendvalue(Boolean incEndValue){
        if(incEndValue == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSCodeItem ordervalue(Integer orderValue){
     ...
     * <P>
     * 引用连接属性：对象&nbsp;{@link net.ibizsys.psmodel.core.domain.PSCodeItem} 
     */
     ...
     */
    @JsonIgnore
    public PSCodeItem ppscodeitemid(String pPSCodeItemId){
     ...
     */
    @JsonIgnore
    public PSCodeItem ppscodeitemid(PSCodeItem pSCodeItem){
        if(pSCodeItem == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem ppscodeitemname(String pPSCodeItemName){
     ...
     */
    @JsonIgnore
    public PSCodeItem pscodeitemid(String pSCodeItemId){
     ...
     */
    @JsonIgnore
    public PSCodeItem pscodeitemname(String pSCodeItemName){
    ...
    @JsonIgnore
    public PSCodeItem name(String strName){
        this.setPSCodeItemName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSCodeItem pscodelistid(String pSCodeListId){
     ...
     */
    @JsonIgnore
    public PSCodeItem pscodelistid(PSCodeList pSCodeList){
        if(pSCodeList == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem pscodelistname(String pSCodeListName){
     ...
     */
    @JsonIgnore
    public PSCodeItem pssyscssid(String pSSysCssId){
     ...
     */
    @JsonIgnore
    public PSCodeItem pssyscssid(PSSysCss pSSysCss){
        if(pSSysCss == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem pssyscssname(String pSSysCssName){
     ...
     */
    @JsonIgnore
    public PSCodeItem pssysimageid(String pSSysImageId){
     ...
     */
    @JsonIgnore
    public PSCodeItem pssysimageid(PSSysImage pSSysImage){
        if(pSSysImage == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem pssysimagename(String pSSysImageName){
     ...
     */
    @JsonIgnore
    public PSCodeItem shortkey(String shortKey){
        this.setShortKey(shortKey);
        return this;
    }

    /**
     * <B>SHOWASALL</B>&nbsp;作为全部显示内容
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.YesNo} 
     */
    public final static String FIELD_SHOWASALL = "showasall";
     ...
     * 
     */
    @JsonProperty(FIELD_SHOWASALL)
    public void setShowAsAll(Integer showAsAll){
        this.set(FIELD_SHOWASALL, showAsAll);
    }
    ...
    public Integer getShowAsAll(){
        Object objValue = this.get(FIELD_SHOWASALL);
        if(objValue==null){
            return null;
        }
        return (Integer)objValue;
    ...
    /**
     * 判断 作为全部显示内容 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isShowAsAllDirty(){
        if(this.contains(FIELD_SHOWASALL)){
            return true;
        }
        return false;
    }
    ...
    public void resetShowAsAll(){
        this.reset(FIELD_SHOWASALL);
    }

    /**
     * 设置 作为全部显示内容
     * <P>
     * 等同 {@link #setShowAsAll}
     * @param showAsAll
     */
    @JsonIgnore
    public PSCodeItem showasall(Integer showAsAll){
     ...
     */
    @JsonIgnore
    public PSCodeItem showasall(Boolean showAsAll){
        if(showAsAll == null){
            this.setShowAsAll(null);
        }
        else{
            this.setShowAsAll(showAsAll?BOOLEAN_TRUE:BOOLEAN_FALSE);
        }
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSCodeItem showasempty(Integer showAsEmpty){
     ...
     */
    @JsonIgnore
    public PSCodeItem showasempty(Boolean showAsEmpty){
        if(showAsEmpty == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem textpslanresid(String textPSLanResId){
     ...
     */
    @JsonIgnore
    public PSCodeItem textpslanresid(PSLanguageRes pSLanguageRes){
     ...
     */
    @JsonIgnore
    public PSCodeItem textpslanresname(String textPSLanResName){
     ...
     */
    @JsonIgnore
    public PSCodeItem thresholdgroupflag(Integer thresholdGroupFlag){
     ...
     */
    @JsonIgnore
    public PSCodeItem tippslanresid(String tipPSLanResId){
     ...
     */
    @JsonIgnore
    public PSCodeItem tippslanresid(PSLanguageRes pSLanguageRes){
        if(pSLanguageRes == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem tippslanresname(String tipPSLanResName){
     ...
     */
    @JsonIgnore
    public PSCodeItem tooltipinfo(String tooltipInfo){
     ...
     */
    @JsonIgnore
    public PSCodeItem updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSCodeItem updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSCodeItem usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSCodeItem usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSCodeItem userdata(String userData){
     ...
     */
    @JsonIgnore
    public PSCodeItem userdata2(String userData2){
     ...
     */
    @JsonIgnore
    public PSCodeItem userparams(String userParams){
     ...
     */
    @JsonIgnore
    public PSCodeItem usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSCodeItem usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSCodeItem usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSCodeItem usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSCodeItem validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSCodeItem validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSCodeItem id(String strValue){
        this.setPSCodeItemId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSCodeItem){
            PSCodeItem model = (PSCodeItem)iPSModel;
