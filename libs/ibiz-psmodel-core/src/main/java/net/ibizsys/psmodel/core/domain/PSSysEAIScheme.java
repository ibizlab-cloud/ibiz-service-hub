...
/**
 * <B>PSSYSEAISCHEME</B>应用集成体系 模型传输对象
 * <P>
 * 
 */
public class PSSysEAIScheme extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSSysEAIScheme(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme createman(String createMan){
        this.setCreateMan(createMan);
        return this;
    }

    /**
     * <B>EAISCHEMETAG</B>&nbsp;体系标记
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_EAISCHEMETAG = "eaischemetag";
     ...
     * 
     */
    @JsonProperty(FIELD_EAISCHEMETAG)
    public void setEAISchemeTag(String eAISchemeTag){
        this.set(FIELD_EAISCHEMETAG, eAISchemeTag);
    }
    ...
    public String getEAISchemeTag(){
        Object objValue = this.get(FIELD_EAISCHEMETAG);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isEAISchemeTagDirty(){
        if(this.contains(FIELD_EAISCHEMETAG)){
            return true;
        }
        return false;
    }
    ...
    public void resetEAISchemeTag(){
        this.reset(FIELD_EAISCHEMETAG);
    }

    /**
     * 设置 体系标记
     * <P>
     * 等同 {@link #setEAISchemeTag}
     * @param eAISchemeTag
     */
    @JsonIgnore
    public PSSysEAIScheme eaischemetag(String eAISchemeTag){
        this.setEAISchemeTag(eAISchemeTag);
        return this;
    }

    /**
     * <B>EAISCHEMETAG2</B>&nbsp;体系标记2
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_EAISCHEMETAG2 = "eaischemetag2";
     ...
     * 
     */
    @JsonProperty(FIELD_EAISCHEMETAG2)
    public void setEAISchemeTag2(String eAISchemeTag2){
        this.set(FIELD_EAISCHEMETAG2, eAISchemeTag2);
    }
    ...
    public String getEAISchemeTag2(){
        Object objValue = this.get(FIELD_EAISCHEMETAG2);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isEAISchemeTag2Dirty(){
        if(this.contains(FIELD_EAISCHEMETAG2)){
            return true;
        }
        return false;
    }
    ...
    public void resetEAISchemeTag2(){
        this.reset(FIELD_EAISCHEMETAG2);
    }

    /**
     * 设置 体系标记2
     * <P>
     * 等同 {@link #setEAISchemeTag2}
     * @param eAISchemeTag2
     */
    @JsonIgnore
    public PSSysEAIScheme eaischemetag2(String eAISchemeTag2){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme enableserviceapi(Integer enableServiceAPI){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme enableserviceapi(Boolean enableServiceAPI){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme enablesubsysserviceapi(Integer enableSubSysServiceAPI){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme enablesubsysserviceapi(Boolean enableSubSysServiceAPI){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme psmoduleid(PSModule pSModule){
        if(pSModule == null){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme psmodulename(String pSModuleName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssubsysserviceapiid(String pSSubSysServiceAPIId){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssubsysserviceapiid(PSSubSysServiceAPI pSSubSysServiceAPI){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssubsysserviceapiname(String pSSubSysServiceAPIName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssysdynamodelid(String pSSysDynaModelId){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssysdynamodelid(PSSysDynaModel pSSysDynaModel){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssysdynamodelname(String pSSysDynaModelName){
        this.setPSSysDynaModelName(pSSysDynaModelName);
        return this;
    }

    /**
     * <B>PSSYSEAISCHEMEID</B>&nbsp;系统应用集成体系标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssyseaischemeid(String pSSysEAISchemeId){
        this.setPSSysEAISchemeId(pSSysEAISchemeId);
        return this;
    }

    /**
     * <B>PSSYSEAISCHEMENAME</B>&nbsp;集成体系名称
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssyseaischemename(String pSSysEAISchemeName){
    ...
    @JsonIgnore
    public PSSysEAIScheme name(String strName){
        this.setPSSysEAISchemeName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssysserviceapiid(String pSSysServiceAPIId){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssysserviceapiid(PSSysServiceAPI pSSysServiceAPI){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssysserviceapiname(String pSSysServiceAPIName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme pssyssfpluginname(String pSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme schemeparams(String schemeParams){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme servicecodename(String serviceCodeName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme subsysservicecodename(String subSysServiceCodeName){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysEAIScheme usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSSysEAIScheme id(String strValue){
        this.setPSSysEAISchemeId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysEAIScheme){
            PSSysEAIScheme model = (PSSysEAIScheme)iPSModel;
        }
