 ...
 */
public class PSSysSearchDoc extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSSysSearchDoc(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc createman(String createMan){
        this.setCreateMan(createMan);
        return this;
    }

    /**
     * <B>DEFAULTMODE</B>&nbsp;默认文档
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc defaultmode(Integer defaultMode){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc defaultmode(Boolean defaultMode){
        if(defaultMode == null){
     ...
     * <B>DOCPARAMS</B>&nbsp;文档参数
     */
    public final static String FIELD_DOCPARAMS = "docparams";
     ...
     * 
     */
    @JsonProperty(FIELD_DOCPARAMS)
    public void setDocParams(String docParams){
        this.set(FIELD_DOCPARAMS, docParams);
    }
    ...
    public String getDocParams(){
        Object objValue = this.get(FIELD_DOCPARAMS);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isDocParamsDirty(){
        if(this.contains(FIELD_DOCPARAMS)){
            return true;
        }
        return false;
    }
    ...
    public void resetDocParams(){
        this.reset(FIELD_DOCPARAMS);
    }

    /**
     * 设置 文档参数
     * <P>
     * 等同 {@link #setDocParams}
     * @param docParams
     */
    @JsonIgnore
    public PSSysSearchDoc docparams(String docParams){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc doctag(String docTag){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc doctag2(String docTag2){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc logicname(String logicName){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc pssyssearchdocid(String pSSysSearchDocId){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc pssyssearchdocname(String pSSysSearchDocName){
    ...
    @JsonIgnore
    public PSSysSearchDoc name(String strName){
        this.setPSSysSearchDocName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc pssyssearchschemeid(String pSSysSearchSchemeId){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc pssyssearchschemeid(PSSysSearchScheme pSSysSearchScheme){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc pssyssearchschemename(String pSSysSearchSchemeName){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc replicas(Integer replicas){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc shards(Integer shards){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSSysSearchDoc validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSSysSearchDoc id(String strValue){
        this.setPSSysSearchDocId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysSearchDoc){
            PSSysSearchDoc model = (PSSysSearchDoc)iPSModel;
        }
