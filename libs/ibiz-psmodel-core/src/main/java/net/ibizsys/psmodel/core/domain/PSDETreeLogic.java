...
/**
 * <B>PSDETREELOGIC</B>实体树视图逻辑 模型传输对象
 * <P>
 * 
 */
public class PSDETreeLogic extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSDETreeLogic(){
        this.setValidFlag(1);
    }      
     ...
     */
    @JsonIgnore
    public PSDETreeLogic attrname(String attrName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic customcode(String customCode){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic dstlogictype(String dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic dstlogictype(net.ibizsys.psmodel.core.util.PSModelEnums.TargetUILogic dstLogicType){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic eventarg(String eventArg){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic eventarg2(String eventArg2){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic eventnames(String eventNames){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDETreeLogic ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdelogicid(String pSDELogicId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdelogicid(PSDELogic pSDELogic){
        if(pSDELogic == null){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdelogicname(String pSDELogicName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdename(String pSDEName){
        this.setPSDEName(pSDEName);
        return this;
    }

    /**
     * <B>PSDETREECOLID</B>&nbsp;树表格列
     * <P>
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreecolid(String pSDETreeColId){
        this.setPSDETreeColId(pSDETreeColId);
        return this;
    }

    /**
     * 设置 树表格列，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSDETreeColId}
     * @param pSDETreeCol 引用对象
     */
    @JsonIgnore
    public PSDETreeLogic psdetreecolid(PSDETreeCol pSDETreeCol){
        if(pSDETreeCol == null){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreecolname(String pSDETreeColName){
        this.setPSDETreeColName(pSDETreeColName);
        return this;
    }

    /**
     * <B>PSDETREELOGICID</B>&nbsp;实体树实体逻辑标识
     * <P>
     * 字符串：最大长度 100
     */
    public final static String FIELD_PSDETREELOGICID = "psdetreelogicid";

    /**
     * 设置 实体树实体逻辑标识
     * 
     * @param pSDETreeLogicId
     * 
     */
    @JsonProperty(FIELD_PSDETREELOGICID)
    public void setPSDETreeLogicId(String pSDETreeLogicId){
        this.set(FIELD_PSDETREELOGICID, pSDETreeLogicId);
    }
    ...
    public String getPSDETreeLogicId(){
        Object objValue = this.get(FIELD_PSDETREELOGICID);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    /**
     * 判断 实体树实体逻辑标识 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isPSDETreeLogicIdDirty(){
        if(this.contains(FIELD_PSDETREELOGICID)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDETreeLogicId(){
        this.reset(FIELD_PSDETREELOGICID);
    }

    /**
     * 设置 实体树实体逻辑标识
     * <P>
     * 等同 {@link #setPSDETreeLogicId}
     * @param pSDETreeLogicId
     */
    @JsonIgnore
    public PSDETreeLogic psdetreelogicid(String pSDETreeLogicId){
        this.setPSDETreeLogicId(pSDETreeLogicId);
        return this;
    }

    /**
     * <B>PSDETREELOGICNAME</B>&nbsp;逻辑标识
     * <P>
     * 字符串：最大长度 30，由字母、数字、下划线组成，且开始必须为字母
     */
    public final static String FIELD_PSDETREELOGICNAME = "psdetreelogicname";

    /**
     * 设置 逻辑标识
     * 
     * @param pSDETreeLogicName
     * 
     */
    @JsonProperty(FIELD_PSDETREELOGICNAME)
    public void setPSDETreeLogicName(String pSDETreeLogicName){
        this.set(FIELD_PSDETREELOGICNAME, pSDETreeLogicName);
    }
    ...
    public String getPSDETreeLogicName(){
        Object objValue = this.get(FIELD_PSDETREELOGICNAME);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPSDETreeLogicNameDirty(){
        if(this.contains(FIELD_PSDETREELOGICNAME)){
            return true;
        }
        return false;
    }
    ...
    public void resetPSDETreeLogicName(){
        this.reset(FIELD_PSDETREELOGICNAME);
    }

    /**
     * 设置 逻辑标识
     * <P>
     * 等同 {@link #setPSDETreeLogicName}
     * @param pSDETreeLogicName
     */
    @JsonIgnore
    public PSDETreeLogic psdetreelogicname(String pSDETreeLogicName){
    ...
    @JsonIgnore
    public PSDETreeLogic name(String strName){
        this.setPSDETreeLogicName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreenodeid(String pSDETreeNodeId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreenodeid(PSDETreeNode pSDETreeNode){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreenodename(String pSDETreeNodeName){
        this.setPSDETreeNodeName(pSDETreeNodeName);
        return this;
    }

    /**
     * <B>PSDETREEVIEWID</B>&nbsp;树视图
     * <P>
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreeviewid(String pSDETreeViewId){
        this.setPSDETreeViewId(pSDETreeViewId);
        return this;
    }

    /**
     * 设置 树视图，包括引用对象的其它关系属性
     * <P>
     * 等同 {@link #setPSDETreeViewId}
     * @param pSDETreeView 引用对象
     */
    @JsonIgnore
    public PSDETreeLogic psdetreeviewid(PSDETreeView pSDETreeView){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdetreeviewname(String pSDETreeViewName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdeuiactionid(String pSDEUIActionId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdeuiactionid(PSDEUIAction pSDEUIAction){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic psdeuiactionname(String pSDEUIActionName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssyspfpluginid(String pSSysPFPluginId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssyspfpluginid(PSSysPFPlugin pSSysPFPlugin){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssyspfpluginname(String pSSysPFPluginName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssysviewlogicid(String pSSysViewLogicId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssysviewlogicid(PSSysViewLogic pSSysViewLogic){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssysviewlogicname(String pSSysViewLogicName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssysviewpanelid(String pSSysViewPanelId){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssysviewpanelid(PSSysViewPanel pSSysViewPanel){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic pssysviewpanelname(String pSSysViewPanelName){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic timer(Integer timer){
        this.setTimer(timer);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDETreeLogic triggertype(String triggerType){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic triggertype(net.ibizsys.psmodel.core.util.PSModelEnums.ViewLogicTrigger triggerType){
        if(triggerType == null){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDETreeLogic validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSDETreeLogic id(String strValue){
        this.setPSDETreeLogicId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDETreeLogic){
            PSDETreeLogic model = (PSDETreeLogic)iPSModel;
        }
