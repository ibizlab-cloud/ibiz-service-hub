...
/**
 * <B>PSDEGROUP</B>实体组 模型传输对象
 * <P>
 * 实体组模型，定义包含实体的组对象
 */
public class PSDEGroup extends net.ibizsys.psmodel.core.util.PSModelBase {
    ...
    /**
     * <B>CODENAME</B>&nbsp;代码标识，指定实体组的代码标识，需要在所在的模型域（实体、系统模块或系统）中具有唯一性
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEGroup codename(String codeName){
        this.setCodeName(codeName);
        return this;
    }

    /**
     * <B>CODENAME2</B>&nbsp;代码标识2，指定实体组的代码标识2，需要在所在的模型域（实体、系统模块或系统）中具有唯一性
     * <P>
     * 字符串：最大长度 50，由字母、数字、下划线组成，且开始必须为字母
     */
     ...
     */
    @JsonIgnore
    public PSDEGroup codename2(String codeName2){
     ...
     */
    @JsonIgnore
    public PSDEGroup createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSDEGroup createman(String createMan){
        this.setCreateMan(createMan);
        return this;
    }

    /**
     * <B>GROUPCAT</B>&nbsp;实体组分类，指定实体组的分类
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.DEGroupCat} 
     */
    public final static String FIELD_GROUPCAT = "groupcat";

    /**
     * 设置 实体组分类，详细说明：{@link #FIELD_GROUPCAT}
     * 
     * @param groupCat
     * 
     */
    @JsonProperty(FIELD_GROUPCAT)
    public void setGroupCat(String groupCat){
        this.set(FIELD_GROUPCAT, groupCat);
    }
    ...
    public String getGroupCat(){
        Object objValue = this.get(FIELD_GROUPCAT);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isGroupCatDirty(){
        if(this.contains(FIELD_GROUPCAT)){
            return true;
        }
        return false;
    }
     ...
     */
    @JsonIgnore
    public PSDEGroup groupcat(String groupCat){
     ...
     */
    @JsonIgnore
    public PSDEGroup groupcat(net.ibizsys.psmodel.core.util.PSModelEnums.DEGroupCat groupCat){
        if(groupCat == null){
     ...
     */
    @JsonIgnore
    public PSDEGroup grouptag(String groupTag){
     ...
     */
    @JsonIgnore
    public PSDEGroup grouptag2(String groupTag2){
        this.setGroupTag2(groupTag2);
        return this;
    }

    /**
     * <B>INITPSSYSDYNAMODELID</B>&nbsp;初始化模型，指定实体组成员的初始化模型，此配置为开发工具辅助模型
     * <P>
    ...
    /**
     * 设置 初始化模型，详细说明：{@link #FIELD_INITPSSYSDYNAMODELID}
     * 
     ...
     */
    @JsonIgnore
    public PSDEGroup initpssysdynamodelid(String initPSSysDynaModelId){
     ...
     */
    @JsonIgnore
    public PSDEGroup initpssysdynamodelid(PSSysDynaModel pSSysDynaModel){
    ...
    /**
     * <B>INITPSSYSDYNAMODELNAME</B>&nbsp;初始化模型，指定实体组成员的初始化模型，此配置为开发工具辅助模型
     * <P>
    ...
    /**
     * 设置 初始化模型，详细说明：{@link #FIELD_INITPSSYSDYNAMODELNAME}
     * 
     ...
     */
    @JsonIgnore
    public PSDEGroup initpssysdynamodelname(String initPSSysDynaModelName){
     ...
     * <B>LOGICMODE</B>&nbsp;逻辑模式
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.DEGroupLogicMode} 
     */
     ...
     */
    @JsonIgnore
    public PSDEGroup logicmode(String logicMode){
     ...
     */
    @JsonIgnore
    public PSDEGroup logicmode(net.ibizsys.psmodel.core.util.PSModelEnums.DEGroupLogicMode logicMode){
        if(logicMode == null){
     ...
     */
    @JsonIgnore
    public PSDEGroup logicparam(String logicParam){
     ...
     */
    @JsonIgnore
    public PSDEGroup logicparam2(String logicParam2){
     ...
     */
    @JsonIgnore
    public PSDEGroup memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSDEGroup ordervalue(Integer orderValue){
        this.setOrderValue(orderValue);
        return this;
    }

    /**
     * <B>PSDEGROUPID</B>&nbsp;实体组标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSDEGroup psdegroupid(String pSDEGroupId){
        this.setPSDEGroupId(pSDEGroupId);
        return this;
    }

    /**
     * <B>PSDEGROUPNAME</B>&nbsp;实体组名称，指定实体组的名称，需要在所在的模型域（实体、系统模块或系统）中具有唯一性
     * <P>
     * 字符串：最大长度 200
     */
    ...
    /**
     * 设置 实体组名称，详细说明：{@link #FIELD_PSDEGROUPNAME}
     * 
     * @param pSDEGroupName
     * 
     */
     ...
     */
    @JsonIgnore
    public PSDEGroup psdegroupname(String pSDEGroupName){
    ...
    @JsonIgnore
    public PSDEGroup name(String strName){
        this.setPSDEGroupName(strName);
        return this;
    }

    /**
     * <B>PSDEID</B>&nbsp;实体，指定实体组所在的实体对象
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEGroup psdeid(String pSDEId){
     ...
     */
    @JsonIgnore
    public PSDEGroup psdeid(PSDataEntity pSDataEntity){
     ...
     */
    @JsonIgnore
    public PSDEGroup psdename(String pSDEName){
        this.setPSDEName(pSDEName);
        return this;
    }

    /**
     * <B>PSMODULEID</B>&nbsp;系统模块，指定实体组所在的系统模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEGroup psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSDEGroup psmoduleid(PSModule pSModule){
        if(pSModule == null){
    ...
    /**
     * <B>PSMODULENAME</B>&nbsp;系统模块，指定实体组所在的系统模块
     * <P>
     ...
     */
    @JsonIgnore
    public PSDEGroup psmodulename(String pSModuleName){
     ...
     */
    @JsonIgnore
    public PSDEGroup pssysdynamodelid(String pSSysDynaModelId){
     ...
     */
    @JsonIgnore
    public PSDEGroup pssysdynamodelid(PSSysDynaModel pSSysDynaModel){
        if(pSSysDynaModel == null){
     ...
     */
    @JsonIgnore
    public PSDEGroup pssysdynamodelname(String pSSysDynaModelName){
     ...
     */
    @JsonIgnore
    public PSDEGroup pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSDEGroup pssyssfpluginid(PSSysSFPlugin pSSysSFPlugin){
     ...
     */
    @JsonIgnore
    public PSDEGroup pssyssfpluginname(String pSSysSFPluginName){
     ...
     */
    @JsonIgnore
    public PSDEGroup updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSDEGroup updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSDEGroup usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSDEGroup usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSDEGroup usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSDEGroup usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSDEGroup usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSDEGroup usertag4(String userTag4){
     ...
     */
    @JsonIgnore
    public PSDEGroup validflag(Integer validFlag){
     ...
     */
    @JsonIgnore
    public PSDEGroup validflag(Boolean validFlag){
        if(validFlag == null){
    ...
    @JsonIgnore
    public PSDEGroup id(String strValue){
        this.setPSDEGroupId(strValue);
        return this;
    }
     ...
     *  实体组成员 成员集合
     */
    public final static String FIELD_PSDEGROUPDETAILS = "psdegroupdetails";

    private java.util.List<net.ibizsys.psmodel.core.domain.PSDEGroupDetail> psdegroupdetails;

    /**
     * 获取 实体组成员 成员集合
     * @return
     */
    @JsonProperty(FIELD_PSDEGROUPDETAILS)
    public java.util.List<net.ibizsys.psmodel.core.domain.PSDEGroupDetail> getPSDEGroupDetails(){
        return this.psdegroupdetails;
    }

    /**
     * 设置 实体组成员 成员集合  
     * @param psdegroupdetails
     */
    @JsonProperty(FIELD_PSDEGROUPDETAILS)
    public void setPSDEGroupDetails(java.util.List<net.ibizsys.psmodel.core.domain.PSDEGroupDetail> psdegroupdetails){
        this.psdegroupdetails = psdegroupdetails;
    }

    /**
     * 获取 实体组成员 成员集合，不存在时建立集合对象
     * @return
     */
    @JsonIgnore
    public java.util.List<net.ibizsys.psmodel.core.domain.PSDEGroupDetail> getPSDEGroupDetailsIf(){
        if(this.psdegroupdetails == null){
            this.psdegroupdetails = new java.util.ArrayList<net.ibizsys.psmodel.core.domain.PSDEGroupDetail>();          
        }
        return this.psdegroupdetails;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSDEGroup){
            PSDEGroup model = (PSDEGroup)iPSModel;
            model.setPSDEGroupDetails(this.getPSDEGroupDetails());
        }
