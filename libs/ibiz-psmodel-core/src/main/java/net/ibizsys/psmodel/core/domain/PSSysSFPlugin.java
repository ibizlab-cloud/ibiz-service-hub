 ...
 */
public class PSSysSFPlugin extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSSysSFPlugin(){
    }      
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin codename(String codeName){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin createman(String createMan){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin keywords(String keywords){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin memo(String memo){
        this.setMemo(memo);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin ordervalue(Integer orderValue){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin paramdesc(String paramDesc){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin pluginmodel(String pluginModel){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin pluginparams(String pluginParams){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin plugintag(String pluginTag){
        this.setPluginTag(pluginTag);
        return this;
    }

    /**
     * <B>PLUGINTAG2</B>&nbsp;插件标识2
     * <P>
     * 字符串：最大长度 500
     */
    public final static String FIELD_PLUGINTAG2 = "plugintag2";
     ...
     * 
     */
    @JsonProperty(FIELD_PLUGINTAG2)
    public void setPluginTag2(String pluginTag2){
        this.set(FIELD_PLUGINTAG2, pluginTag2);
    }
    ...
    public String getPluginTag2(){
        Object objValue = this.get(FIELD_PLUGINTAG2);
        if(objValue==null){
            return null;
        }
        return (String)objValue;
    ...
    public boolean isPluginTag2Dirty(){
        if(this.contains(FIELD_PLUGINTAG2)){
            return true;
        }
        return false;
    }
    ...
    public void resetPluginTag2(){
        this.reset(FIELD_PLUGINTAG2);
    }

    /**
     * 设置 插件标识2
     * <P>
     * 等同 {@link #setPluginTag2}
     * @param pluginTag2
     */
    @JsonIgnore
    public PSSysSFPlugin plugintag2(String pluginTag2){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.SFPluginType} 
     */
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin plugintype(String pluginType){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin plugintype(net.ibizsys.psmodel.core.util.PSModelEnums.SFPluginType pluginType){
        if(pluginType == null){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin previewhtml(String previewHtml){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin psmoduleid(String pSModuleId){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin psmoduleid(PSModule pSModule){
        if(pSModule == null){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin psmodulename(String pSModuleName){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin pssfpluginid(String pSSFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin pssfpluginname(String pSSFPluginName){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin pssyssfpluginid(String pSSysSFPluginId){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin pssyssfpluginname(String pSSysSFPluginName){
    ...
    @JsonIgnore
    public PSSysSFPlugin name(String strName){
        this.setPSSysSFPluginName(strName);
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin repdefault(Integer repDefault){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin repdefault(Boolean repDefault){
        if(repDefault == null){
     ...
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.PluginRTMode} 
     */
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin rtobjectmode(Integer rTObjectMode){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin rtobjectmode(net.ibizsys.psmodel.core.util.PSModelEnums.PluginRTMode rTObjectMode){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin rtobjectname(String rTObjectName){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin rtobjectrepo(String rTObjectRepo){
        this.setRTObjectRepo(rTObjectRepo);
        return this;
    }

    /**
     * <B>SINGLEINSTMODE</B>&nbsp;单实例模式
     * <P>
     * 值参考&nbsp;{@link net.ibizsys.psmodel.core.util.PSModelEnums.YesNo} 
     */
    public final static String FIELD_SINGLEINSTMODE = "singleinstmode";

    /**
     * 设置 单实例模式
     * 
     * @param singleInstMode
     * 
     */
    @JsonProperty(FIELD_SINGLEINSTMODE)
    public void setSingleInstMode(Integer singleInstMode){
        this.set(FIELD_SINGLEINSTMODE, singleInstMode);
    }
    ...
    public Integer getSingleInstMode(){
        Object objValue = this.get(FIELD_SINGLEINSTMODE);
        if(objValue==null){
            return null;
        }
        return (Integer)objValue;
    ...
    public boolean isSingleInstModeDirty(){
        if(this.contains(FIELD_SINGLEINSTMODE)){
            return true;
        }
        return false;
    }
    ...
    public void resetSingleInstMode(){
        this.reset(FIELD_SINGLEINSTMODE);
    }

    /**
     * 设置 单实例模式
     * <P>
     * 等同 {@link #setSingleInstMode}
     * @param singleInstMode
     */
    @JsonIgnore
    public PSSysSFPlugin singleinstmode(Integer singleInstMode){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin singleinstmode(Boolean singleInstMode){
        if(singleInstMode == null){
            this.setSingleInstMode(null);
        }
        else{
            this.setSingleInstMode(singleInstMode?BOOLEAN_TRUE:BOOLEAN_FALSE);
        }
        return this;
    }
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin studioicon(String studioIcon){
        this.setStudioIcon(studioIcon);
        return this;
    }

    /**
     * <B>TEMPALTEFUNC</B>&nbsp;模板函数集合
     * <P>
     * 字符串：最大长度 500
     */
    public final static String FIELD_TEMPALTEFUNC = "tempaltefunc";
     ...
     * 
     */
    @JsonProperty(FIELD_TEMPALTEFUNC)
    public void setTempalteFunc(String tempalteFunc){
        this.set(FIELD_TEMPALTEFUNC, tempalteFunc);
        //属性名称与代码标识不一致，设置属性名称
        this.set("templatefunc", tempalteFunc);
    }
    ...
    public String getTempalteFunc(){
        Object objValue = this.get(FIELD_TEMPALTEFUNC);
        if(objValue==null){
            //属性名称与代码标识不一致，使用属性名称
            objValue = this.get("templatefunc");
            if(objValue == null){
                return null;
            }
        }
    ...
    /**
     * 判断 模板函数集合 是否指定值，包括空值
     * @return
     */
    @JsonIgnore
    public boolean isTempalteFuncDirty(){
        if(this.contains(FIELD_TEMPALTEFUNC)){
            return true;
        }
        //属性名称与代码标识不一致，判断属性名称
        if(this.contains("templatefunc")){
            return true;
        }
        return false;
    }
    ...
    public void resetTempalteFunc(){
        this.reset(FIELD_TEMPALTEFUNC);
        //属性名称与代码标识不一致，重置属性名称
        this.reset("templatefunc");
    }

    /**
     * 设置 模板函数集合
     * <P>
     * 等同 {@link #setTempalteFunc}
     * @param tempalteFunc
     */
    @JsonIgnore
    public PSSysSFPlugin tempaltefunc(String tempalteFunc){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin templatemode(Integer templateMode){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin templatemode(Boolean templateMode){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysSFPlugin usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSSysSFPlugin id(String strValue){
        this.setPSSysSFPluginId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysSFPlugin){
            PSSysSFPlugin model = (PSSysSFPlugin)iPSModel;
        }
