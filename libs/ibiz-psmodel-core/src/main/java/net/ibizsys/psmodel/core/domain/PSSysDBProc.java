...
/**
 * <B>PSSYSDBPROC</B>系统数据库存储过程 模型传输对象
 * <P>
 * 数据库存储过程模型，定义存储过程的基本信息，包括过程参数对象
 */
public class PSSysDBProc extends net.ibizsys.psmodel.core.util.PSModelBase {

    public PSSysDBProc(){
    }      

    /**
     * <B>CODENAME</B>&nbsp;代码标识，指定存储过程的代码标识，需要在所在的数据库体系中具有唯一性
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysDBProc codename(String codeName){
        this.setCodeName(codeName);
        return this;
    }

    /**
     * <B>CODENAME2</B>&nbsp;代码标识2，指定存储过程的代码标识2，需要在所在的数据库体系中具有唯一性
     * <P>
     * 字符串：最大长度 50
     */
     ...
     */
    @JsonIgnore
    public PSSysDBProc codename2(String codeName2){
     ...
     */
    @JsonIgnore
    public PSSysDBProc createdate(String createDate){
     ...
     */
    @JsonIgnore
    public PSSysDBProc createman(String createMan){
        this.setCreateMan(createMan);
        return this;
    }

    /**
     * <B>LOGICNAME</B>&nbsp;逻辑名称，指定存储过程的逻辑名称
     * <P>
     * 字符串：最大长度 200
     */
     ...
     */
    @JsonIgnore
    public PSSysDBProc logicname(String logicName){
     ...
     */
    @JsonIgnore
    public PSSysDBProc memo(String memo){
        this.setMemo(memo);
        return this;
    }

    /**
     * <B>PROCDESC</B>&nbsp;过程描述，指定存储过程的描述信息
     * <P>
     * 字符串：最大长度 200
     */
    public final static String FIELD_PROCDESC = "procdesc";

    /**
     * 设置 过程描述，详细说明：{@link #FIELD_PROCDESC}
     * 
     * @param procDesc
     * 
     */
    @JsonProperty(FIELD_PROCDESC)
    ...
    public boolean isProcDescDirty(){
        if(this.contains(FIELD_PROCDESC)){
            return true;
        }
        return false;
    }
     ...
     */
    @JsonIgnore
    public PSSysDBProc procdesc(String procDesc){
        this.setProcDesc(procDesc);
        return this;
    }

    /**
     * <B>PSSYSDBPROCID</B>&nbsp;系统数据库存储过程标识
     * <P>
     * 字符串：最大长度 100
     */
     ...
     */
    @JsonIgnore
    public PSSysDBProc pssysdbprocid(String pSSysDBProcId){
        this.setPSSysDBProcId(pSSysDBProcId);
        return this;
    }

    /**
     * <B>PSSYSDBPROCNAME</B>&nbsp;过程名称，指定存储过程的名称，需在所在的数据库体系中具备唯一性
     * <P>
    ...
    /**
     * 设置 过程名称，详细说明：{@link #FIELD_PSSYSDBPROCNAME}
     * 
     ...
     */
    @JsonIgnore
    public PSSysDBProc pssysdbprocname(String pSSysDBProcName){
    ...
    @JsonIgnore
    public PSSysDBProc name(String strName){
        this.setPSSysDBProcName(strName);
        return this;
    }

    /**
     * <B>PSSYSDBSCHEMEID</B>&nbsp;系统数据库，指定存储过程所在的数据库体系
     * <P>
    ...
    /**
     * 设置 系统数据库，详细说明：{@link #FIELD_PSSYSDBSCHEMEID}
     * 
     ...
     */
    @JsonIgnore
    public PSSysDBProc pssysdbschemeid(String pSSysDBSchemeId){
     ...
     */
    @JsonIgnore
    public PSSysDBProc pssysdbschemeid(PSSysDBScheme pSSysDBScheme){
    ...
    /**
     * <B>PSSYSDBSCHEMENAME</B>&nbsp;数据库体系，指定存储过程所在的数据库体系
     * <P>
     ...
     */
    @JsonIgnore
    public PSSysDBProc pssysdbschemename(String pSSysDBSchemeName){
     ...
     */
    @JsonIgnore
    public PSSysDBProc updatedate(String updateDate){
     ...
     */
    @JsonIgnore
    public PSSysDBProc updateman(String updateMan){
     ...
     */
    @JsonIgnore
    public PSSysDBProc usercat(String userCat){
     ...
     */
    @JsonIgnore
    public PSSysDBProc usercat(net.ibizsys.psmodel.core.util.PSModelEnums.ModelUserCat userCat){
        if(userCat == null){
     ...
     */
    @JsonIgnore
    public PSSysDBProc usertag(String userTag){
     ...
     */
    @JsonIgnore
    public PSSysDBProc usertag2(String userTag2){
     ...
     */
    @JsonIgnore
    public PSSysDBProc usertag3(String userTag3){
     ...
     */
    @JsonIgnore
    public PSSysDBProc usertag4(String userTag4){
    ...
    @JsonIgnore
    public PSSysDBProc id(String strValue){
        this.setPSSysDBProcId(strValue);
        return this;
    }
    ...
    public void copyTo(net.ibizsys.psmodel.core.util.IPSModel iPSModel){
        if(iPSModel instanceof PSSysDBProc){
            PSSysDBProc model = (PSSysDBProc)iPSModel;
        }
