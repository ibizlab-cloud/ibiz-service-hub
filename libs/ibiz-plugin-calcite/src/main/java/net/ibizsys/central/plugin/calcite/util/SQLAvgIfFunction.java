...
public class SQLAvgIfFunction extends SQLFunctionBase {

	public final static SQLAvgIfFunction DEFAULT = new SQLAvgIfFunction();
	...
	public SqlCall parse(SqlBasicCall sqlBasicCall, Map<String, Object> params) {
		...
		SqlFunction avgFunction = new SqlFunction("AVG", SqlKind.OTHER_FUNCTION,
		...
		return new SqlBasicCall(avgFunction, Arrays.asList(sqlCase), SqlParserPos.ZERO);
