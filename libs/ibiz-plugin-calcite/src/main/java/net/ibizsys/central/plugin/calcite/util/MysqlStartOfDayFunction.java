...
public class MysqlStartOfDayFunction extends SQLFunctionBase {

	public final static MysqlStartOfDayFunction DEFAULT = new MysqlStartOfDayFunction();
	...
	public SqlCall parse(SqlBasicCall sqlBasicCall, Map<String, Object> params) {
		...
		SqlBasicCall concatCall = new SqlBasicCall(CONCAT, Arrays.asList(dateCall, SqlLiteral.createCharString(" 00:00:00", SqlParserPos.ZERO)), SqlParserPos.ZERO);
